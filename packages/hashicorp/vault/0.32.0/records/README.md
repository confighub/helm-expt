...
| `dev-mode` | [source and intent](./dev-mode/source-and-intent.yaml) | [Helm render intent](./dev-mode/helm-render-intent.yaml) | [Kubernetes objects](../bases/dev-mode/upstream.yaml) |
| `ha-raft-ui` | [source and intent](./ha-raft-ui/source-and-intent.yaml) | [Helm render intent](./ha-raft-ui/helm-render-intent.yaml) | [Kubernetes objects](../bases/ha-raft-ui/upstream.yaml) |
