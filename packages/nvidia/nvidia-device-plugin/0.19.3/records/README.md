...
| `nfd-enabled` | [source and intent](./nfd-enabled/source-and-intent.yaml) | [Helm render intent](./nfd-enabled/helm-render-intent.yaml) | [Kubernetes objects](../bases/nfd-enabled/upstream.yaml) |
