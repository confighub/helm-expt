...
| --- | --- | --- | --- |
| `admission-disabled` | [source and intent](./admission-disabled/source-and-intent.yaml) | [Helm render intent](./admission-disabled/helm-render-intent.yaml) | [Kubernetes objects](../bases/admission-disabled/upstream.yaml) |
...
| `internal-clusterip` | [source and intent](./internal-clusterip/source-and-intent.yaml) | [Helm render intent](./internal-clusterip/helm-render-intent.yaml) | [Kubernetes objects](../bases/internal-clusterip/upstream.yaml) |
