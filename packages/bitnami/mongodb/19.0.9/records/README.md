...
| --- | --- | --- | --- |
| `existing-secret-replicaset` | [source and intent](./existing-secret-replicaset/source-and-intent.yaml) | [Helm render intent](./existing-secret-replicaset/helm-render-intent.yaml) | [Kubernetes objects](../bases/existing-secret-replicaset/upstream.yaml) |
