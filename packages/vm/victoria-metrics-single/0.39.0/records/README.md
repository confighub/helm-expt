...
| `default-reviewed` | [source and intent](./default-reviewed/source-and-intent.yaml) | [Helm render intent](./default-reviewed/helm-render-intent.yaml) | [Kubernetes objects](../bases/default-reviewed/upstream.yaml) |
