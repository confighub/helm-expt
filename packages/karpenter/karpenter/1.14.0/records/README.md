...
| --- | --- | --- | --- |
| `crds-managed` | [source and intent](./crds-managed/source-and-intent.yaml) | [Helm render intent](./crds-managed/helm-render-intent.yaml) | [Kubernetes objects](../bases/crds-managed/upstream.yaml) |
...
| `eks-inference` | [source and intent](./eks-inference/source-and-intent.yaml) | [Helm render intent](./eks-inference/helm-render-intent.yaml) | [Kubernetes objects](../bases/eks-inference/upstream.yaml) |
