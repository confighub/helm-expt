...
| `external-tls-ca` | [source and intent](./external-tls-ca/source-and-intent.yaml) | [Helm render intent](./external-tls-ca/helm-render-intent.yaml) | [Kubernetes objects](../bases/external-tls-ca/upstream.yaml) |
