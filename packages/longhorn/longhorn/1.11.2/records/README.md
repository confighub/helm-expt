...
| `ui-ingress` | [source and intent](./ui-ingress/source-and-intent.yaml) | [Helm render intent](./ui-ingress/helm-render-intent.yaml) | [Kubernetes objects](../bases/ui-ingress/upstream.yaml) |
