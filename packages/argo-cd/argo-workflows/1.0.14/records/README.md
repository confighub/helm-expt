...
| --- | --- | --- | --- |
| `controller-default-reviewed` | [source and intent](./controller-default-reviewed/source-and-intent.yaml) | [Helm render intent](./controller-default-reviewed/helm-render-intent.yaml) | [Kubernetes objects](../bases/controller-default-reviewed/upstream.yaml) |
...
| `minimal-crds` | [source and intent](./minimal-crds/source-and-intent.yaml) | [Helm render intent](./minimal-crds/helm-render-intent.yaml) | [Kubernetes objects](../bases/minimal-crds/upstream.yaml) |
