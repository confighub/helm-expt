...
| `server-only-ephemeral` | [source and intent](./server-only-ephemeral/source-and-intent.yaml) | [Helm render intent](./server-only-ephemeral/helm-render-intent.yaml) | [Kubernetes objects](../bases/server-only-ephemeral/upstream.yaml) |
