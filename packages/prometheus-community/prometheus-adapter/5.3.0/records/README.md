...
| --- | --- | --- | --- |
| `apiservice-v1-capability` | [source and intent](./apiservice-v1-capability/source-and-intent.yaml) | [Helm render intent](./apiservice-v1-capability/helm-render-intent.yaml) | [Kubernetes objects](../bases/apiservice-v1-capability/upstream.yaml) |
| `cluster-metrics-readonly` | [source and intent](./cluster-metrics-readonly/source-and-intent.yaml) | [Helm render intent](./cluster-metrics-readonly/helm-render-intent.yaml) | [Kubernetes objects](../bases/cluster-metrics-readonly/upstream.yaml) |
