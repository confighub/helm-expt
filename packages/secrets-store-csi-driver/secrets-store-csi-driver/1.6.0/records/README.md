...
| `sync-secret-rotation` | [source and intent](./sync-secret-rotation/source-and-intent.yaml) | [Helm render intent](./sync-secret-rotation/helm-render-intent.yaml) | [Kubernetes objects](../bases/sync-secret-rotation/upstream.yaml) |
