...
| --- | --- | --- | --- |
| `existing-secret-ingress` | [source and intent](./existing-secret-ingress/source-and-intent.yaml) | [Helm render intent](./existing-secret-ingress/helm-render-intent.yaml) | [Kubernetes objects](../bases/existing-secret-ingress/upstream.yaml) |
