...
| `dry-run-txt-registry` | [source and intent](./dry-run-txt-registry/source-and-intent.yaml) | [Helm render intent](./dry-run-txt-registry/helm-render-intent.yaml) | [Kubernetes objects](../bases/dry-run-txt-registry/upstream.yaml) |
