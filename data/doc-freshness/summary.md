...
Snapshot as of 2026-06-17 (commit `b0939504`). Refresh with `npm run doc-freshness` - cheap, ride
...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 7 | `data/outcome-coverage/base-outcomes.csv (2026-06-16)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-13)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 6 | `data/status-dashboard/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/outcome-coverage/summary.md (2026-06-16)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 6 | `data/outcome-coverage/summary.md (2026-06-16)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 6 | `data/status-dashboard/status.csv (2026-06-17)`<br>`data/status-dashboard/summary.md (2026-06-17)`<br>`data/outcome-evidence-contract/summary.md (2026-06-16)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 6 | `data/live-kind-parity/summary.md (2026-06-17)`<br>`data/master-catalog-matrix/summary.md (2026-06-17)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 6 | `data/chart-use-guide/summary.md (2026-06-16)`<br>`data/outcome-coverage/base-outcomes.csv (2026-06-16)`<br>`data/top100-readiness/next80-queues.csv (2026-06-13)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 6 | `data/outcome-coverage/summary.md (2026-06-16)`<br>`tests/npm-scripts.md (2026-06-12)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-12 | 5 | `data/master-catalog-matrix/matrix.csv (2026-06-17)`<br>`data/master-catalog-matrix/matrix.html (2026-06-17)`<br>`data/master-catalog-matrix/summary.md (2026-06-17)` |
...
| [README.md](../../README.md) | root | 2026-06-13 | 4 | `data/live-kind-parity/summary.md (2026-06-17)`<br>`data/status-dashboard/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)` |
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 4 | `data/live-kind-parity/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-16)` |
...
| [docs/reference/variant-promotion-model.md](../../docs/reference/variant-promotion-model.md) | reference | 2026-06-14 | 3 | `data/variant-promotion/summary.md (2026-06-17)` |
...
| [docs/user/try-now.md](../../docs/user/try-now.md) | user | 2026-06-13 | 3 | `data/chart-use-guide/summary.md (2026-06-16)` |
...
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-16 | 2 | `data/kind-parity-decisions/summary.md (2026-06-17)`<br>`data/live-matrix-burndown/summary.md (2026-06-17)`<br>`data/master-catalog-matrix/matrix.html (2026-06-17)` |
...
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-16 | 1 | `data/status-dashboard/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)` |
...
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 1 | `data/disposition-frontier/summary.md (2026-06-17)`<br>`data/kind-parity-decisions/summary.md (2026-06-17)`<br>`data/live-matrix-burndown/summary.md (2026-06-17)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 1 | `data/kind-parity-decisions/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/live-parity-decisions/summary.md (2026-06-16)` |
...
| [docs/reference/variant-promotion-closeout.md](../../docs/reference/variant-promotion-closeout.md) | reference | 2026-06-16 | 1 | `data/variant-promotion-closeout/summary.md (2026-06-17)`<br>`data/variant-promotion/status.csv (2026-06-17)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-16 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-17)`<br>`data/status-dashboard/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-16 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-17)`<br>`data/outcome-evidence-contract/summary.md (2026-06-16)` |
...
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 1 | `data/live-kind-parity/summary.md (2026-06-17)`<br>`data/live-matrix-burndown/summary.md (2026-06-17)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)` |
...
| [docs/user/target-prerequisites-before-rerun.md](../../docs/user/target-prerequisites-before-rerun.md) | user | 2026-06-16 | 1 | `data/model-gap-workdown/summary.md (2026-06-17)` |
