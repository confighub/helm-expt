...
Snapshot as of 2026-06-16 (commit `8742cf75`). Refresh with `npm run doc-freshness` - cheap, ride
...
| Metric | Count |
| --- | ---: |
| Authored docs tracked | 177 |
| Fresh (no linked source newer than the doc) | 12 |
| **Review-due** | 45 |
| No linked evidence sources (cannot auto-trigger) | 120 |
...
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 6 | `data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/status-dashboard/summary.md (2026-06-16)`<br>`data/outcome-coverage/summary.md (2026-06-16)` |
...
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 5 | `data/outcome-evidence-contract/summary.md (2026-06-16)`<br>`data/status-dashboard/status.csv (2026-06-16)`<br>`data/status-dashboard/summary.md (2026-06-16)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 5 | `data/live-kind-parity/summary.md (2026-06-16)`<br>`data/master-catalog-matrix/summary.md (2026-06-16)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
...
| [docs/user/verify-it-yourself.md](../../docs/user/verify-it-yourself.md) | user | 2026-06-13 | 4 | `data/live-kind-parity/summary.md (2026-06-16)` |
...
| [README.md](../../README.md) | root | 2026-06-13 | 3 | `data/live-kind-parity/summary.md (2026-06-16)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/status-dashboard/summary.md (2026-06-16)` |
...
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 3 | `data/live-kind-parity/summary.md (2026-06-16)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-16)` |
...
| [docs/reference/variant-promotion-model.md](../../docs/reference/variant-promotion-model.md) | reference | 2026-06-14 | 3 | `data/variant-promotion/summary.md (2026-06-16)` |
...
| [docs/README.md](../../docs/README.md) | docs | 2026-06-16 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-16)`<br>`data/outcome-evidence-contract/summary.md (2026-06-16)`<br>`data/chart-use-guide/summary.md (2026-06-16)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-16 | 1 | `data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/status-dashboard/summary.md (2026-06-16)` |
...
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 1 | `data/kind-parity-decisions/summary.md (2026-06-16)`<br>`data/live-matrix-burndown/summary.md (2026-06-16)`<br>`data/live-run-blocks/summary.md (2026-06-16)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 1 | `data/kind-parity-decisions/summary.md (2026-06-16)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/live-parity-decisions/summary.md (2026-06-16)` |
...
| [docs/reference/variant-promotion-closeout.md](../../docs/reference/variant-promotion-closeout.md) | reference | 2026-06-16 | 1 | `data/variant-promotion-closeout/summary.md (2026-06-16)`<br>`data/variant-promotion/status.csv (2026-06-16)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-16 | 1 | `data/live-parity-rerun-plan/summary.md (2026-06-16)`<br>`data/master-catalog-matrix/matrix.html (2026-06-16)`<br>`data/status-dashboard/active-proof-queue.csv (2026-06-16)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-16 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-16)`<br>`data/outcome-evidence-contract/summary.md (2026-06-16)` |
...
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 1 | `data/live-kind-parity/summary.md (2026-06-16)`<br>`data/live-matrix-burndown/summary.md (2026-06-16)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-16)` |
...
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-16 | 1 | `data/kind-parity-decisions/summary.md (2026-06-16)`<br>`data/live-matrix-burndown/summary.md (2026-06-16)`<br>`data/master-catalog-matrix/matrix.html (2026-06-16)` |
