...
Snapshot as of 2026-06-15 (commit `1280a55d`). Refresh with `npm run doc-freshness` — cheap, ride
...
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 4 | `data/master-catalog-matrix/summary.md (2026-06-15)`<br>`data/live-kind-parity/summary.md (2026-06-13)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
