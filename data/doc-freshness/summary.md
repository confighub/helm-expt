...
Snapshot as of 2026-09-10 (commit `d051e7cfe`). Refresh with `npm run doc-freshness` - cheap, ride
...
| Metric | Count |
| --- | ---: |
| Authored docs tracked | 435 |
| Fresh (no linked source newer than the doc) | 70 |
| **Review-due** | 78 |
...
| --- | --- | --- | ---: | --- |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 91 | `data/README.md (2026-09-10)`<br>`data/csv-index.csv (2026-09-10)`<br>`CATALOG.md (2026-08-26)` |
