...
Snapshot as of 2026-06-19 (commit `aaf31fe6`). Refresh with `npm run doc-freshness` - cheap, ride
...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 9 | `data/outcome-coverage/base-outcomes.csv (2026-06-19)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-17)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 9 | `data/outcome-coverage/base-outcomes.csv (2026-06-19)`<br>`data/top100-promotion-wave/summary.md (2026-06-17)`<br>`data/top100-readiness/next80-queues.csv (2026-06-17)` |
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 8 | `data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/outcome-coverage/summary.md (2026-06-19)`<br>`data/status-dashboard/summary.md (2026-06-18)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 8 | `data/outcome-coverage/summary.md (2026-06-19)` |
| [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md) | planning | 2026-06-10 | 8 | `data/top100-coverage/summary.md (2026-06-17)` |
| [docs/reference/proof-kit-migration.md](../../docs/reference/proof-kit-migration.md) | reference | 2026-06-11 | 8 | `data/live-helm-confighub-compare/summary.md (2026-06-19)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 8 | `data/outcome-coverage/base-outcomes.csv (2026-06-19)`<br>`data/top100-coverage/summary.md (2026-06-17)`<br>`data/top100-readiness/readiness.csv (2026-06-17)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 8 | `data/outcome-coverage/base-outcomes.csv (2026-06-19)`<br>`data/outcome-coverage/chart-outcomes.csv (2026-06-19)`<br>`data/outcome-coverage/summary.md (2026-06-19)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 8 | `data/master-catalog-matrix/summary.md (2026-06-19)`<br>`data/live-kind-parity/summary.md (2026-06-18)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 8 | `data/outcome-coverage/summary.md (2026-06-19)`<br>`tests/npm-scripts.md (2026-06-12)` |
| [docs/user/why-this-does-not-collapse.md](../../docs/user/why-this-does-not-collapse.md) | user | 2026-06-10 | 8 | `data/top100-coverage/summary.md (2026-06-17)`<br>`data/quirk-coverage/summary.md (2026-06-13)`<br>`data/live-e2e/cub-scout-watchlist.md (2026-06-11)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-13 | 7 | `data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/outcome-coverage/summary.md (2026-06-19)`<br>`CATALOG.md (2026-06-18)` |
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 7 | `data/live-helm-confighub-compare/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/live-kind-parity/summary.md (2026-06-18)` |
| [docs/reference/helm-quirk-support-matrix.md](../../docs/reference/helm-quirk-support-matrix.md) | reference | 2026-06-11 | 7 | `data/top100-user-readiness/summary.md (2026-06-17)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-13 | 6 | `data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/outcome-coverage/summary.md (2026-06-19)`<br>`CATALOG.md (2026-06-18)` |
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 6 | `data/live-helm-confighub-compare/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/live-kind-parity/summary.md (2026-06-18)` |
...
| [docs/user/prometheus-high-fanout.md](../../docs/user/prometheus-high-fanout.md) | user | 2026-06-11 | 6 | `data/high-fanout-demo/prometheus-kps.csv (2026-06-17)`<br>`data/high-fanout-demo/summary.md (2026-06-17)`<br>`recipes/prometheus-community/kube-prometheus-stack/85.3.3/CATALOG.md (2026-06-11)` |
| [docs/user/serious-chart-proof.md](../../docs/user/serious-chart-proof.md) | user | 2026-06-11 | 6 | `data/webhook-cert-lifecycle/summary.md (2026-06-17)`<br>`recipes/prometheus-community/kube-prometheus-stack/85.3.3/CATALOG.md (2026-06-11)` |
| [docs/reference/variant-promotion-model.md](../../docs/reference/variant-promotion-model.md) | reference | 2026-06-14 | 5 | `data/variant-promotion/summary.md (2026-06-18)` |
...
| [docs/user/top100-status.md](../../docs/user/top100-status.md) | user | 2026-06-12 | 5 | `data/top100-readiness/summary.md (2026-06-17)`<br>`data/top100-user-readiness/summary.md (2026-06-17)`<br>`data/top20-base-readiness/start-here.md (2026-06-17)` |
| [docs/user/verify-it-yourself.md](../../docs/user/verify-it-yourself.md) | user | 2026-06-13 | 5 | `data/live-kind-parity/summary.md (2026-06-18)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 4 | `data/live-parity-decisions/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/kind-parity-decisions/summary.md (2026-06-18)` |
...
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 3 | `data/outcome-coverage/summary.md (2026-06-19)`<br>`data/blast-radius-accuracy/summary.md (2026-06-18)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-16 | 3 | `data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/outcome-coverage/summary.md (2026-06-19)`<br>`data/status-dashboard/summary.md (2026-06-18)` |
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 3 | `data/disposition-frontier/summary.md (2026-06-19)`<br>`data/live-parity-decisions/summary.md (2026-06-19)`<br>`data/master-catalog-matrix/summary.md (2026-06-19)` |
...
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 3 | `data/live-helm-confighub-compare/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/live-kind-parity/summary.md (2026-06-18)` |
| [docs/user/offering.md](../../docs/user/offering.md) | user | 2026-06-13 | 3 | `data/chart-use-guide/summary.md (2026-06-16)` |
| [README.md](../../README.md) | root | 2026-06-18 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)` |
| [docs/README.md](../../docs/README.md) | docs | 2026-06-18 | 2 | `data/master-catalog-matrix/matrix.html (2026-06-19)`<br>`data/outcome-evidence-contract/summary.md (2026-06-18)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 2 | `data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/master-catalog-matrix/matrix.csv (2026-06-19)`<br>`data/master-catalog-matrix/matrix.html (2026-06-19)` |
...
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 2 | `data/live-parity-decisions/summary.md (2026-06-19)`<br>`data/master-catalog-matrix/matrix.html (2026-06-19)` |
...
| [README.md](../../README.md) | root | 2026-06-18 | 1 | `data/live-helm-confighub-compare/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)` |
| [docs/README.md](../../docs/README.md) | docs | 2026-06-18 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-19)`<br>`data/outcome-evidence-contract/summary.md (2026-06-18)` |
...
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 1 | `data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/master-catalog-matrix/matrix.csv (2026-06-19)`<br>`data/master-catalog-matrix/matrix.html (2026-06-19)` |
| [docs/reference/variant-promotion-closeout.md](../../docs/reference/variant-promotion-closeout.md) | reference | 2026-06-18 | 1 | `data/variant-promotion-closeout/summary.md (2026-06-18)`<br>`data/variant-promotion/status.csv (2026-06-18)` |
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-18 | 1 | `data/live-helm-confighub-compare/summary.md (2026-06-19)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-19)`<br>`data/master-catalog-matrix/matrix.html (2026-06-19)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-18 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-19)`<br>`data/outcome-evidence-contract/summary.md (2026-06-18)` |
...
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 1 | `data/live-parity-decisions/summary.md (2026-06-19)`<br>`data/master-catalog-matrix/matrix.html (2026-06-19)` |
