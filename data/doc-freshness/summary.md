...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 10 | `data/outcome-coverage/base-outcomes.csv (2026-06-20)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-17)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 10 | `data/README.md (2026-06-21)`<br>`data/csv-index.csv (2026-06-21)`<br>`data/outcome-coverage/base-outcomes.csv (2026-06-20)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 10 | `data/outcome-coverage/base-outcomes.csv (2026-06-20)`<br>`data/top100-promotion-wave/summary.md (2026-06-17)`<br>`data/top100-readiness/next80-queues.csv (2026-06-17)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 10 | `tests/npm-scripts.md (2026-06-21)`<br>`data/outcome-coverage/summary.md (2026-06-20)` |
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 9 | `data/live-parity-rerun-plan/summary.md (2026-06-20)`<br>`data/outcome-coverage/summary.md (2026-06-20)`<br>`data/status-dashboard/summary.md (2026-06-18)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 9 | `data/outcome-coverage/summary.md (2026-06-20)` |
...
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 9 | `data/outcome-coverage/base-outcomes.csv (2026-06-20)`<br>`data/top100-coverage/summary.md (2026-06-17)`<br>`data/top100-readiness/readiness.csv (2026-06-17)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 9 | `data/master-catalog-matrix/summary.md (2026-06-20)`<br>`data/live-kind-parity/summary.md (2026-06-20)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-13 | 8 | `tests/npm-scripts.md (2026-06-21)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-20)`<br>`data/outcome-coverage/summary.md (2026-06-20)` |
...
| [docs/reference/variant-promotion-model.md](../../docs/reference/variant-promotion-model.md) | reference | 2026-06-14 | 7 | `data/variant-promotion/summary.md (2026-06-20)` |
...
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 5 | `data/master-catalog-matrix/summary.md (2026-06-20)`<br>`data/matrix-completion-audit/summary.md (2026-06-20)`<br>`data/disposition-frontier/summary.md (2026-06-20)` |
...
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 4 | `data/outcome-coverage/summary.md (2026-06-20)`<br>`data/blast-radius-accuracy/summary.md (2026-06-18)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 4 | `data/kind-parity-decisions/summary.md (2026-06-20)`<br>`data/live-parity-decisions/summary.md (2026-06-20)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-20)` |
...
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 4 | `data/live-helm-confighub-compare/summary.md (2026-06-20)`<br>`data/live-kind-parity/summary.md (2026-06-20)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-20)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 3 | `data/master-catalog-matrix/matrix.csv (2026-06-20)`<br>`data/master-catalog-matrix/matrix.html (2026-06-20)`<br>`data/master-catalog-matrix/summary.md (2026-06-20)` |
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-18 | 3 | `data/master-catalog-matrix/matrix.html (2026-06-20)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-20)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-20)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-18 | 3 | `data/master-catalog-matrix/matrix.html (2026-06-20)`<br>`data/outcome-evidence-contract/summary.md (2026-06-18)` |
| [docs/user/offering.md](../../docs/user/offering.md) | user | 2026-06-13 | 3 | `data/chart-use-guide/summary.md (2026-06-16)` |
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 3 | `data/master-catalog-matrix/matrix.html (2026-06-20)`<br>`data/kind-parity-decisions/summary.md (2026-06-20)`<br>`data/live-parity-decisions/summary.md (2026-06-20)` |
| [README.md](../../README.md) | root | 2026-06-18 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-20)`<br>`data/live-kind-parity/summary.md (2026-06-20)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-20)` |
...
| [docs/reference/variant-promotion-closeout.md](../../docs/reference/variant-promotion-closeout.md) | reference | 2026-06-18 | 2 | `data/variant-promotion-closeout/summary.md (2026-06-20)`<br>`data/variant-promotion/status.csv (2026-06-20)` |
...
| [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md) | planning | 2026-06-21 | 1 | `tests/README.md (2026-06-21)` |
| [docs/planning/pilot-adversarial-testing.md](../../docs/planning/pilot-adversarial-testing.md) | planning | 2026-06-21 | 1 | `tests/README.md (2026-06-21)` |
...
| [docs/planning/user-journey-test-pathways-plan.md](../../docs/planning/user-journey-test-pathways-plan.md) | planning | 2026-06-21 | 1 | `tests/README.md (2026-06-21)` |
...
| [docs/user/how-it-works.md](../../docs/user/how-it-works.md) | user | 2026-06-21 | 1 | `tests/doctrine.md (2026-06-22)`<br>`tests/README.md (2026-06-21)` |
| [docs/user/pathway-route-hooks-transparently.md](../../docs/user/pathway-route-hooks-transparently.md) | user | 2026-06-21 | 1 | `tests/README.md (2026-06-21)` |
| [docs/user/security-end-to-end.md](../../docs/user/security-end-to-end.md) | user | 2026-06-21 | 1 | `tests/doctrine.md (2026-06-22)`<br>`tests/README.md (2026-06-21)` |
