...
Snapshot as of 2026-06-14 (commit `95cf6b60`). Refresh with `npm run doc-freshness` — cheap, ride
...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 5 | `data/outcome-coverage/base-outcomes.csv (2026-06-14)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-13)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 5 | `data/outcome-coverage/base-outcomes.csv (2026-06-14)`<br>`data/top100-readiness/next80-queues.csv (2026-06-13)`<br>`data/top100-readiness/next80-queues.md (2026-06-13)` |
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 4 | `data/live-parity-rerun-plan/summary.md (2026-06-14)`<br>`data/outcome-coverage/summary.md (2026-06-14)`<br>`data/status-dashboard/summary.md (2026-06-14)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 4 | `data/outcome-coverage/summary.md (2026-06-14)` |
...
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 4 | `data/outcome-coverage/base-outcomes.csv (2026-06-14)`<br>`data/outcome-coverage/chart-outcomes.csv (2026-06-14)`<br>`data/outcome-coverage/summary.md (2026-06-14)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 4 | `data/outcome-coverage/summary.md (2026-06-14)`<br>`tests/npm-scripts.md (2026-06-12)` |
...
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-12 | 3 | `data/live-parity-rerun-plan/summary.md (2026-06-14)`<br>`data/master-catalog-matrix/matrix.csv (2026-06-14)`<br>`data/master-catalog-matrix/matrix.html (2026-06-14)` |
| [docs/reference/proof-kit-migration.md](../../docs/reference/proof-kit-migration.md) | reference | 2026-06-11 | 3 | `data/live-helm-confighub-compare/summary.md (2026-06-14)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 3 | `data/outcome-coverage/base-outcomes.csv (2026-06-14)`<br>`data/top100-readiness/readiness.csv (2026-06-13)`<br>`data/top100-readiness/summary.md (2026-06-13)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-12 | 3 | `data/master-catalog-matrix/matrix.html (2026-06-14)`<br>`data/chart-use-guide/summary.md (2026-06-13)`<br>`data/outcome-evidence-contract/summary.md (2026-06-13)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 3 | `data/master-catalog-matrix/summary.md (2026-06-14)`<br>`data/live-kind-parity/summary.md (2026-06-13)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
| [README.md](../../README.md) | root | 2026-06-13 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-14)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-14)`<br>`data/status-dashboard/summary.md (2026-06-14)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-13 | 2 | `data/live-parity-rerun-plan/summary.md (2026-06-14)`<br>`data/outcome-coverage/summary.md (2026-06-14)` |
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-14)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-14)` |
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-13 | 2 | `data/outcome-coverage/summary.md (2026-06-14)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-13 | 2 | `data/live-parity-rerun-plan/summary.md (2026-06-14)`<br>`data/outcome-coverage/summary.md (2026-06-14)`<br>`data/status-dashboard/summary.md (2026-06-14)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-13 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-14)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-14)`<br>`data/master-catalog-matrix/matrix.html (2026-06-14)` |
...
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-14 | 1 | `data/live-helm-confighub-compare/summary.md (2026-06-14)`<br>`data/live-matrix-burndown/summary.md (2026-06-14)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-14)` |
...
| [docs/user/verify-it-yourself.md](../../docs/user/verify-it-yourself.md) | user | 2026-06-13 | 1 | `data/live-kind-parity/summary.md (2026-06-13)` |
