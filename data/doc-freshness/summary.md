...
Snapshot as of 2026-06-26 (commit `10cb55c0f`). Refresh with `npm run doc-freshness` - cheap, ride
...
| Metric | Count |
| --- | ---: |
| Authored docs tracked | 210 |
| Fresh (no linked source newer than the doc) | 20 |
| **Review-due** | 55 |
| No linked evidence sources (cannot auto-trigger) | 135 |
...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 15 | `data/outcome-coverage/base-outcomes.csv (2026-06-24)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-24)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/user/why-this-does-not-collapse.md](../../docs/user/why-this-does-not-collapse.md) | user | 2026-06-10 | 15 | `data/quirk-coverage/summary.md (2026-06-24)`<br>`data/top100-coverage/summary.md (2026-06-24)`<br>`data/live-e2e/cub-scout-watchlist.md (2026-06-11)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 14 | `data/outcome-coverage/summary.md (2026-06-24)` |
| [docs/reference/helm-quirk-support-matrix.md](../../docs/reference/helm-quirk-support-matrix.md) | reference | 2026-06-11 | 14 | `data/top100-user-readiness/summary.md (2026-06-24)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 14 | `data/outcome-coverage/base-outcomes.csv (2026-06-24)`<br>`data/production-disposition/next-actions.csv (2026-06-24)`<br>`data/top100-coverage/work-queue.md (2026-06-24)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 14 | `data/outcome-coverage/summary.md (2026-06-24)`<br>`tests/npm-scripts.md (2026-06-21)` |
| [docs/reference/quirk-coverage.md](../../docs/reference/quirk-coverage.md) | reference | 2026-06-11 | 13 | `data/quirk-coverage/coverage.csv (2026-06-24)`<br>`data/quirk-coverage/summary.md (2026-06-24)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 13 | `data/outcome-coverage/base-outcomes.csv (2026-06-24)`<br>`data/top100-coverage/summary.md (2026-06-24)`<br>`data/top100-readiness/readiness.csv (2026-06-24)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 13 | `CATALOG.md (2026-06-24)`<br>`data/README.md (2026-06-24)`<br>`data/attack-plan-workdown/summary.md (2026-06-24)` |
| [docs/user/production-support-decisions.md](../../docs/user/production-support-decisions.md) | user | 2026-06-11 | 13 | `data/production-disposition/next-actions.csv (2026-06-24)`<br>`data/production-disposition/summary.md (2026-06-24)`<br>`data/production-disposition/support-decision-contract.md (2026-06-24)` |
...
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 13 | `data/master-catalog-matrix/summary.md (2026-06-24)`<br>`data/live-kind-parity/summary.md (2026-06-20)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
| [docs/user/prometheus-high-fanout.md](../../docs/user/prometheus-high-fanout.md) | user | 2026-06-11 | 12 | `data/production-support-decisions/prometheus-community-kube-prometheus-stack/README.md (2026-06-23)`<br>`data/production-support-decisions/prometheus-community-kube-prometheus-stack/support-decision.yaml (2026-06-23)`<br>`data/high-fanout-demo/prometheus-kps.csv (2026-06-17)` |
| [docs/user/serious-chart-proof.md](../../docs/user/serious-chart-proof.md) | user | 2026-06-11 | 12 | `data/production-support-decisions/prometheus-community-kube-prometheus-stack/README.md (2026-06-23)`<br>`data/webhook-cert-lifecycle/summary.md (2026-06-17)`<br>`recipes/prometheus-community/kube-prometheus-stack/85.3.3/CATALOG.md (2026-06-11)` |
| [docs/user/top100-status.md](../../docs/user/top100-status.md) | user | 2026-06-12 | 12 | `data/top100-promotion-wave/fast-track.md (2026-06-24)`<br>`data/top100-readiness/summary.md (2026-06-24)`<br>`data/top100-user-readiness/summary.md (2026-06-24)` |
| [docs/reference/secret-lifecycle.md](../../docs/reference/secret-lifecycle.md) | reference | 2026-06-13 | 11 | `data/secret-lifecycle/secrets.csv (2026-06-24)`<br>`data/secret-lifecycle/summary.md (2026-06-24)`<br>`data/secret-lifecycle/variant-summary.csv (2026-06-24)` |
| [docs/reference/variant-promotion-model.md](../../docs/reference/variant-promotion-model.md) | reference | 2026-06-14 | 11 | `data/variant-promotion/summary.md (2026-06-24)` |
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 9 | `data/disposition-frontier/summary.md (2026-06-24)`<br>`data/master-catalog-matrix/summary.md (2026-06-24)`<br>`data/matrix-completion-audit/summary.md (2026-06-24)` |
| [docs/reference/proof-kit-migration.md](../../docs/reference/proof-kit-migration.md) | reference | 2026-06-11 | 9 | `data/live-helm-confighub-compare/summary.md (2026-06-20)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 9 | `data/production-disposition/support-decision-contract.md (2026-06-24)`<br>`data/kind-parity-decisions/summary.md (2026-06-20)`<br>`data/live-parity-decisions/summary.md (2026-06-20)` |
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 9 | `data/status-dashboard/active-proof-queue.csv (2026-06-24)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-20)`<br>`data/live-kind-parity/summary.md (2026-06-20)` |
| [docs/user/remote-images-and-supported-bases.md](../../docs/user/remote-images-and-supported-bases.md) | user | 2026-06-16 | 9 | `data/remote-image-runtime-workdown/summary.md (2026-06-24)`<br>`data/image-digest-workdown/summary.md (2026-06-17)` |
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 8 | `data/outcome-coverage/summary.md (2026-06-24)`<br>`data/blast-radius-accuracy/summary.md (2026-06-18)` |
...
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 7 | `data/live-helm-confighub-compare/summary.md (2026-06-20)`<br>`data/live-kind-parity/summary.md (2026-06-20)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-20)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 7 | `data/master-catalog-matrix/matrix.csv (2026-06-24)`<br>`data/master-catalog-matrix/matrix.html (2026-06-24)`<br>`data/master-catalog-matrix/summary.md (2026-06-24)` |
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 7 | `data/master-catalog-matrix/matrix.html (2026-06-24)`<br>`data/kind-parity-decisions/summary.md (2026-06-20)`<br>`data/live-parity-decisions/summary.md (2026-06-20)` |
| [docs/user/verify-it-yourself.md](../../docs/user/verify-it-yourself.md) | user | 2026-06-13 | 7 | `data/live-kind-parity/summary.md (2026-06-20)` |
| [README.md](../../README.md) | root | 2026-06-18 | 6 | `CATALOG.md (2026-06-24)`<br>`data/production-disposition/support-decision-contract.md (2026-06-24)`<br>`data/status-dashboard/summary.md (2026-06-24)` |
| [docs/reference/variant-promotion-closeout.md](../../docs/reference/variant-promotion-closeout.md) | reference | 2026-06-18 | 6 | `data/variant-promotion-closeout/summary.md (2026-06-24)`<br>`data/variant-promotion/status.csv (2026-06-24)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-18 | 6 | `CATALOG.md (2026-06-24)`<br>`data/attack-plan-workdown/summary.md (2026-06-24)`<br>`data/master-catalog-matrix/matrix.html (2026-06-24)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-18 | 6 | `data/master-catalog-matrix/matrix.html (2026-06-24)`<br>`data/outcome-evidence-contract/summary.md (2026-06-24)` |
| [docs/user/product-support-tiers.md](../../docs/user/product-support-tiers.md) | user | 2026-06-11 | 6 | `data/image-digest-workdown/summary.md (2026-06-17)` |
...
| [docs/user/hard-questions.md](../../docs/user/hard-questions.md) | user | 2026-06-20 | 4 | `data/secret-lifecycle/summary.md (2026-06-24)` |
...
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-23 | 2 | `data/outcome-coverage/summary.md (2026-06-24)`<br>`data/status-dashboard/summary.md (2026-06-24)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-23 | 2 | `CATALOG.md (2026-06-24)`<br>`data/attack-plan-workdown/summary.md (2026-06-24)`<br>`data/outcome-coverage/summary.md (2026-06-24)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-23 | 2 | `data/outcome-coverage/summary.md (2026-06-24)`<br>`data/status-dashboard/summary.md (2026-06-24)` |
...
| [docs/planning/roadmap.md](../../docs/planning/roadmap.md) | planning | 2026-06-24 | 1 | `data/master-catalog-matrix/matrix.html (2026-06-24)`<br>`data/outcome-evidence-contract/summary.md (2026-06-24)`<br>`data/variant-promotion/summary.md (2026-06-24)` |
...
| [docs/user/gitops-adopter-guide.md](../../docs/user/gitops-adopter-guide.md) | user | 2026-06-21 | 1 | `tests/doctrine.md (2026-06-22)` |
