...
Snapshot as of 2026-06-13 (commit `5f0e4528`). Refresh with `npm run doc-freshness` — cheap, ride
...
| Fresh (no linked source newer than the doc) | 7 |
| **Review-due** | 38 |
...
| --- | --- | --- | ---: | --- |
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-10 | 3 | `data/live-helm-confighub-compare/summary.md (2026-06-13)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-12)`<br>`data/live-kind-parity/summary.md (2026-06-12)` |
| [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md) | planning | 2026-06-10 | 3 | `data/top100-coverage/summary.md (2026-06-12)` |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 3 | `data/outcome-coverage/base-outcomes.csv (2026-06-13)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-11)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 3 | `data/chart-use-guide/summary.md (2026-06-13)`<br>`data/outcome-coverage/base-outcomes.csv (2026-06-13)`<br>`data/top100-readiness/next80-queues.csv (2026-06-13)` |
| [docs/user/why-this-does-not-collapse.md](../../docs/user/why-this-does-not-collapse.md) | user | 2026-06-10 | 3 | `data/top100-coverage/summary.md (2026-06-12)`<br>`data/live-e2e/cub-scout-watchlist.md (2026-06-11)`<br>`data/quirk-coverage/summary.md (2026-06-10)` |
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 2 | `data/outcome-coverage/summary.md (2026-06-13)`<br>`data/status-dashboard/summary.md (2026-06-13)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-12)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-11 | 2 | `data/outcome-coverage/summary.md (2026-06-13)`<br>`CATALOG.md (2026-06-13)`<br>`data/top100-promotion-wave/summary.md (2026-06-12)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 2 | `data/outcome-coverage/summary.md (2026-06-13)` |
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-11 | 2 | `data/outcome-coverage/summary.md (2026-06-13)` |
| [docs/reference/helm-quirk-support-matrix.md](../../docs/reference/helm-quirk-support-matrix.md) | reference | 2026-06-11 | 2 | `data/top100-user-readiness/summary.md (2026-06-13)` |
...
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 2 | `data/outcome-coverage/base-outcomes.csv (2026-06-13)`<br>`data/outcome-coverage/chart-outcomes.csv (2026-06-13)`<br>`data/outcome-coverage/summary.md (2026-06-13)` |
...
| [docs/user/try-now.md](../../docs/user/try-now.md) | user | 2026-06-11 | 2 | `data/chart-use-guide/summary.md (2026-06-13)`<br>`data/top20-base-readiness/summary.md (2026-06-13)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 2 | `data/outcome-coverage/summary.md (2026-06-13)`<br>`tests/npm-scripts.md (2026-06-12)` |
...
| [README.md](../../README.md) | root | 2026-06-12 | 1 | `data/chart-use-guide/summary.md (2026-06-13)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-13)`<br>`data/status-dashboard/summary.md (2026-06-13)` |
| [docs/README.md](../../docs/README.md) | docs | 2026-06-12 | 1 | `data/chart-use-guide/summary.md (2026-06-13)`<br>`data/master-catalog-matrix/matrix.html (2026-06-13)`<br>`data/outcome-evidence-contract/summary.md (2026-06-13)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-12 | 1 | `data/outcome-coverage/summary.md (2026-06-13)`<br>`data/status-dashboard/summary.md (2026-06-13)`<br>`data/top20-base-readiness/summary.md (2026-06-13)` |
...
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-12 | 1 | `data/master-catalog-matrix/matrix.csv (2026-06-13)`<br>`data/master-catalog-matrix/matrix.html (2026-06-13)`<br>`data/master-catalog-matrix/summary.md (2026-06-13)` |
| [docs/user/README.md](../../docs/user/README.md) | user | 2026-06-12 | 1 | `data/chart-use-guide/summary.md (2026-06-13)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-12 | 1 | `data/chart-use-guide/summary.md (2026-06-13)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-13)`<br>`data/master-catalog-matrix/matrix.html (2026-06-13)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-12 | 1 | `data/chart-use-guide/summary.md (2026-06-13)`<br>`data/master-catalog-matrix/matrix.html (2026-06-13)`<br>`data/outcome-evidence-contract/summary.md (2026-06-13)` |
...
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-12 | 1 | `data/live-helm-confighub-compare/summary.md (2026-06-13)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-12)`<br>`data/status-dashboard/active-proof-queue.csv (2026-06-12)` |
| [docs/user/offering.md](../../docs/user/offering.md) | user | 2026-06-12 | 1 | `data/chart-use-guide/summary.md (2026-06-13)` |
...
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 1 | `data/master-catalog-matrix/summary.md (2026-06-13)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)`<br>`data/live-kind-parity/summary.md (2026-06-12)` |
| [docs/user/top100-status.md](../../docs/user/top100-status.md) | user | 2026-06-12 | 1 | `data/top100-readiness/summary.md (2026-06-13)`<br>`data/top100-user-readiness/summary.md (2026-06-13)`<br>`data/top20-base-readiness/start-here.md (2026-06-13)` |
| [docs/user/tutorial-sequence.md](../../docs/user/tutorial-sequence.md) | user | 2026-06-11 | 1 | `recipes/prometheus-community/prometheus/29.8.0/CATALOG.md (2026-06-12)` |
