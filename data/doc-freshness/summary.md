...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 49 | `data/outcome-coverage/base-outcomes.csv (2026-07-28)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-07-27)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
...
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 48 | `data/outcome-coverage/base-outcomes.csv (2026-07-28)`<br>`data/top100-readiness/readiness.csv (2026-07-28)`<br>`data/chart-use-guide/summary.md (2026-07-01)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 48 | `data/outcome-coverage/summary.md (2026-07-28)`<br>`tests/npm-scripts.md (2026-07-13)` |
...
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 47 | `data/outcome-coverage/base-outcomes.csv (2026-07-28)`<br>`data/top100-readiness/readiness.csv (2026-07-28)`<br>`data/top20-base-readiness/base-readiness.csv (2026-07-28)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 47 | `data/outcome-coverage/base-outcomes.csv (2026-07-28)`<br>`data/outcome-coverage/chart-outcomes.csv (2026-07-28)`<br>`data/outcome-coverage/summary.md (2026-07-28)` |
...
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 45 | `data/live-kind-parity/summary.md (2026-07-28)`<br>`data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/live-helm-confighub-compare/summary.md (2026-06-30)` |
...
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 43 | `data/kind-parity-decisions/summary.md (2026-07-28)`<br>`data/master-catalog-matrix/summary.md (2026-07-28)`<br>`data/matrix-completion-audit/summary.md (2026-07-28)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 43 | `data/kind-parity-decisions/summary.md (2026-07-28)`<br>`data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/lifecycle-route-actions/summary.md (2026-07-27)` |
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 43 | `data/live-kind-parity/summary.md (2026-07-28)`<br>`data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/status-dashboard/active-proof-queue.csv (2026-07-28)` |
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 42 | `data/outcome-coverage/summary.md (2026-07-28)`<br>`data/claims-register/summary.md (2026-07-27)`<br>`data/variant-goldens/derived-expansion-wave/README.md (2026-06-30)` |
| [docs/user/target-prerequisites-before-rerun.md](../../docs/user/target-prerequisites-before-rerun.md) | user | 2026-06-16 | 42 | `data/target-prerequisite-actions/summary.md (2026-07-28)`<br>`data/target-prerequisite-workdown/summary.md (2026-07-28)`<br>`data/model-gap-workdown/summary.md (2026-06-24)` |
...
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 41 | `data/kind-parity-decisions/summary.md (2026-07-28)`<br>`data/master-catalog-matrix/matrix.html (2026-07-28)`<br>`data/lifecycle-route-actions/summary.md (2026-07-27)` |
...
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-23 | 36 | `data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/outcome-coverage/summary.md (2026-07-28)`<br>`CATALOG.md (2026-07-28)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-23 | 36 | `data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/outcome-coverage/summary.md (2026-07-28)`<br>`data/status-dashboard/summary.md (2026-07-28)` |
...
| [docs/user/verification.md](../../docs/user/verification.md) | user | 2026-06-30 | 29 | `data/outcome-coverage/summary.md (2026-07-28)`<br>`data/status-dashboard/summary.md (2026-07-28)`<br>`tests/npm-scripts.md (2026-07-13)` |
| [docs/user/verify-it-yourself.md](../../docs/user/verify-it-yourself.md) | user | 2026-06-30 | 28 | `data/live-kind-parity/summary.md (2026-07-28)` |
...
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-07-26 | 2 | `data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/outcome-coverage/summary.md (2026-07-28)`<br>`data/status-dashboard/summary.md (2026-07-28)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-07-27 | 2 | `data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/master-catalog-matrix/matrix.html (2026-07-28)`<br>`data/outcome-coverage/summary.md (2026-07-28)` |
...
| [README.md](../../README.md) | root | 2026-07-28 | 1 | `data/live-kind-parity/summary.md (2026-07-28)`<br>`data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/status-dashboard/summary.md (2026-07-28)` |
| [docs/README.md](../../docs/README.md) | docs | 2026-07-28 | 1 | `data/master-catalog-matrix/matrix.html (2026-07-28)`<br>`CATALOG.md (2026-07-28)`<br>`data/outcome-evidence-contract/summary.md (2026-07-28)` |
| [docs/planning/roadmap.md](../../docs/planning/roadmap.md) | planning | 2026-07-27 | 1 | `data/live-parity-rerun-plan/summary.md (2026-07-28)`<br>`data/master-catalog-matrix/matrix.html (2026-07-28)`<br>`data/outcome-evidence-contract/summary.md (2026-07-28)` |
