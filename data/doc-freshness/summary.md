...
Snapshot as of 2026-06-11 (commit `374846ed`). Refresh with `npm run doc-freshness` — cheap, ride
...
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-10 | 1 | `data/top20-base-readiness/base-readiness.csv (2026-06-11)`<br>`data/top100-readiness/readiness.csv (2026-06-11)`<br>`data/top100-readiness/summary.md (2026-06-11)` |
...
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 1 | `data/outcome-coverage/base-outcomes.csv (2026-06-11)`<br>`data/status-dashboard/summary.md (2026-06-11)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-11)` |
