...
Snapshot as of 2026-08-31 (commit `d0ae4523c`). Refresh with `npm run doc-freshness` - cheap, ride
...
- [docs/planning/stack-manifest-spec.md](../../docs/planning/stack-manifest-spec.md)
