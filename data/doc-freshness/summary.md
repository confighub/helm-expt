...
Snapshot as of 2026-08-09 (commit `22680bcd1`). Refresh with `npm run doc-freshness` - cheap, ride
...
| --- | --- | --- | ---: | --- |
| [docs/user/why-this-does-not-collapse.md](../../docs/user/why-this-does-not-collapse.md) | user | 2026-06-10 | 61 | `data/top100-coverage/summary.md (2026-08-09)`<br>`data/live-e2e/normalization-rules.md (2026-06-30)`<br>`data/quirk-coverage/summary.md (2026-06-24)` |
| [docs/reference/helm-quirk-support-matrix.md](../../docs/reference/helm-quirk-support-matrix.md) | reference | 2026-06-11 | 60 | `data/top100-user-readiness/summary.md (2026-08-09)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 60 | `data/chart-use-guide/summary.md (2026-08-09)`<br>`data/top100-coverage/work-queue.md (2026-08-09)`<br>`data/top100-readiness/next80-queues.csv (2026-08-09)` |
| [docs/reference/quirk-coverage.md](../../docs/reference/quirk-coverage.md) | reference | 2026-06-11 | 59 | `data/extension-slots/summary.md (2026-08-09)`<br>`data/quirk-coverage/coverage.csv (2026-06-24)`<br>`data/quirk-coverage/summary.md (2026-06-24)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 59 | `data/chart-facts/chart-facts.csv (2026-08-09)`<br>`data/top100-coverage/summary.md (2026-08-09)`<br>`data/top100-readiness/readiness.csv (2026-08-09)` |
...
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 59 | `CATALOG.md (2026-08-09)`<br>`data/attack-plan-workdown/summary.md (2026-08-09)`<br>`data/extension-slots/summary.md (2026-08-09)` |
| [docs/user/top100-status.md](../../docs/user/top100-status.md) | user | 2026-06-12 | 58 | `data/top100-readiness/summary.md (2026-08-09)`<br>`data/top100-user-readiness/summary.md (2026-08-09)`<br>`data/top20-base-readiness/start-here.md (2026-07-28)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 53 | `data/master-catalog-matrix/matrix.csv (2026-08-09)`<br>`data/master-catalog-matrix/matrix.html (2026-08-09)`<br>`data/top100-readiness/summary.md (2026-08-09)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-18 | 53 | `data/master-catalog-matrix/matrix.html (2026-08-09)`<br>`data/chart-use-guide/summary.md (2026-08-09)`<br>`data/runtime-gitops/summary.md (2026-08-09)` |
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 53 | `data/master-catalog-matrix/matrix.html (2026-08-09)`<br>`data/lifecycle-route-actions/summary.md (2026-07-29)`<br>`data/live-matrix-burndown/summary.md (2026-07-29)` |
| [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md) | planning | 2026-06-21 | 50 | `data/top100-coverage/summary.md (2026-08-09)`<br>`tests/README.md (2026-07-28)` |
...
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-23 | 48 | `CATALOG.md (2026-08-09)`<br>`data/attack-plan-workdown/summary.md (2026-08-09)`<br>`data/chart-facts/summary.md (2026-08-09)` |
...
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-23 | 48 | `data/status-dashboard/summary.md (2026-08-09)`<br>`data/live-parity-rerun-plan/summary.md (2026-07-29)`<br>`data/outcome-coverage/summary.md (2026-07-29)` |
...
| [docs/planning/chart-claim-integrity-audit-2026-06-22.md](../../docs/planning/chart-claim-integrity-audit-2026-06-22.md) | planning | 2026-06-23 | 47 | `scripts/verify-chart-claim-integrity.mjs (2026-08-09)`<br>`tests/persona-ux-strategy.md (2026-07-14)`<br>`data/chart-claim-integrity-audit-2026-06-22/summary.md (2026-07-02)` |
...
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 43 | `data/claims-register/summary.md (2026-07-29)`<br>`data/outcome-coverage/summary.md (2026-07-29)`<br>`data/variant-goldens/derived-expansion-wave/README.md (2026-06-30)` |
...
| [docs/user/offering.md](../../docs/user/offering.md) | user | 2026-06-30 | 41 | `data/chart-use-guide/summary.md (2026-08-09)` |
| [docs/user/verification.md](../../docs/user/verification.md) | user | 2026-06-30 | 41 | `data/status-dashboard/summary.md (2026-08-09)`<br>`data/outcome-coverage/summary.md (2026-07-29)`<br>`tests/npm-scripts.md (2026-07-28)` |
...
| [docs/user/hard-questions.md](../../docs/user/hard-questions.md) | user | 2026-07-26 | 15 | `data/chart-use-guide/summary.md (2026-08-09)`<br>`data/claims-register/summary.md (2026-07-29)`<br>`data/secret-lifecycle/summary.md (2026-07-29)` |
| [docs/planning/roadmap.md](../../docs/planning/roadmap.md) | planning | 2026-07-27 | 14 | `data/master-catalog-matrix/matrix.html (2026-08-09)`<br>`data/chart-use-guide/summary.md (2026-08-09)`<br>`data/top50-completion/summary.md (2026-07-30)` |
...
| [docs/user/installer-oci-packages.md](../../docs/user/installer-oci-packages.md) | user | 2026-07-28 | 13 | `data/installer-oci-packages/packages.csv (2026-08-09)`<br>`data/installer-oci-packages/packages.json (2026-08-09)`<br>`data/installer-oci-packages/summary.md (2026-08-09)` |
...
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-07-29 | 12 | `data/master-catalog-matrix/matrix.html (2026-08-09)`<br>`CATALOG.md (2026-08-09)`<br>`data/attack-plan-workdown/summary.md (2026-08-09)` |
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-07-29 | 11 | `data/status-dashboard/summary.md (2026-08-09)` |
| [docs/user/README.md](../../docs/user/README.md) | user | 2026-07-30 | 11 | `data/chart-use-guide/summary.md (2026-08-09)`<br>`data/app-readiness/summary.md (2026-08-07)` |
| [docs/user/choosing-commands.md](../../docs/user/choosing-commands.md) | user | 2026-08-02 | 7 | `data/chart-use-guide/summary.md (2026-08-09)` |
| [docs/user/gitops-adopter-guide.md](../../docs/user/gitops-adopter-guide.md) | user | 2026-08-02 | 7 | `tests/doctrine.md (2026-08-09)` |
| [docs/user/helm-presets-and-values.md](../../docs/user/helm-presets-and-values.md) | user | 2026-08-02 | 7 | `data/confighub-example-guides/summary.md (2026-08-09)` |
...
| [docs/user/config-catalog-demonstrations.md](../../docs/user/config-catalog-demonstrations.md) | user | 2026-08-08 | 2 | `data/installer-oci-packages/summary.md (2026-08-09)` |
| [README.md](../../README.md) | root | 2026-08-08 | 1 | `CATALOG.md (2026-08-09)`<br>`data/extension-slots/summary.md (2026-08-09)`<br>`data/runtime-gitops/summary.md (2026-08-09)` |
| [docs/README.md](../../docs/README.md) | docs | 2026-08-09 | 1 | `data/master-catalog-matrix/matrix.html (2026-08-09)`<br>`CATALOG.md (2026-08-09)`<br>`data/attack-plan-workdown/summary.md (2026-08-09)` |
...
| [docs/planning/aicr-nim-track-backlog.md](../../docs/planning/aicr-nim-track-backlog.md) | planning | 2026-08-09 | 1 | `data/receipt-aging/summary.md (2026-08-09)`<br>`data/credential-boundary/summary.md (2026-08-09)`<br>`tests/doctrine.md (2026-08-09)` |
