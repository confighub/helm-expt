...
Snapshot as of 2026-08-10 (commit `dd5ec2925`). Refresh with `npm run doc-freshness` - cheap, ride
...
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 61 | `data/outcome-coverage/base-outcomes.csv (2026-08-10)`<br>`data/chart-use-guide/summary.md (2026-08-10)`<br>`data/outcome-coverage/feature-outcomes.csv (2026-08-10)` |
| [docs/user/why-this-does-not-collapse.md](../../docs/user/why-this-does-not-collapse.md) | user | 2026-06-10 | 61 | `data/top100-coverage/summary.md (2026-08-10)`<br>`data/live-e2e/normalization-rules.md (2026-06-30)`<br>`data/quirk-coverage/summary.md (2026-06-24)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 60 | `data/outcome-coverage/summary.md (2026-08-10)` |
| [docs/reference/helm-quirk-support-matrix.md](../../docs/reference/helm-quirk-support-matrix.md) | reference | 2026-06-11 | 60 | `data/top100-user-readiness/summary.md (2026-08-10)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 60 | `data/outcome-coverage/base-outcomes.csv (2026-08-10)`<br>`data/top100-coverage/summary.md (2026-08-10)`<br>`data/top100-readiness/readiness.csv (2026-08-10)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 60 | `data/outcome-coverage/base-outcomes.csv (2026-08-10)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-08-10)`<br>`CATALOG.md (2026-08-10)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 60 | `data/outcome-coverage/summary.md (2026-08-10)`<br>`tests/npm-scripts.md (2026-07-28)` |
...
| [docs/user/top100-status.md](../../docs/user/top100-status.md) | user | 2026-06-12 | 59 | `data/top100-readiness/summary.md (2026-08-10)`<br>`data/top100-user-readiness/summary.md (2026-08-10)`<br>`data/top20-base-readiness/start-here.md (2026-07-28)` |
...
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 55 | `data/outcome-coverage/summary.md (2026-08-10)`<br>`data/claims-register/summary.md (2026-07-29)`<br>`data/variant-goldens/derived-expansion-wave/README.md (2026-06-30)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 53 | `data/master-catalog-matrix/matrix.csv (2026-08-10)`<br>`data/master-catalog-matrix/matrix.html (2026-08-10)`<br>`data/master-catalog-matrix/summary.md (2026-08-10)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-18 | 53 | `data/master-catalog-matrix/matrix.html (2026-08-10)`<br>`data/chart-use-guide/summary.md (2026-08-10)`<br>`data/runtime-gitops/summary.md (2026-08-09)` |
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 53 | `data/master-catalog-matrix/matrix.html (2026-08-10)`<br>`data/lifecycle-route-actions/summary.md (2026-08-10)`<br>`data/live-matrix-burndown/summary.md (2026-08-10)` |
| [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md) | planning | 2026-06-21 | 50 | `data/top100-coverage/summary.md (2026-08-10)`<br>`tests/README.md (2026-07-28)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-23 | 48 | `CATALOG.md (2026-08-10)`<br>`data/next-ten-waves/summary.md (2026-08-10)`<br>`data/outcome-coverage/summary.md (2026-08-10)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-23 | 48 | `data/next-ten-waves/summary.md (2026-08-10)`<br>`data/outcome-coverage/summary.md (2026-08-10)`<br>`data/status-dashboard/summary.md (2026-08-09)` |
...
| [docs/user/verification.md](../../docs/user/verification.md) | user | 2026-06-30 | 41 | `data/outcome-coverage/summary.md (2026-08-10)`<br>`data/status-dashboard/summary.md (2026-08-09)`<br>`tests/npm-scripts.md (2026-07-28)` |
...
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-07-29 | 12 | `data/outcome-coverage/summary.md (2026-08-10)`<br>`data/status-dashboard/summary.md (2026-08-09)` |
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-07-29 | 12 | `data/master-catalog-matrix/matrix.html (2026-08-10)`<br>`CATALOG.md (2026-08-10)`<br>`data/chart-use-guide/summary.md (2026-08-10)` |
| [docs/user/serious-chart-proof.md](../../docs/user/serious-chart-proof.md) | user | 2026-07-29 | 12 | `recipes/prometheus-community/kube-prometheus-stack/85.3.3/CATALOG.md (2026-08-10)` |
| [docs/user/README.md](../../docs/user/README.md) | user | 2026-07-30 | 11 | `data/chart-use-guide/summary.md (2026-08-10)`<br>`data/app-readiness/summary.md (2026-08-07)` |
| [docs/user/helm-render-intents.md](../../docs/user/helm-render-intents.md) | user | 2026-07-30 | 11 | `data/helm-render-intents/intents.csv (2026-08-10)`<br>`data/helm-render-intents/intents.json (2026-08-10)`<br>`data/helm-render-intents/intents/prometheus-community-prometheus-29-8-0-server-only-ephemeral.yaml (2026-08-10)` |
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-08-02 | 8 | `data/master-catalog-matrix/summary.md (2026-08-10)`<br>`data/outcome-coverage/base-outcomes.csv (2026-08-10)`<br>`data/disposition-frontier/summary.md (2026-08-10)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-08-02 | 8 | `data/lifecycle-route-actions/summary.md (2026-08-10)` |
...
| [docs/user/chart-hooks-what-happens.md](../../docs/user/chart-hooks-what-happens.md) | user | 2026-08-02 | 8 | `data/lifecycle-route-actions/summary.md (2026-08-10)`<br>`data/per-chart-hooks/summary.md (2026-08-10)` |
| [docs/user/choosing-commands.md](../../docs/user/choosing-commands.md) | user | 2026-08-02 | 8 | `data/chart-use-guide/summary.md (2026-08-10)` |
...
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-08-02 | 8 | `data/master-catalog-matrix/summary.md (2026-08-10)` |
| [docs/user/variants-after-upload.md](../../docs/user/variants-after-upload.md) | user | 2026-08-02 | 8 | `data/master-catalog-matrix/summary.md (2026-08-10)` |
