...
Snapshot as of 2026-07-27 (commit `9c77901f8`). Refresh with `npm run doc-freshness` - cheap, ride
...
| [docs/user/helm-render-intents.md](../../docs/user/helm-render-intents.md) | user | 2026-07-09 | 18 | `data/helm-render-intents/intents.json (2026-07-27)`<br>`data/helm-render-intents/intents/prometheus-community-kube-prometheus-stack-85-3-3-no-crds.yaml (2026-07-26)` |
...
| [README.md](../../README.md) | root | 2026-07-27 | 1 | `data/base-variant-records/summary.md (2026-07-27)` |
