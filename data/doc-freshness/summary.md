...
Snapshot as of 2026-06-18 (commit `94648d98`). Refresh with `npm run doc-freshness` - cheap, ride
...
| Fresh (no linked source newer than the doc) | 9 |
| **Review-due** | 48 |
...
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 8 | `data/outcome-coverage/base-outcomes.csv (2026-06-18)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-06-17)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 8 | `data/outcome-coverage/base-outcomes.csv (2026-06-18)`<br>`data/top100-promotion-wave/summary.md (2026-06-17)`<br>`data/top100-readiness/next80-queues.csv (2026-06-17)` |
...
| [docs/planning/agreed-execution-plan.md](../../docs/planning/agreed-execution-plan.md) | planning | 2026-06-11 | 7 | `data/live-parity-rerun-plan/summary.md (2026-06-18)`<br>`data/outcome-coverage/summary.md (2026-06-18)`<br>`data/status-dashboard/summary.md (2026-06-18)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 7 | `data/outcome-coverage/summary.md (2026-06-18)` |
...
| [docs/reference/proof-kit-migration.md](../../docs/reference/proof-kit-migration.md) | reference | 2026-06-11 | 7 | `data/live-helm-confighub-compare/summary.md (2026-06-18)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 7 | `data/outcome-coverage/base-outcomes.csv (2026-06-18)`<br>`data/top100-coverage/summary.md (2026-06-17)`<br>`data/top100-readiness/readiness.csv (2026-06-17)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 7 | `data/README.md (2026-06-18)`<br>`data/csv-index.csv (2026-06-18)`<br>`data/outcome-coverage/base-outcomes.csv (2026-06-18)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-06-12 | 7 | `data/live-kind-parity/summary.md (2026-06-18)`<br>`data/master-catalog-matrix/summary.md (2026-06-18)`<br>`packages/jetstack/cert-manager/v1.20.2/installer.yaml (2026-06-13)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 7 | `data/outcome-coverage/summary.md (2026-06-18)`<br>`tests/npm-scripts.md (2026-06-12)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-12 | 6 | `data/live-parity-rerun-plan/summary.md (2026-06-18)`<br>`data/master-catalog-matrix/matrix.csv (2026-06-18)`<br>`data/master-catalog-matrix/matrix.html (2026-06-18)` |
...
| [README.md](../../README.md) | root | 2026-06-13 | 5 | `data/live-helm-confighub-compare/summary.md (2026-06-18)`<br>`data/live-kind-parity/summary.md (2026-06-18)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-18)` |
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-13 | 5 | `data/live-parity-rerun-plan/summary.md (2026-06-18)`<br>`data/outcome-coverage/summary.md (2026-06-18)`<br>`data/attack-plan-workdown/summary.md (2026-06-17)` |
| [docs/planning/helm-community-persona-plan.md](../../docs/planning/helm-community-persona-plan.md) | planning | 2026-06-13 | 5 | `data/live-helm-confighub-compare/summary.md (2026-06-18)`<br>`data/live-kind-parity/summary.md (2026-06-18)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-18)` |
...
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-16 | 3 | `data/kind-parity-decisions/summary.md (2026-06-18)`<br>`data/live-matrix-burndown/summary.md (2026-06-18)`<br>`data/live-parity-decisions/summary.md (2026-06-18)` |
| [docs/README.md](../../docs/README.md) | docs | 2026-06-17 | 2 | `data/master-catalog-matrix/matrix.html (2026-06-18)`<br>`data/attack-plan-workdown/summary.md (2026-06-17)`<br>`data/outcome-evidence-contract/summary.md (2026-06-17)` |
...
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-16 | 2 | `data/live-parity-rerun-plan/summary.md (2026-06-18)`<br>`data/outcome-coverage/summary.md (2026-06-18)`<br>`data/status-dashboard/summary.md (2026-06-18)` |
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 2 | `data/matrix-completion-audit/summary.md (2026-06-18)`<br>`data/disposition-frontier/summary.md (2026-06-18)`<br>`data/kind-parity-decisions/summary.md (2026-06-18)` |
...
| [docs/reference/variant-promotion-closeout.md](../../docs/reference/variant-promotion-closeout.md) | reference | 2026-06-16 | 2 | `data/variant-promotion-closeout/summary.md (2026-06-18)`<br>`data/variant-promotion/status.csv (2026-06-18)` |
| [docs/user/current-proof-status.md](../../docs/user/current-proof-status.md) | user | 2026-06-16 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-18)`<br>`data/live-parity-rerun-plan/summary.md (2026-06-18)`<br>`data/master-catalog-matrix/matrix.html (2026-06-18)` |
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-16 | 2 | `data/master-catalog-matrix/matrix.html (2026-06-18)`<br>`data/outcome-evidence-contract/summary.md (2026-06-17)` |
| [docs/user/live-parity.md](../../docs/user/live-parity.md) | user | 2026-06-16 | 2 | `data/live-helm-confighub-compare/summary.md (2026-06-18)`<br>`data/live-kind-parity/summary.md (2026-06-18)`<br>`data/live-matrix-burndown/summary.md (2026-06-18)` |
