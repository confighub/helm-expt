...
Snapshot as of 2026-07-27 (commit `9d6d46abd`). Refresh with `npm run doc-freshness` - cheap, ride
...
| --- | --- | --- | ---: | --- |
| [docs/user/helm-pain-points.md](../../docs/user/helm-pain-points.md) | user | 2026-06-10 | 48 | `data/outcome-coverage/base-outcomes.csv (2026-07-27)`<br>`data/variant-path-coverage/coverage-matrix.csv (2026-07-27)`<br>`data/pain-point-coverage/pain-points.csv (2026-06-10)` |
| [docs/planning/large-machine-handover.md](../../docs/planning/large-machine-handover.md) | planning | 2026-06-11 | 47 | `data/outcome-coverage/summary.md (2026-07-27)` |
| [docs/reference/helm-quirk-support-matrix.md](../../docs/reference/helm-quirk-support-matrix.md) | reference | 2026-06-11 | 47 | `data/top100-user-readiness/summary.md (2026-07-27)` |
| [docs/user/outcomes-and-tests.md](../../docs/user/outcomes-and-tests.md) | user | 2026-06-11 | 47 | `data/README.md (2026-07-27)`<br>`data/csv-index.csv (2026-07-27)`<br>`data/outcome-coverage/base-outcomes.csv (2026-07-27)` |
| [docs/user/top100-readiness.md](../../docs/user/top100-readiness.md) | user | 2026-06-10 | 47 | `data/outcome-coverage/base-outcomes.csv (2026-07-27)`<br>`data/chart-use-guide/summary.md (2026-07-01)`<br>`data/production-disposition/next-actions.csv (2026-06-30)` |
| [docs/user/verification-lanes.md](../../docs/user/verification-lanes.md) | user | 2026-06-11 | 47 | `data/outcome-coverage/summary.md (2026-07-27)`<br>`tests/npm-scripts.md (2026-07-13)` |
| [docs/reference/top100-user-readiness.md](../../docs/reference/top100-user-readiness.md) | reference | 2026-06-12 | 46 | `data/outcome-coverage/base-outcomes.csv (2026-07-27)`<br>`data/top100-user-readiness/readiness.csv (2026-07-27)`<br>`data/top100-user-readiness/summary.md (2026-07-27)` |
...
| [docs/user/top100-status.md](../../docs/user/top100-status.md) | user | 2026-06-12 | 45 | `data/top100-user-readiness/summary.md (2026-07-27)`<br>`data/top20-base-readiness/start-here.md (2026-07-01)`<br>`data/top100-readiness/summary.md (2026-06-30)` |
| [docs/planning/where-does-my-hook-go.md](../../docs/planning/where-does-my-hook-go.md) | planning | 2026-06-14 | 44 | `data/lifecycle-routes/routes.json (2026-07-27)`<br>`data/lifecycle-routes/summary.md (2026-07-27)` |
...
| [docs/planning/next-20-tasks.md](../../docs/planning/next-20-tasks.md) | planning | 2026-06-16 | 42 | `data/outcome-coverage/summary.md (2026-07-27)`<br>`data/claims-register/summary.md (2026-07-27)`<br>`data/variant-goldens/derived-expansion-wave/README.md (2026-06-30)` |
| [docs/reference/matrix-completion-audit.md](../../docs/reference/matrix-completion-audit.md) | reference | 2026-06-16 | 42 | `data/master-catalog-matrix/summary.md (2026-07-27)`<br>`data/matrix-completion-audit/summary.md (2026-07-27)`<br>`data/outcome-coverage/base-outcomes.csv (2026-07-27)` |
| [docs/reference/residue-families.md](../../docs/reference/residue-families.md) | reference | 2026-06-16 | 42 | `data/lifecycle-route-actions/summary.md (2026-07-27)`<br>`data/production-disposition/support-decision-contract.md (2026-06-30)`<br>`data/kind-parity-decisions/summary.md (2026-06-20)` |
| [docs/reference/master-catalog-matrix.md](../../docs/reference/master-catalog-matrix.md) | reference | 2026-06-18 | 40 | `data/master-catalog-matrix/matrix.csv (2026-07-27)`<br>`data/master-catalog-matrix/matrix.html (2026-07-27)`<br>`data/master-catalog-matrix/summary.md (2026-07-27)` |
...
| [docs/user/generative-gitops-fit.md](../../docs/user/generative-gitops-fit.md) | user | 2026-06-18 | 40 | `data/master-catalog-matrix/matrix.html (2026-07-27)`<br>`data/outcome-evidence-contract/summary.md (2026-07-27)`<br>`data/claims-register/summary.md (2026-07-27)` |
| [docs/user/reading-the-matrix.md](../../docs/user/reading-the-matrix.md) | user | 2026-06-18 | 40 | `data/lifecycle-route-actions/summary.md (2026-07-27)`<br>`data/master-catalog-matrix/matrix.html (2026-07-27)`<br>`data/kind-parity-decisions/summary.md (2026-06-20)` |
...
| [docs/planning/current-handover.md](../../docs/planning/current-handover.md) | planning | 2026-06-23 | 35 | `data/outcome-coverage/summary.md (2026-07-27)`<br>`tests/npm-scripts.md (2026-07-13)`<br>`CATALOG.md (2026-07-01)` |
| [docs/planning/next-execution-plan.md](../../docs/planning/next-execution-plan.md) | planning | 2026-06-23 | 35 | `data/outcome-coverage/summary.md (2026-07-27)`<br>`data/status-dashboard/summary.md (2026-07-27)`<br>`data/top20-base-readiness/summary.md (2026-07-01)` |
| [docs/user/verification.md](../../docs/user/verification.md) | user | 2026-06-30 | 28 | `data/outcome-coverage/summary.md (2026-07-27)`<br>`data/status-dashboard/summary.md (2026-07-27)`<br>`tests/npm-scripts.md (2026-07-13)` |
| [docs/user/variants-after-upload.md](../../docs/user/variants-after-upload.md) | user | 2026-07-03 | 25 | `data/master-catalog-matrix/summary.md (2026-07-27)` |
...
| [docs/user/helm-render-intents.md](../../docs/user/helm-render-intents.md) | user | 2026-07-09 | 18 | `data/helm-render-intents/intents.csv (2026-07-27)`<br>`data/helm-render-intents/intents.json (2026-07-27)`<br>`data/helm-render-intents/intents/prometheus-community-kube-prometheus-stack-85-3-3-no-crds.yaml (2026-07-27)` |
| [docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | user | 2026-07-09 | 18 | `data/master-catalog-matrix/summary.md (2026-07-27)` |
...
| [README.md](../../README.md) | root | 2026-07-27 | 1 | `data/base-variant-records/summary.md (2026-07-27)`<br>`data/apply-policy-profiles/summary.md (2026-07-27)`<br>`data/status-dashboard/summary.md (2026-07-27)` |
...
| [docs/reference/config-catalog-doctrine.md](../../docs/reference/config-catalog-doctrine.md) | reference | 2026-07-27 | 1 | `data/redis-upgrade-app-proof/summary.md (2026-07-27)` |
...
| [docs/user/config-catalog-demonstrations.md](../../docs/user/config-catalog-demonstrations.md) | user | 2026-07-27 | 1 | `data/redis-upgrade-app-proof/summary.md (2026-07-27)`<br>`data/apply-policy-profiles/live-helm-catalog.yaml (2026-07-27)`<br>`data/base-variant-records/summary.md (2026-07-27)` |
