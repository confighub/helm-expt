...
**Goal:** K: run the 4 ready kind-parity row(s) with predicted remote-image / target-runtime (bitnami/spark@10.0.3, bitnami/zookeeper@13.8.7, elastic/kibana@8.5.1); each kind-parity command classifies the K cell. Confirm or reclassify from each receipt.
