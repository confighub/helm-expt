...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 834 / 31 / 53 / 304 / 122 |
...
| Variants currently in the active proof queue | 15 |
...
| Active proof queue | 15 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `bitnami/mongodb@19.0.9/existing-secret-replicaset`, `bitnami/mongodb@19.1.0/existing-secret-replicaset` |
