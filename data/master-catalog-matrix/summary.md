...
| Chart versions | 110 |
| Variant rows | 191 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 655 / 2 / 59 / 499 / 122 |
| Variants with the complete core lane set | 47 |
...
| Complete the core proof lane | 144 | Rows missing at least one core evidence lane: ConfigHub proof, live Kubernetes, GitOps/OCI, or live parity. | `aqua/trivy-operator@0.32.1/no-crds`, `argo-cd/argo-cd@9.5.15/no-crds`, `argo-cd/argo-cd@9.5.17/default` |
