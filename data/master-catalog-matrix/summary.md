...
| Chart versions | 110 |
| Variant rows | 190 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 545 / 18 / 59 / 708 / 0 |
| Variants with the complete core lane set | 27 |
...
| Complete the core proof lane | 163 | Rows missing at least one core evidence lane: ConfigHub proof, live Kubernetes, GitOps/OCI, or live parity. | `aqua/trivy-operator@0.32.1/default`, `aqua/trivy-operator@0.32.1/no-crds`, `argo-cd/argo-cd@9.5.15/no-crds` |
