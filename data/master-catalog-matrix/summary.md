...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 788 / 13 / 53 / 368 / 122 |
| Variants with the complete core lane set | 85 |
...
| Variants currently in the active proof queue | 6 |
...
| Complete the core proof lane | 107 | Rows missing at least one core evidence lane: ConfigHub proof, live Kubernetes, GitOps/OCI, or live parity. | `argo-cd/argo-cd@9.5.15/no-crds`, `argo-cd/argo-cd@9.5.17/default`, `argo-cd/argo-cd@9.5.17/no-crds` |
| Active proof queue | 6 | Rows with a current non-pass live parity result and an exact rerun or review action. | `grafana/pyroscope@2.0.2/default`, `grafana/tempo@1.24.4/s3-query-observability`, `hashicorp/consul@2.0.0/secure-mesh-existing-secrets` |
