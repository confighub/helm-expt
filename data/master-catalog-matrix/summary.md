...
| Chart versions | 140 |
| Matrix rows | 466 |
| F1 source / F2 base / candidate / F4 derived rows | 140 / 246 / 67 / 13 |
| Layer rows | F1:140 / F2a:125 / F2b:121 / F2c:33 / F3:34 / F4a:7 / F4b:6 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / - | 1039 / 107 / 125 / 308 / 1683 |
...
| Server-side variant promotion (proven / watch / todo / blocked / n/a) | 179 / 17 / 48 / 2 / 220 |
| Lifecycle route contracts (observed / watch / todo / n/a) | 20 / 0 / 1 / 445 |
| Render-intent lifecycle records (attached / gap / no separate route) | 12 / 10 / 224 |
| Render-intent prerequisite records (attached / gap / none explicitly required) | 89 / 145 / 12 |
...
| Promote after review | 82 | Proof-grade rows that need catalog/product review before becoming public starting points. | `aqua/trivy-operator@0.32.1/default`, `aqua/trivy-operator@0.32.1/no-crds`, `argo-cd/argo-events@2.4.21/default` |
...
| Complete the core proof lane | 128 | Real base or derived rows missing at least one core evidence lane: ConfigHub proof, live Kubernetes, GitOps/OCI, or live parity. | `argo-cd/argo-cd@9.5.15/no-crds`, `argo-cd/argo-cd@9.5.17/default`, `argo-cd/argo-cd@9.5.17/no-crds` |
...
| Decide target run scope | 233 | Rows without a target run decision or target-bound receipt yet. | `aqua/trivy-operator@0.32.1/default`, `aqua/trivy-operator@0.32.1/no-crds`, `argo-cd/argo-cd@9.5.15/no-crds` |
