...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 919 / 81 / 92 / 132 / 120 |
...
| Variants currently in the active proof queue | 54 |
...
| Active proof queue | 54 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `autoscaler/cluster-autoscaler@9.57.0/controller-default-reviewed`, `aws-ebs-csi-driver/aws-ebs-csi-driver@2.60.1/default` |
