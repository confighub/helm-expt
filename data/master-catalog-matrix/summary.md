...
| Active proof queue | 2 | Rows with a current non-pass live parity result and an exact rerun or review action. | `autoscaler/cluster-autoscaler@9.57.0/default`, `hashicorp/consul@2.0.0/secure-mesh-existing-secrets` |
