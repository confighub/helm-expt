...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 902 / 55 / 57 / 208 / 122 |
...
| Variants currently in the active proof queue | 30 |
...
| Active proof queue | 30 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `autoscaler/cluster-autoscaler@9.57.0/controller-default-reviewed`, `bitnami/mongodb@19.0.9/existing-secret-replicaset` |
