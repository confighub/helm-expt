...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 870 / 35 / 57 / 260 / 122 |
...
| Variants currently in the active proof queue | 20 |
...
| Active proof queue | 20 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `argo-cd/argo-workflows@1.0.14/controller-default-reviewed`, `autoscaler/cluster-autoscaler@9.57.0/controller-default-reviewed` |
