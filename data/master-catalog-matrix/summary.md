...
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / - | 967 / 114 / 113 / 100 / 1478 |
...
| Rows currently in the active proof queue | 82 |
| Cells with deferred accepted disposition | 145 |
...
| Active proof queue | 82 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `autoscaler/cluster-autoscaler@9.57.0/controller-default-reviewed`, `aws-ebs-csi-driver/aws-ebs-csi-driver@2.60.1/default` |
...
|  | F2b | base | legacy | next80 | `lookup;generated-facts;tpl;capabilities` | - | - | ✅ | ✅ | ✅ | - | ⚠️ | ⚠️ | ⬜ | ✅ | run | local-live | ⬜ |
...
|  | F2b | base | legacy | next80 | `lookup;generated-facts;tpl;capabilities;stateful-storage` | - | - | ✅ | ✅ | ✅ | - | ⚠️ | ⚠️ | ⬜ | ✅ | run | local-live | ⬜ |
...
|  | F2b | base | legacy | next80 | - | - | - | ✅ | ✅ | ✅ | - | ⚠️ | ⚠️ | ⬜ | ✅ | run | local-live | ⬜ |
