...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 810 / 21 / 53 / 338 / 122 |
...
| Variants currently in the active proof queue | 10 |
...
| Active proof queue | 10 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `bitnami/mongodb@19.0.9/existing-secret-replicaset`, `grafana/pyroscope@2.0.2/default` |
