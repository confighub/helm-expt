...
| Chart versions | 110 |
| Variant rows | 191 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 714 / 0 / 54 / 447 / 122 |
| Variants with the complete core lane set | 74 |
...
| Complete the core proof lane | 117 | Rows missing at least one core evidence lane: ConfigHub proof, live Kubernetes, GitOps/OCI, or live parity. | `argo-cd/argo-cd@9.5.15/no-crds`, `argo-cd/argo-cd@9.5.17/default`, `argo-cd/argo-cd@9.5.17/no-crds` |
