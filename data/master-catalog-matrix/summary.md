...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 840 / 33 / 53 / 296 / 122 |
...
| Variants currently in the active proof queue | 16 |
...
| Active proof queue | 16 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `bitnami/mongodb@19.0.9/existing-secret-replicaset`, `bitnami/mongodb@19.1.0/existing-secret-replicaset` |
