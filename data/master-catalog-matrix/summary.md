...
| Chart versions | 110 |
| Variant rows | 192 |
| Lane cells ✅ / ⚠️ / ❌ / ⬜ / — | 808 / 19 / 53 / 342 / 122 |
...
| Variants currently in the active proof queue | 9 |
...
| Active proof queue | 9 | Rows with a current non-pass live parity result and an exact rerun or review action. | `argo-cd/argo-cd@9.5.17/default`, `grafana/pyroscope@2.0.2/default`, `grafana/tempo@1.24.4/s3-query-observability` |
