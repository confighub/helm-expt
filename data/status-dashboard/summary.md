...
| proof lanes | two-cluster kind parity pass rows | 81/85 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| proof lanes | two-cluster semantic parity pass rows | 83/85 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| live evidence | two-cluster kind parity receipts | 85/85 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| live evidence | live parity rerun rows needing decisions | 21/21 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live parity rows needing model or staging first | 2/21 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live parity rows needing target review first | 17/21 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live matrix commands remaining | 172 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
...
| live evidence | live matrix two-cluster kind commands remaining | 111 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
...
| live evidence | two-cluster semantic parity defect receipts | 0/85 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| two-cluster kind parity | 81 | 4 | 0 | 85 |
