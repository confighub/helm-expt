...
| --- | --- | ---: | --- | --- |
| top100 | charts with model support | 105/107 | good | [data/outcome-coverage/chart-outcomes.csv](../../data/outcome-coverage/chart-outcomes.csv) |
...
| top100 | variant-rich charts | 61/107 | partial | [data/outcome-coverage/chart-outcomes.csv](../../data/outcome-coverage/chart-outcomes.csv) |
...
| proof lanes | render parity rows | 173/173 | good | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | in-ConfigHub proof rows | 20/173 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | local live rows | 23/173 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | GitOps/OCI live pass rows | 22/173 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | live Helm-vs-ConfigHub parity pass rows | 20/173 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
...
| proof lanes | complete core lane rows | 20/173 | gap | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
...
| graph bridge | charts with recovered graph fragments | 20/107 | partial | [data/edge-recovery/edges.csv](../../data/edge-recovery/edges.csv) |
...
| --- | ---: | --- |
| Write replacement decisions | 4 | Review the latest-aligned candidate against the supported version and record a target-scoped replacement decision. |
...
| --- | ---: | ---: | ---: | ---: |
| in-ConfigHub | 20 | 0 | 153 | 173 |
| local live | 23 | 0 | 150 | 173 |
| GitOps/OCI live | 22 | 6 | 145 | 173 |
| live Helm-vs-ConfigHub parity | 20 | 2 | 151 | 173 |
