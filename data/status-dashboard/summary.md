...
| production support decisions | supported decision artifacts | 9/20 | gap | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
| production support decisions | draft decision artifacts | 11/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| --- | ---: | --- |
| Supported scope evidence | 9 | Keep target-scoped evidence fresh before using the supported scope as a production example. |
...
| Scan scope decision | 9 | Record which scanner findings are accepted, fixed, or outside the supported target scope. |
...
| Fresh target-scoped evidence | 7 | After scope and risk decisions are closed, refresh ConfigHub OCI/GitOps and live/e2e evidence for that exact scope. |
...
| supported decision artifacts | 9/20 |
| draft decision artifacts | 11/20 |
