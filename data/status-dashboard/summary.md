...
| proof lanes | GitOps/OCI live pass rows | 132/192 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | live Helm-vs-ConfigHub parity pass rows | 132/192 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | two-cluster kind parity pass rows | 100/106 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| proof lanes | two-cluster semantic parity pass rows | 105/106 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| live evidence | selected live Helm-vs-ConfigHub parity receipts | 132/151 | partial | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| live evidence | live parity rows needing target review first | 19/24 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live matrix commands remaining | 152 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | live matrix GitOps/OCI parity commands remaining | 60 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | live matrix two-cluster kind commands remaining | 92 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | GitOps aggregate health residue rows | 1/151 | partial | [data/gitops-health-residue/residue.csv](../../data/gitops-health-residue/residue.csv) |
| live evidence | ConfigHub/OCI semantic parity defect receipts | 0/151 | good | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| GitOps/OCI live | 132 | 19 | 41 | 192 |
| live Helm-vs-ConfigHub parity | 132 | 19 | 41 | 192 |
| two-cluster kind parity | 100 | 6 | 0 | 106 |
...
~~~text
ConfigHub/OCI live comparison: 0/151
