...
| proof lanes | GitOps/OCI live pass rows | 70/191 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | live Helm-vs-ConfigHub parity pass rows | 70/191 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
...
| proof lanes | complete core lane rows | 69/191 | gap | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
...
| live evidence | selected live Helm-vs-ConfigHub parity receipts | 70/70 | good | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| live evidence | ConfigHub/OCI semantic parity defect receipts | 0/70 | good | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| --- | ---: |
| live-helm-vs-confighub-parity | 43 |
...
| GitOps/OCI live | 70 | 1 | 120 | 191 |
| live Helm-vs-ConfigHub parity | 70 | 0 | 121 | 191 |
...
~~~text
ConfigHub/OCI live comparison: 0/70
