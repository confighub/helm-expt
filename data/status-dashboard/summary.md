...
| proof lanes | two-cluster kind parity pass rows | 105/115 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| proof lanes | two-cluster semantic parity pass rows | 111/115 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| live evidence | two-cluster kind parity receipts | 115/115 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| live evidence | live parity rerun rows needing decisions | 36/36 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live parity rows needing model or staging first | 5/36 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live parity rows needing target review first | 27/36 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live matrix commands remaining | 145 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
...
| live evidence | live matrix two-cluster kind commands remaining | 87 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
...
| live evidence | two-cluster semantic parity defect receipts | 3/115 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| Queue | Rows | Next action |
| --- | ---: | --- |
| inspect-diff-first | 3 | Inspect the semantic diff before another rerun. |
...
| two-cluster kind parity | 105 | 10 | 0 | 115 |
...
| --- | ---: | --- |
| inspect-parity-diff | 3 | Inspect the semantic object diff before changing waits, target provisioning, or the recipe. |
