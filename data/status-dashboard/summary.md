...
| production disposition | top20 production-review-ready charts | 15/20 | partial | [data/production-disposition/top20.csv](../../data/production-disposition/top20.csv) |
| production disposition | top20 production-blocked charts | 5/20 | partial | [data/production-disposition/top20.csv](../../data/production-disposition/top20.csv) |
| production disposition | charts with accepted production dispositions | 15/20 | partial | [data/production-disposition/top20.csv](../../data/production-disposition/top20.csv) |
...
| production-review-ready pending final support decision | 15/20 |
| production-blocked pending disposition | 5/20 |
| charts with accepted dispositions | 15/20 |
| high-priority scan rows | 4/20 |
| mutable-image rows still needing fixes | 0/20 |

| Open disposition | Charts |
| --- | ---: |
| cluster RBAC review | 5 |
| scan/gate warning disposition | 5 |
| CRD lifecycle and upgrade policy | 4 |
| extension slot provenance and scan policy | 4 |
| webhook readiness and failure policy | 4 |
| hook and lifecycle phase policy | 3 |
| storage backup restore and rollback policy | 3 |
