...
| production support decisions | target-scoped decision artifacts | 1/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| target-scoped support decision artifacts | 1/20 |
