...
| proof lanes | GitOps/OCI live pass rows | 78/191 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | live Helm-vs-ConfigHub parity pass rows | 78/191 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
...
| proof lanes | complete core lane rows | 77/191 | gap | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
...
| live evidence | selected live Helm-vs-ConfigHub parity receipts | 78/80 | partial | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| live evidence | ConfigHub/OCI semantic parity defect receipts | 0/80 | good | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| GitOps/OCI live | 78 | 1 | 112 | 191 |
| live Helm-vs-ConfigHub parity | 78 | 2 | 111 | 191 |
...
~~~text
ConfigHub/OCI live comparison: 0/80
