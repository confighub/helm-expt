...
| production support decisions | supported decision artifacts | 6/20 | gap | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
| production support decisions | draft decision artifacts | 14/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| --- | ---: | --- |
| Supported scope evidence | 6 | Keep target-scoped evidence fresh before using the supported scope as a production example. |
...
| Scan scope decision | 11 | Record which scanner findings are accepted, fixed, or outside the supported target scope. |
...
| Fresh target-scoped evidence | 9 | After scope and risk decisions are closed, refresh ConfigHub OCI/GitOps and live/e2e evidence for that exact scope. |
...
| supported decision artifacts | 6/20 |
| draft decision artifacts | 14/20 |
