...
| production support decisions | supported decision artifacts | 14/20 | gap | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
| production support decisions | draft decision artifacts | 6/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| --- | ---: | --- |
| Supported scope evidence | 14 | Keep target-scoped evidence fresh before using the supported scope as a production example. |
| Image digest resolution or exception | 5 | Pin images by digest or record an explicit exception before production OCI support. |
...
| supported decision artifacts | 14/20 |
| draft decision artifacts | 6/20 |
