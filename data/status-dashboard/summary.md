...
| live evidence | selected live Helm-vs-ConfigHub parity receipts | 102/112 | partial | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
| live evidence | live matrix commands remaining | 209 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | live matrix GitOps/OCI parity commands remaining | 90 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
...
| live evidence | GitOps aggregate health residue rows | 1/112 | partial | [data/gitops-health-residue/residue.csv](../../data/gitops-health-residue/residue.csv) |
| live evidence | ConfigHub/OCI semantic parity defect receipts | 0/112 | good | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
...
~~~text
ConfigHub/OCI live comparison: 0/112
