...
| proof lanes | GitOps/OCI live pass rows | 131/192 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | live Helm-vs-ConfigHub parity pass rows | 131/192 | partial | [data/outcome-coverage/base-outcomes.csv](../../data/outcome-coverage/base-outcomes.csv) |
| proof lanes | two-cluster kind parity pass rows | 84/89 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| proof lanes | two-cluster semantic parity pass rows | 87/89 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| live evidence | selected live Helm-vs-ConfigHub parity receipts | 131/149 | partial | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
| live evidence | two-cluster kind parity receipts | 89/89 | partial | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
| live evidence | live parity rerun rows needing decisions | 22/22 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live parity rows needing model or staging first | 3/22 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live parity rows needing target review first | 17/22 | partial | [data/live-parity-rerun-plan/rerun-plan.csv](../../data/live-parity-rerun-plan/rerun-plan.csv) |
| live evidence | live matrix commands remaining | 169 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | live matrix GitOps/OCI parity commands remaining | 61 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | live matrix two-cluster kind commands remaining | 108 | gap | [data/live-matrix-burndown/work-items.csv](../../data/live-matrix-burndown/work-items.csv) |
| live evidence | GitOps aggregate health residue rows | 1/149 | partial | [data/gitops-health-residue/residue.csv](../../data/gitops-health-residue/residue.csv) |
| live evidence | ConfigHub/OCI semantic parity defect receipts | 0/149 | good | [data/live-helm-confighub-compare/summary.csv](../../data/live-helm-confighub-compare/summary.csv) |
| live evidence | two-cluster semantic parity defect receipts | 0/89 | good | [data/live-kind-parity/summary.csv](../../data/live-kind-parity/summary.csv) |
...
| argo-cd/argo-workflows@1.0.14 | controller-default-reviewed | blocked | inspect-receipt | - |
...
| GitOps/OCI live | 131 | 18 | 43 | 192 |
| live Helm-vs-ConfigHub parity | 131 | 18 | 43 | 192 |
| two-cluster kind parity | 84 | 5 | 0 | 89 |
...
~~~text
ConfigHub/OCI live comparison: 0/149
two-cluster kind parity:       0/89
~~~
...
| gitops-runtime-review | 13 | Inspect GitOps/controller health and rerun after target conditions or controller waits are corrected. |
...
| --- | --- | --- | --- |
| argo-cd/argo-workflows@1.0.14 | controller-default-reviewed | blocked | blocked: inspect receipt |
