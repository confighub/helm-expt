...
| production support decisions | supported decision artifacts | 7/20 | gap | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
| production support decisions | draft decision artifacts | 13/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| --- | ---: | --- |
| Supported scope evidence | 7 | Keep target-scoped evidence fresh before using the supported scope as a production example. |
| Image digest resolution or exception | 10 | Pin images by digest or record an explicit exception before production OCI support. |
| Scan scope decision | 11 | Record which scanner findings are accepted, fixed, or outside the supported target scope. |
| Security acceptance or hardened base | 2 | Accept current security findings for the target scope or create a narrower hardened base. |
...
| Runtime or missing-lane decision | 4 | Close the runtime, missing-lane, or lifecycle-observation decision before refreshing final evidence. |
...
| supported decision artifacts | 7/20 |
| draft decision artifacts | 13/20 |
