...
| production support decisions | supported decision artifacts | 4/20 | gap | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
| production support decisions | draft decision artifacts | 16/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| --- | ---: | --- |
| Supported scope evidence | 4 | Keep target-scoped evidence fresh before using the supported scope as a production example. |
| Image digest resolution or exception | 12 | Pin images by digest or record an explicit exception before production OCI support. |
| Scan scope decision | 13 | Record which scanner findings are accepted, fixed, or outside the supported target scope. |
...
| Fresh target-scoped evidence | 11 | After scope and risk decisions are closed, refresh ConfigHub OCI/GitOps and live/e2e evidence for that exact scope. |
...
| supported decision artifacts | 4/20 |
| draft decision artifacts | 16/20 |
