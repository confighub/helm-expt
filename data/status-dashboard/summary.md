...
| production support decisions | supported decision artifacts | 12/20 | gap | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
| production support decisions | draft decision artifacts | 8/20 | partial | [data/production-support-decisions/decisions.csv](../../data/production-support-decisions/decisions.csv) |
...
| --- | ---: | --- |
| Supported scope evidence | 12 | Keep target-scoped evidence fresh before using the supported scope as a production example. |
...
| Scan scope decision | 6 | Record which scanner findings are accepted, fixed, or outside the supported target scope. |
...
| supported decision artifacts | 12/20 |
| draft decision artifacts | 8/20 |
