...
| ---: | --- | --- | --- | --- | --- |
| 1 | `bitnami/redis@25.5.3` | default | pass | - | runs/redis-local-kind/latest/observation-receipt.yaml |
| 2 | `metrics-server/metrics-server@3.13.0` | default | pass | - | runs/top20-local-kind/metrics-server-default/observation-receipt.json |
...
| 7 | `prometheus-community/kube-prometheus-stack@85.3.3` | default | pass | - | runs/top20-local-kind/kube-prometheus-stack-default/observation-receipt.json |
