...
| ---: | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `bitnami/mongodb@19.0.7` | existing-secret-replicaset | watch | watch: inspect receipt | - | `npm run live-parity:top20 -- --chart mongodb --base existing-secret-replicaset --repo-url oci://registry-1.docker.io/bitnamicharts --continue-on-fail` |
...
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `metrics-server/metrics-server@3.13.0` | external-tls-ca | watch | watch: inspect receipt | - | `npm run live-parity:top20 -- --chart metrics-server --base external-tls-ca --continue-on-fail` |
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `prometheus-community/prometheus@29.8.0` | default | watch | watch: inspect receipt | - | `npm run live-parity:top20 -- --chart prometheus --base default --continue-on-fail` |
