...
blocked: 0
watch: 16
configHub-oci-live-comparison: 16
...
| --- | ---: | ---: | ---: | ---: | ---: |
| configHub-oci-live-comparison | 16 | 0 | 16 | 0 | 0 |
...
| --- | ---: | --- |
| gitops-runtime-review | 12 | Inspect GitOps/controller health; rerun after target conditions or controller waits are corrected. |
