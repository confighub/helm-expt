...
2 row(s) currently point at an object-set parity defect; inspect those first. The rows below are the active work queue for stronger live
...
| inspect-parity-diff | 2 | Inspect the object diff before changing waits, target provisioning, or the recipe. |
