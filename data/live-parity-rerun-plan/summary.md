...
| --- | ---: | ---: | ---: | ---: | ---: |
| configHub-oci-live-comparison | 23 | 0 | 22 | 1 | 0 |
...
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `elastic/filebeat@8.5.1` | node-or-cluster-collector | watch | target-runtime: pod ContainerCreating (parity passed) | - | `npm run live-parity:run -- --recipe recipes/elastic/filebeat/8.5.1 --base node-or-cluster-collector` |
