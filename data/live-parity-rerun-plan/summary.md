...
blocked: 13
watch: 32
configHub-oci-live-comparison: 29
two-cluster-kind-parity: 16
semantic-parity-defects: 4
infra-or-rig-rows: 0
prerequisite-or-lifecycle-rows: 7
runtime-or-watch-rows: 32
```

## Current Interpretation

4 row(s) currently point at an object-set parity defect; inspect those first. The rows below are the active work queue for stronger live
...
| `bitnami/apache@11.4.29` | default | watch | Receipt exists and comparison did not fail; inspect readiness detail and decide whether this is acceptable target behavior. | Convert to pass only when expected live readiness settles, otherwise keep as watch with a clear target limitation. |
...
| `bitnami/opensearch@2.0.10` | default | watch | Receipt exists and comparison did not fail; inspect readiness detail and decide whether this is acceptable target behavior. | Convert to pass only when expected live readiness settles, otherwise keep as watch with a clear target limitation. |
| `bitnami/opensearch@2.0.10` | ha | watch | Receipt exists and comparison did not fail; inspect readiness detail and decide whether this is acceptable target behavior. | Convert to pass only when expected live readiness settles, otherwise keep as watch with a clear target limitation. |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| configHub-oci-live-comparison | 29 | 0 | 27 | 2 | 0 |
| two-cluster-kind-parity | 16 | 0 | 5 | 11 | 0 |
...
| stage-prerequisite | 7 | Stage or model CRDs, APIs, Secrets, storage, or another prerequisite before rerunning. |
...
| model-or-stage-first | 8 | Stage the prerequisite, choose the lifecycle route, or record the operating policy before rerunning. |
| review-target-first | 32 | Review runtime, storage, controller health, or wait conditions before rerunning. |
...
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `bitnami/apache@11.4.29` | default | watch | target-runtime: pod config/runtime errors (parity passed) | - | `npm run live-parity:run -- --recipe recipes/bitnami/apache/11.4.29 --base default --repo-url oci://registry-1.docker.io/bitnamicharts` |
...
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `bitnami/opensearch@2.0.10` | default | watch | target-runtime: pod config/runtime errors (parity passed) | - | `npm run live-parity:run -- --recipe recipes/bitnami/opensearch/2.0.10 --base default --repo-url oci://registry-1.docker.io/bitnamicharts` |
| 30 | review-target-first | runtime-review | configHub-oci-live-comparison | `bitnami/opensearch@2.0.10` | ha | watch | target-runtime: pod config/runtime errors (parity passed) | - | `npm run live-parity:run -- --recipe recipes/bitnami/opensearch/2.0.10 --base ha --repo-url oci://registry-1.docker.io/bitnamicharts` |
