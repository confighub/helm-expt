...
Of the 16 candidates, 16 carry a model-profile
record. 15 of those also carry a retention receipt, and
...
| `llama-3-3-nemotron-49b-2xgpu` | `llama-3-3-nemotron-49b` | `2xgpu` | 2 | `nvcr.io/nim/nvidia/llama-3.3-nemotron-super-49b-v1:1.8.2` | yes | yes | no |
| `llama3-70b-instruct-2xgpu` | `llama3-70b-instruct` | `2xgpu` | 2 | `nvcr.io/nim/meta/llama3-70b-instruct:1.0.0` | yes | yes | no |
| `llama3-70b-instruct-4xa100` | `llama3-70b-instruct` | `4xa100` | 4 | `nvcr.io/nim/meta/llama3-70b-instruct:1.0.0` | yes | yes | no |
| `llama3-70b-instruct-4xgpu` | `llama3-70b-instruct` | `4xgpu` | 4 | `nvcr.io/nim/meta/llama3-70b-instruct:1.0.0` | yes | yes | no |
| `llama3-70b-instruct-4xh100` | `llama3-70b-instruct` | `4xh100` | 4 | `nvcr.io/nim/meta/llama3-70b-instruct:1.0.0` | yes | yes | no |
| `llama3-8b-instruct-1xgpu` | `llama3-8b-instruct` | `1xgpu` | 1 | `nvcr.io/nim/meta/llama3-8b-instruct:1.0.0` | yes | yes | no |
| `llama3-8b-instruct-2xa100` | `llama3-8b-instruct` | `2xa100` | 2 | `nvcr.io/nim/meta/llama3-8b-instruct:1.0.0` | yes | yes | no |
| `llama3-8b-instruct-2xgpu` | `llama3-8b-instruct` | `2xgpu` | 2 | `nvcr.io/nim/meta/llama3-8b-instruct:1.0.0` | yes | yes | no |
| `llama3-8b-instruct-2xh100` | `llama3-8b-instruct` | `2xh100` | 2 | `nvcr.io/nim/meta/llama3-8b-instruct:1.0.0` | yes | yes | no |
| `mistral-7b-instruct-v03-1xgpu` | `mistral-7b-instruct-v03` | `1xgpu` | 1 | `nvcr.io/nim/mistralai/mistral-7b-instruct-v03:1.0.0` | yes | yes | no |
| `mixtral-8x22b-instruct-v01-8xgpu` | `mixtral-8x22b-instruct-v01` | `8xgpu` | 8 | `nvcr.io/nim/mistralai/mixtral-8x22b-instruct-v01:1.0.0` | yes | yes | no |
...
| `nv-rerankqa-mistral-4b-v3-1xgpu` | `nv-rerankqa-mistral-4b-v3` | `1xgpu` | 1 | `nvcr.io/nim/nvidia/nv-rerankqa-mistral-4b-v3:1.0.0` | yes | yes | no |
