...
| 5 | `external-secrets/external-secrets@2.5.0` | default | blocked | runs/live-helm-confighub-compare/external-secrets-external-secrets-default/receipt.yaml |
| 6 | `argo-cd/argo-cd@9.5.15` | default | blocked | runs/live-helm-confighub-compare/argo-cd-argo-cd-default/receipt.yaml |
| 7 | `prometheus-community/kube-prometheus-stack@85.3.3` | default | blocked | runs/live-helm-confighub-compare/prometheus-community-kube-prometheus-stack-default/receipt.yaml |
...
| 10 | `grafana/loki@7.0.0` | single-binary-filesystem | blocked | runs/live-helm-confighub-compare/grafana-loki-single-binary-filesystem/receipt.yaml |
| 11 | `longhorn/longhorn@1.11.2` | default | blocked | runs/live-helm-confighub-compare/longhorn-longhorn-default/receipt.yaml |
| 12 | `hashicorp/vault@0.32.0` | default | blocked | runs/live-helm-confighub-compare/hashicorp-vault-default/receipt.yaml |
...
| 19 | `grafana/tempo@1.24.4` | local-persistent | blocked | runs/live-helm-confighub-compare/grafana-tempo-local-persistent/receipt.yaml |
| 20 | `hashicorp/consul@2.0.0` | default-control-plane | blocked | runs/live-helm-confighub-compare/hashicorp-consul-default-control-plane/receipt.yaml |
