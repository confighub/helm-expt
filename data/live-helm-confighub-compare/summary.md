...
| 3 | `ingress-nginx/ingress-nginx@4.15.1` | admission-disabled | watch | gitops-runtime: Argo health Progressing (parity passed) | runs/live-helm-confighub-compare/ingress-nginx-ingress-nginx-admission-disabled/receipt.yaml |
...
| 19 | `grafana/tempo@1.24.4` | local-persistent | watch | target-runtime: PVC/storage pending (parity passed) | runs/live-helm-confighub-compare/grafana-tempo-local-persistent/receipt.yaml |
