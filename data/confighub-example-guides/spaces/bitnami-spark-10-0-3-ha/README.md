...
This is the `ha` preset config for `bitnami/spark@10.0.3`. The repo also calls this a base variant. Use this when you want the catalog's reviewed high-availability configuration.
