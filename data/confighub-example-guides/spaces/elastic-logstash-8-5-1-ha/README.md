...
We keep the Helm chart. We lock `elastic/logstash@8.5.1` and choose the `ha` preset config, then render it with the recorded values, namespace and release name against the recorded Kubernetes capabilities, and save the output as files.
