...
We keep the Helm chart. We lock `bitnami/elasticsearch@22.1.6`, choose the `legacy` preset config, render it with the recorded values, namespace, release name, and Kubernetes capabilities, then save the output as files.
