...
# bitnami/elasticsearch 22.1.6 - legacy
...
This is the `legacy` preset config for `bitnami/elasticsearch@22.1.6`. The repo also calls this a base variant. Use this when this package must use the legacy image location for the chart's containers.
...
We keep the Helm chart. We lock `bitnami/elasticsearch@22.1.6` and choose the `legacy` preset config, then render it with the recorded values, namespace and release name against the recorded Kubernetes capabilities, and save the output as files.
...
```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/bitnami-elasticsearch-22-1-6/legacy/try.sh)
```

Fast path with a ConfigHub account:

```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/bitnami-elasticsearch-22-1-6/legacy/confighub.sh)
```
...
| Render intent | [`data/helm-render-intents/intents/bitnami-elasticsearch-22-1-6-legacy.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/bitnami-elasticsearch-22-1-6-legacy.yaml) |
| Render variant | [`recipes/bitnami/elasticsearch/22.1.6/revisions/legacy/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/elasticsearch/22.1.6/revisions/legacy/r001/rendered/release-objects.yaml) |
| Package base | [`packages/bitnami/elasticsearch/22.1.6/bases/legacy`](https://github.com/confighub/helm-expt/tree/main/packages/bitnami/elasticsearch/22.1.6/bases/legacy) |
| Scripts | [try.sh](https://confighub.github.io/helm-expt/site/sh/bitnami-elasticsearch-22-1-6/legacy/try.sh) · [confighub.sh](https://confighub.github.io/helm-expt/site/sh/bitnami-elasticsearch-22-1-6/legacy/confighub.sh) |
...
- Render intent: [`data/helm-render-intents/intents/bitnami-elasticsearch-22-1-6-legacy.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/bitnami-elasticsearch-22-1-6-legacy.yaml)
- Rendered YAML: [`recipes/bitnami/elasticsearch/22.1.6/revisions/legacy/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/elasticsearch/22.1.6/revisions/legacy/r001/rendered/release-objects.yaml)
- Package source: [`packages/bitnami/elasticsearch/22.1.6/bases/legacy`](https://github.com/confighub/helm-expt/tree/main/packages/bitnami/elasticsearch/22.1.6/bases/legacy)
- Generated scripts: [`site/sh/bitnami-elasticsearch-22-1-6/legacy`](https://github.com/confighub/helm-expt/tree/main/site/sh/bitnami-elasticsearch-22-1-6/legacy)
