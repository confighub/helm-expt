...
This is the `default` preset config for `crossplane-stable/crossplane@2.3.1`. The repo also calls this a base variant. Use this when you want to start from the chart author's normal path, with the inputs recorded.

The matching catalog page is [crossplane-stable/crossplane@2.3.1](https://confighub.github.io/helm-expt/site/charts/crossplane-stable-crossplane-2-3-1.html).

## The chart journey

We keep the Helm chart. We lock `crossplane-stable/crossplane@2.3.1`, choose the `default` preset config, render it with the recorded values, namespace, release name, and Kubernetes capabilities, then save the output as files.
...
The public package is `oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/crossplane-stable-crossplane:2.3.1`. Users can pull it without cloning this repo. When someone runs `cub installer upload`, ConfigHub stores the rendered Kubernetes YAML in a Space so it can be searched, compared, reviewed, changed, and delivered. The example script defaults to Space `helm-crossplane-default`, but users can choose another name with `CUB_SPACE=...`.
...
```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/crossplane-stable-crossplane-2-3-1/default/try.sh)
```

Fast path with a ConfigHub account:

```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/crossplane-stable-crossplane-2-3-1/default/confighub.sh)
```
...
| Values | [`recipes/crossplane-stable/crossplane/2.3.1/effective-values.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/crossplane-stable/crossplane/2.3.1/effective-values.yaml) |
| Render intent | [`data/helm-render-intents/intents/crossplane-stable-crossplane-2-3-1-default.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/crossplane-stable-crossplane-2-3-1-default.yaml) |
| Render variant | [`recipes/crossplane-stable/crossplane/2.3.1/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/crossplane-stable/crossplane/2.3.1/revisions/default/r001/rendered/release-objects.yaml) |
| Package base | [`packages/crossplane-stable/crossplane/2.3.1/bases/default`](https://github.com/confighub/helm-expt/tree/main/packages/crossplane-stable/crossplane/2.3.1/bases/default) |
| Scripts | [try.sh](https://confighub.github.io/helm-expt/site/sh/crossplane-stable-crossplane-2-3-1/default/try.sh) · [confighub.sh](https://confighub.github.io/helm-expt/site/sh/crossplane-stable-crossplane-2-3-1/default/confighub.sh) |
...
- Chart page: [https://confighub.github.io/helm-expt/site/charts/crossplane-stable-crossplane-2-3-1.html](https://confighub.github.io/helm-expt/site/charts/crossplane-stable-crossplane-2-3-1.html)
- Render intent: [`data/helm-render-intents/intents/crossplane-stable-crossplane-2-3-1-default.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/crossplane-stable-crossplane-2-3-1-default.yaml)
- Rendered YAML: [`recipes/crossplane-stable/crossplane/2.3.1/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/crossplane-stable/crossplane/2.3.1/revisions/default/r001/rendered/release-objects.yaml)
- Package source: [`packages/crossplane-stable/crossplane/2.3.1/bases/default`](https://github.com/confighub/helm-expt/tree/main/packages/crossplane-stable/crossplane/2.3.1/bases/default)
- Generated scripts: [`site/sh/crossplane-stable-crossplane-2-3-1/default`](https://github.com/confighub/helm-expt/tree/main/site/sh/crossplane-stable-crossplane-2-3-1/default)
