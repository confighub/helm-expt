...
This is the `default` preset config for `nats/nack@0.34.0`. The repo also calls this a base variant. Use this when you want to start from the chart author's normal path, with the inputs recorded.

The matching catalog page is [nats/nack@0.34.0](https://confighub.github.io/helm-expt/site/charts/nats-nack-0-34-0.html).

## The chart journey

We keep the Helm chart. We lock `nats/nack@0.34.0`, choose the `default` preset config, render it with the recorded values, namespace, release name, and Kubernetes capabilities, then save the output as files.

That captured output is the render variant: [`recipes/nats/nack/0.34.0/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/nats/nack/0.34.0/revisions/default/r001/rendered/release-objects.yaml). It contains 10 Kubernetes object(s): CustomResourceDefinition x6, ClusterRole x1, ClusterRoleBinding x1, Deployment x1, ServiceAccount x1.

The public package is `oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/nats-nack:0.34.0`. Users can pull it without cloning this repo. When someone runs `cub installer upload`, ConfigHub stores the rendered Kubernetes YAML in a Space so it can be searched, compared, reviewed, changed, and delivered. The example script defaults to Space `helm-nack-default`, but users can choose another name with `CUB_SPACE=...`.
...
```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/nats-nack-0-34-0/default/try.sh)
```

Fast path with a ConfigHub account:

```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/nats-nack-0-34-0/default/confighub.sh)
```

The core render command is:

```sh
cub installer setup --pull oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/nats-nack:0.34.0 --base default --work-dir ./nats-nack-0-34-0-default --non-interactive --namespace default
```
...
| Namespace | `default` |
| Release name | `nack` |
| Values | [`recipes/nats/nack/0.34.0/effective-values.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/nats/nack/0.34.0/effective-values.yaml) |
| Render intent | [`data/helm-render-intents/intents/nats-nack-0-34-0-default.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/nats-nack-0-34-0-default.yaml) |
| Render variant | [`recipes/nats/nack/0.34.0/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/nats/nack/0.34.0/revisions/default/r001/rendered/release-objects.yaml) |
| Package base | [`packages/nats/nack/0.34.0/bases/default`](https://github.com/confighub/helm-expt/tree/main/packages/nats/nack/0.34.0/bases/default) |
| Scripts | [try.sh](https://confighub.github.io/helm-expt/site/sh/nats-nack-0-34-0/default/try.sh) · [confighub.sh](https://confighub.github.io/helm-expt/site/sh/nats-nack-0-34-0/default/confighub.sh) |
...
- Chart page: [https://confighub.github.io/helm-expt/site/charts/nats-nack-0-34-0.html](https://confighub.github.io/helm-expt/site/charts/nats-nack-0-34-0.html)
- Render intent: [`data/helm-render-intents/intents/nats-nack-0-34-0-default.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/nats-nack-0-34-0-default.yaml)
- Rendered YAML: [`recipes/nats/nack/0.34.0/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/nats/nack/0.34.0/revisions/default/r001/rendered/release-objects.yaml)
- Package source: [`packages/nats/nack/0.34.0/bases/default`](https://github.com/confighub/helm-expt/tree/main/packages/nats/nack/0.34.0/bases/default)
- Generated scripts: [`site/sh/nats-nack-0-34-0/default`](https://github.com/confighub/helm-expt/tree/main/site/sh/nats-nack-0-34-0/default)
