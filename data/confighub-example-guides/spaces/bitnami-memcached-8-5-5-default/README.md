...
This is the `default` preset config for `bitnami/memcached@8.5.5`. The repo also calls this a base variant. Use this when you want to start from the chart author's normal path, with the inputs recorded.

The matching catalog page is [bitnami/memcached@8.5.5](https://confighub.github.io/helm-expt/site/charts/bitnami-memcached-8-5-5.html).

## The chart journey

We keep the Helm chart. We lock `bitnami/memcached@8.5.5`, choose the `default` preset config, render it with the recorded values, namespace, release name, and Kubernetes capabilities, then save the output as files.
...
The public package is `oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/bitnami-memcached:8.5.5`. Users can pull it without cloning this repo. When someone runs `cub installer upload`, ConfigHub stores the rendered Kubernetes YAML in a Space so it can be searched, compared, reviewed, changed, and delivered. The example script defaults to Space `helm-memcached-default`, but users can choose another name with `CUB_SPACE=...`.
...
```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/bitnami-memcached-8-5-5/default/try.sh)
```

Fast path with a ConfigHub account:

```sh
bash <(curl -fsSL https://confighub.github.io/helm-expt/site/sh/bitnami-memcached-8-5-5/default/confighub.sh)
```
...
| Values | [`recipes/bitnami/memcached/8.5.5/effective-values.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/memcached/8.5.5/effective-values.yaml) |
| Render intent | [`data/helm-render-intents/intents/bitnami-memcached-8-5-5-default.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/bitnami-memcached-8-5-5-default.yaml) |
| Render variant | [`recipes/bitnami/memcached/8.5.5/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/memcached/8.5.5/revisions/default/r001/rendered/release-objects.yaml) |
| Package base | [`packages/bitnami/memcached/8.5.5/bases/default`](https://github.com/confighub/helm-expt/tree/main/packages/bitnami/memcached/8.5.5/bases/default) |
| Scripts | [try.sh](https://confighub.github.io/helm-expt/site/sh/bitnami-memcached-8-5-5/default/try.sh) · [confighub.sh](https://confighub.github.io/helm-expt/site/sh/bitnami-memcached-8-5-5/default/confighub.sh) |
...
- Chart page: [https://confighub.github.io/helm-expt/site/charts/bitnami-memcached-8-5-5.html](https://confighub.github.io/helm-expt/site/charts/bitnami-memcached-8-5-5.html)
- Render intent: [`data/helm-render-intents/intents/bitnami-memcached-8-5-5-default.yaml`](https://github.com/confighub/helm-expt/blob/main/data/helm-render-intents/intents/bitnami-memcached-8-5-5-default.yaml)
- Rendered YAML: [`recipes/bitnami/memcached/8.5.5/revisions/default/r001/rendered/release-objects.yaml`](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/memcached/8.5.5/revisions/default/r001/rendered/release-objects.yaml)
- Package source: [`packages/bitnami/memcached/8.5.5/bases/default`](https://github.com/confighub/helm-expt/tree/main/packages/bitnami/memcached/8.5.5/bases/default)
- Generated scripts: [`site/sh/bitnami-memcached-8-5-5/default`](https://github.com/confighub/helm-expt/tree/main/site/sh/bitnami-memcached-8-5-5/default)
