...
This filter names the 8 common checks explicitly:
...
| `platform/workload-sensitive-env-secret-refs` | block | Do not apply a supported Kubernetes workload that puts a password, token, API key, or secret key directly in an environment variable. |
