...
| --- | --- | --- | --- | ---: | --- |
| `aqua/trivy-operator@0.32.1` | default | `live-helm-vs-confighub-parity` | high=0, medium=19, gates=allow;warn | 4 | [aqua-trivy-operator-0-32-1.yaml](./aqua-trivy-operator-0-32-1.yaml) |
| `argo-cd/argo-events@2.4.21` | default | `live-helm-vs-confighub-parity` | high=0, medium=5, gates=allow;warn | 4 | [argo-cd-argo-events-2-4-21.yaml](./argo-cd-argo-events-2-4-21.yaml) |
| `argo-cd/argo-rollouts@2.40.9` | default | `live-helm-vs-confighub-parity` | high=0, medium=10, gates=allow;warn | 4 | [argo-cd-argo-rollouts-2-40-9.yaml](./argo-cd-argo-rollouts-2-40-9.yaml) |
| `argo-cd/argo-workflows@1.0.14` | controller-default-reviewed | `live-helm-vs-confighub-parity` | high=0, medium=22, gates=allow;warn | 4 | [argo-cd-argo-workflows-1-0-14.yaml](./argo-cd-argo-workflows-1-0-14.yaml) |
| `autoscaler/cluster-autoscaler@9.57.0` | controller-default-reviewed | `live-helm-vs-confighub-parity` | high=1, medium=4, gates=warn | 4 | [autoscaler-cluster-autoscaler-9-57-0.yaml](./autoscaler-cluster-autoscaler-9-57-0.yaml) |
| `autoscaler/vertical-pod-autoscaler@0.9.0` | default | `live-helm-vs-confighub-parity` | high=0, medium=25, gates=allow;warn | 4 | [autoscaler-vertical-pod-autoscaler-0-9-0.yaml](./autoscaler-vertical-pod-autoscaler-0-9-0.yaml) |
| `cloudnative-pg/cloudnative-pg@0.28.2` | default | `live-helm-vs-confighub-parity` | high=0, medium=16, gates=allow;warn | 9 | [cloudnative-pg-cloudnative-pg-0-28-2.yaml](./cloudnative-pg-cloudnative-pg-0-28-2.yaml) |
| `elastic/eck-operator@3.4.0` | default | `live-helm-vs-confighub-parity` | high=0, medium=18, gates=allow;warn | 8 | [elastic-eck-operator-3-4-0.yaml](./elastic-eck-operator-3-4-0.yaml) |
| `elastic/logstash@8.5.1` | default | `live-helm-vs-confighub-parity` | high=0, medium=0, gates=allow | 6 | [elastic-logstash-8-5-1.yaml](./elastic-logstash-8-5-1.yaml) |
...
| `prometheus-community/alertmanager@1.37.0` | default | `live-helm-vs-confighub-parity` | high=0, medium=0, gates=allow | 6 | [prometheus-community-alertmanager-1-37-0.yaml](./prometheus-community-alertmanager-1-37-0.yaml) |
| `prometheus-community/kube-state-metrics@7.4.0` | cluster-metrics-readonly | `live-helm-vs-confighub-parity` | high=0, medium=4, gates=warn | 8 | [prometheus-community-kube-state-metrics-7-4-0.yaml](./prometheus-community-kube-state-metrics-7-4-0.yaml) |
| `prometheus-community/prometheus-blackbox-exporter@11.10.0` | cluster-metrics-readonly | `live-helm-vs-confighub-parity` | high=0, medium=0, gates=allow | 5 | [prometheus-community-prometheus-blackbox-exporter-11-10-0.yaml](./prometheus-community-prometheus-blackbox-exporter-11-10-0.yaml) |
| `prometheus-community/prometheus-node-exporter@4.55.0` | cluster-metrics-readonly | `live-helm-vs-confighub-parity` | high=0, medium=2, gates=warn | 7 | [prometheus-community-prometheus-node-exporter-4-55-0.yaml](./prometheus-community-prometheus-node-exporter-4-55-0.yaml) |
