...
| bitnami/mongodb@19.0.7 | generated-passwords | a StorageClass / storage decision; target facts at variant time; mandatory chart inputs | choose whether generated-passwords is in production scope; close or document its render-only live-readiness issue first |
...
| bitnami/postgresql@18.6.7 | generated-passwords | an existing Secret for some bases (built); a StorageClass / storage decision; target facts at variant time; mandatory chart inputs | choose whether generated-passwords is in production scope; close or document its render-only live-readiness issue first |
