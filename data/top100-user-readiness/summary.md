...
| --- | --- | --- | --- |
| argo-cd/argo-cd@9.5.15 | default | a CRD ownership choice (crds vs no-crds base) | finish digest-resolution receipts for remaining affected variants, then choose pinned bases or explicit mutable-image exceptions |
...
| hashicorp/vault@0.32.0 | dev-mode | a StorageClass / storage decision; webhook/cert readiness at delivery time; mandatory chart inputs | write or fix the receipt for target fact preflight |
