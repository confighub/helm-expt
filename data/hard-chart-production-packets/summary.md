...
| `hashicorp/vault@0.32.0` | default | rejected | production-review-ready | Use dev-mode only for local/demo proof. A production Vault base must cover init/unseal, storage, TLS, backup/restore, and opera... | [packet](./packets/hashicorp-vault.md) |
