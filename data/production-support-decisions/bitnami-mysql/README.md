...
- [data/image-digest-workdown/receipts/bitnami-mysql/generated-passwords/image-digest-resolution.yaml](../../../data/image-digest-workdown/receipts/bitnami-mysql/generated-passwords/image-digest-resolution.yaml) - Registry digest resolution exists for the rendered generated-passwords MySQL image reference.
...
- [data/production-support-decisions/bitnami-mysql/security-decision.yaml](../../../data/production-support-decisions/bitnami-mysql/security-decision.yaml) - The target-scoped security decision accepts the generated-passwords PDB warning shape only for this public proof scope.
