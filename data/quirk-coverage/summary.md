...
| `capability-profile` | `partly-tracked` | 49 | 370 | 140/177 render receipts declare renderer flags and kubeVersion. |
| `helm-flag-profile` | `partly-tracked` | 140 | 177 | 140/177 render receipts include the expected flag profile. |
...
| `dependency-lock` | `tracked-and-surfaced` | 109 | 109 | 109 dependency locks found. |
