...
| `capability-profile` | `partly-tracked` | 49 | 370 | 138/175 render receipts declare renderer flags and kubeVersion. |
| `helm-flag-profile` | `partly-tracked` | 138 | 175 | 138/175 render receipts include the expected flag profile. |
...
| `dependency-lock` | `tracked-and-surfaced` | 108 | 108 | 108 dependency locks found. |
