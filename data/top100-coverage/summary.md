...
| --- | ---: | --- | --- |
| `aws-controllers-k8s/ec2-chart@1.18.4` | 63% | `not-ready` | review chart analysis and create a recipe candidate |
| `aws-controllers-k8s/eks-chart@1.16.3` | 63% | `not-ready` | review chart analysis and create a recipe candidate |
| `aws-controllers-k8s/iam-chart@1.7.3` | 63% | `not-ready` | review chart analysis and create a recipe candidate |
| `cloudpirates/nginx@0.16.1` | 63% | `needs-useful-variant` | add at least one user-shaped variant before catalog promotion |
| `cloudpirates/rabbitmq@0.21.13` | 63% | `needs-useful-variant` | add at least one user-shaped variant before catalog promotion |
| `cloudpirates/redis@0.34.11` | 63% | `needs-useful-variant` | add at least one user-shaped variant before catalog promotion |
| `karpenter/karpenter@1.14.0` | 63% | `not-ready` | review source/current-version drift and refresh recipe if needed |
| `nvidia/nvidia-device-plugin@0.19.3` | 63% | `not-ready` | review chart analysis and create a recipe candidate |
| `valkey/valkey@0.11.0` | 63% | `needs-useful-variant` | add at least one user-shaped variant before catalog promotion |
