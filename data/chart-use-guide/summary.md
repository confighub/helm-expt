...
| `bitnami/mongodb@19.0.7` | `generated-passwords (render-only)` | `live-helm-vs-confighub-parity` | Open the per-chart CATALOG.md, choose the recommended base, and run the cub installer setup command. |
...
| `bitnami/postgresql@18.6.7` | `generated-passwords (render-only)` | `live-helm-vs-confighub-parity` | Open the per-chart CATALOG.md, choose the recommended base, and run the cub installer setup command. |
