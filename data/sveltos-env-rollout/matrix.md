...
| --- | --- | --- | --- | --- | --- | --- |
| hx-sveltos-env-pilot | pilot | 1 | `r1-5ef2cd8aef8e` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-staging | staging | 2 | `r1-445596dc846a` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-a | prod | 3 | `r1-25f80d487bba` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-b | prod | 3 | `r1-25f80d487bba` | 1 | | awaiting-live-run (confighubai/confighub#4975) |

## After wave 1, pilot

| Cluster | Environment | Wave | Expected revision | Expected background replicas | Observed | Status |
| --- | --- | --- | --- | --- | --- | --- |
| hx-sveltos-env-pilot | pilot | 1 | `r2-4a7541e862f9` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-staging | staging | 2 | `r1-445596dc846a` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-a | prod | 3 | `r1-25f80d487bba` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-b | prod | 3 | `r1-25f80d487bba` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
...
| --- | --- | --- | --- | --- | --- | --- |
| hx-sveltos-env-pilot | pilot | 1 | `r2-4a7541e862f9` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-staging | staging | 2 | `r2-5471d24ca614` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-a | prod | 3 | `r1-25f80d487bba` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-b | prod | 3 | `r1-25f80d487bba` | 1 | | awaiting-live-run (confighubai/confighub#4975) |
...
| hx-sveltos-env-pilot | pilot | 1 | `r2-4a7541e862f9` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-staging | staging | 2 | `r2-5471d24ca614` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-a | prod | 3 | `r2-6d3daa60f562` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
| hx-sveltos-env-prod-b | prod | 3 | `r2-6d3daa60f562` | 2 | | awaiting-live-run (confighubai/confighub#4975) |
