...
| `argo-cd/argo-cd@9.5.15` | no-crds | blocked | runs/live-kind-parity/argo-cd-argo-cd-no-crds/receipt.yaml |
| `bitnami/mongodb@19.0.7` | existing-secret-replicaset | blocked | runs/live-kind-parity/bitnami-mongodb-existing-secret-replicaset/receipt.yaml |
...
| `external-secrets/external-secrets@2.5.0` | no-crds | blocked | runs/live-kind-parity/external-secrets-external-secrets-no-crds/receipt.yaml |
...
| `ingress-nginx/ingress-nginx@4.15.1` | default | watch | runs/live-kind-parity/ingress-nginx-ingress-nginx-default/receipt.yaml |
| `jetstack/cert-manager@v1.20.2` | crds-enabled | pass | runs/live-kind-parity/jetstack-cert-manager-crds-enabled/receipt.yaml |
| `jetstack/cert-manager@v1.20.2` | default | blocked | runs/live-kind-parity/jetstack-cert-manager-default/receipt.yaml |
...
| `metrics-server/metrics-server@3.13.0` | external-tls-ca | blocked | runs/live-kind-parity/metrics-server-metrics-server-external-tls-ca/receipt.yaml |
...
| `prometheus-community/kube-prometheus-stack@85.3.3` | no-crds | blocked | runs/live-kind-parity/prometheus-community-kube-prometheus-stack-no-crds/receipt.yaml |
