...
| `argo-cd/argo-cd@9.5.17` | no-crds | pass | pass |  |  | live parity passed | runs/live-kind-parity/argo-cd-argo-cd-no-crds/receipt.yaml |
...
| `bitnami/mongodb@19.1.0` | static-passwords | pass | pass |  |  | live parity passed | runs/live-kind-parity/bitnami-mongodb-static-passwords/receipt.yaml |
...
| `bitnami/mysql@14.0.3` | static-passwords | pass | pass |  |  | live parity passed | runs/live-kind-parity/bitnami-mysql-static-passwords/receipt.yaml |
| `bitnami/nginx@25.0.0` | existing-tls-ingress | pass | pass |  |  | live parity passed | runs/live-kind-parity/bitnami-nginx-existing-tls-ingress/receipt.yaml |
...
| `bitnami/postgresql@18.7.0` | static-passwords | pass | pass |  |  | live parity passed | runs/live-kind-parity/bitnami-postgresql-static-passwords/receipt.yaml |
...
| `bitnami/rabbitmq@16.0.14` | static-passwords | pass | pass |  |  | live parity passed | runs/live-kind-parity/bitnami-rabbitmq-static-passwords/receipt.yaml |
...
| `grafana/grafana@10.5.15` | static-passwords | pass | pass |  |  | live parity passed | runs/live-kind-parity/grafana-grafana-static-passwords/receipt.yaml |
...
| `projectcalico/tigera-operator@v3.32.0` | default | pass | pass |  |  | live parity passed | runs/live-kind-parity/projectcalico-tigera-operator-default/receipt.yaml |
...
| `prometheus-community/kube-prometheus-stack@86.1.0` | default | blocked | defect | parity: semantic object diff |  | semantic object parity defect | runs/live-kind-parity/prometheus-community-kube-prometheus-stack-default/receipt.yaml |
| `prometheus-community/kube-prometheus-stack@86.1.0` | no-crds | pass | pass |  |  | live parity passed | runs/live-kind-parity/prometheus-community-kube-prometheus-stack-no-crds/receipt.yaml |
...
| `prometheus-community/prometheus@29.9.0` | default | pass | pass |  |  | live parity passed | runs/live-kind-parity/prometheus-community-prometheus-default/receipt.yaml |
| `prometheus-community/prometheus@29.9.0` | server-only-ephemeral | pass | pass |  |  | live parity passed | runs/live-kind-parity/prometheus-community-prometheus-server-only-ephemeral/receipt.yaml |
...
| `runix/pgadmin4@1.62.0` | default | pass | pass |  |  | live parity passed | runs/live-kind-parity/runix-pgadmin4-default/receipt.yaml |
...
| `vm/victoria-logs-single@0.12.5` | default | pass | pass |  |  | live parity passed | runs/live-kind-parity/vm-victoria-logs-single-default/receipt.yaml |
