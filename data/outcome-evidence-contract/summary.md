...
| Can wrapper charts, values files, and customer overlays be supported without pretending they are simple public-chart installs? | gap | top100 user-shaped variant queue 36/89 partial; useful-base proposal rows 46 partial; useful-base realized rows 10/46 partial; useful-base proposals not yet built 36/46 gap; top100 promotion-review queue 40/89 partial | managed imports and reviewed overlay paths; arbitrary private overlays are not public-catalog guarantees | Convert more user-shaped variant queue rows into reviewed base or overlay examples. |
