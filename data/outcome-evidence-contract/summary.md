...
| Can I prove the ConfigHub/installer path did not secretly change Helm output? | backed | render parity rows 199/199 good; two-cluster semantic parity pass rows 153/178 good; ConfigHub/OCI semantic parity defect receipts 0/198 good | selected chart/version/base rows with committed receipts | Add or refresh live parity receipts when a base, chart version, or target profile changes. |
...
| Can Argo or Flux pull ConfigHub OCI and can I see that the workload actually works? | partial | GitOps/OCI live pass rows 135/199 partial; local live rows 148/199 partial; ConfigHub/OCI semantic parity defect receipts 0/198 good | live receipts for declared targets; local live is not the same as GitOps live | Keep GitOps/runtime receipts fresh and add more target-bound cub-scout witness runs. |
...
| Can I trust the project not to overclaim when a lane is missing or blocked? | refused | ConfigHub/OCI semantic parity defect receipts 0/198 good; two-cluster semantic parity defect receipts 16/178 good; source-scanned but not surfaced axes 5/26 gap | public claims must name chart, version, base, lane, and target profile | Keep rejected, partial, planned, watch, blocked, and missing statuses visible in public-facing summaries. |
...
| handle-hooks-and-lifecycle | data/hook-lifecycle/summary.md; data/hook-coverage/summary.md; data/lifecycle-boundary/summary.md; data/lifecycle-observations/cert-manager-eso/summary.md; data/hook-lifecycle/source-top100-hooks.csv; data/hook-lifecycle/maintained-hook-queue.csv; data/lifecycle-observations/cert-manager-eso/summary.csv; docs/user/hook-lifecycle-strategy.md; data/hooks-crds-app/summary.md; data/kps-lifecycle-route-proof/summary.md; runs/hook-lifecycle/gatekeeper-gatekeeper/default/latest/receipt.yaml; runs/kps-lifecycle-route-proof/receipt.yaml | `npm run hooks:lifecycle:verify; npm run hooks:coverage:verify; npm run lifecycle:boundary:verify; npm run lifecycle:cert-manager-eso:verify` |
