...
| --- | ---: | --- |
| `in-confighub-proof` | 1 | Rendered objects uploaded to ConfigHub and passed the ConfigHub proof lane. |
...
| `render-parity` | 26 | Regular Helm and cub installer setup render-equivalent objects. |
