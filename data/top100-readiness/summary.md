...
| `grafana/grafana@10.5.15` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | add production resource policy or accept chart defaults for local-test only; review pod security posture for the production target | `data/production-disposition/receipts/grafana-grafana/scan-gate-warning-disposition.yaml` | `production-disposition` |
...
| `ingress-nginx/ingress-nginx@4.15.1` | `try-from-public-catalog` | `local-kubernetes-live` | 2 | add production resource policy or accept chart defaults for local-test only; review pod security posture for the production target; review probe port wiring | `data/production-disposition/receipts/ingress-nginx-ingress-nginx/scan-gate-warning-disposition.yaml` | `production-disposition` |
...
| `prometheus-community/prometheus@29.8.0` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | record security acceptance or create a hardened base; add production resource policy or accept chart defaults for local-test only; review pod security posture for the production target | `data/production-disposition/receipts/prometheus-community-prometheus/scan-gate-warning-disposition.yaml` | `production-disposition` |
