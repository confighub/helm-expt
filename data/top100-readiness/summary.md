...
charts with live evidence on at least one variant: 26
...
| Expand live evidence | 74 | Select rows that only have render parity and add local, GitOps, or live Helm-vs-ConfigHub evidence. | The strongest evidence moves beyond render parity for the selected chart/base. | `traefik/traefik@40.2.0`<br>`gitlab/gitlab-runner@0.89.0`<br>`kyverno/kyverno@3.8.1`<br>`fluent/fluent-bit@0.57.6`<br>`runix/pgadmin4@1.62.0` |
...
| `render-parity` | 74 | Regular Helm and cub installer setup render-equivalent objects. |
