...
| --- | ---: | --- |
| `in-confighub-proof` | 3 | Rendered objects uploaded to ConfigHub and passed the ConfigHub proof lane. |
...
| `render-parity` | 24 | Regular Helm and cub installer setup render-equivalent objects. |
