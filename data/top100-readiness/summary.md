...
| --- | ---: | --- |
| `in-confighub-proof` | 4 | Rendered objects uploaded to ConfigHub and passed the ConfigHub proof lane. |
...
| `render-parity` | 23 | Regular Helm and cub installer setup render-equivalent objects. |
