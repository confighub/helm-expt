...
| What works as a proof but is not promoted yet? | 40 | The recipe/package proof exists and useful variants exist; run catalog review and selected live lanes. |
...
| Which proof-grade charts are closest to promotion? | 40 | Recipe/package proof and multiple variants exist, but catalog review is not done. | Run catalog promotion review and add live lanes for selected bases. |
...
| Promote proof-grade charts | 40 | Run catalog review on the closest proof-grade rows. | A chart has reviewed variants, live evidence for selected bases, and an updated catalog status. | `traefik/traefik@40.2.0`<br>`external-dns/external-dns@1.21.1`<br>`kyverno/kyverno@3.8.1`<br>`cloudnative-pg/cloudnative-pg@0.28.2`<br>`kedacore/keda@2.19.0` |
...
| `promote-after-review` | 40 | Recipe/package proof and multiple variants exist. It is a good candidate for catalog review and selected live lanes. | You are expanding the catalog or choosing the next charts for live evidence. |
...
| `promote-after-review` | 40 | 0 | No named hard gap currently blocks promotion review. |
...
| `proof-grade-ready-for-promotion-review` | 40 | Recipe/package proof exists and variants exist; needs human catalog promotion review. |
