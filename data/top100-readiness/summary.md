...
| `grafana/grafana@10.5.15` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | write or fix the receipt for cluster RBAC review | `data/production-disposition/receipts/grafana-grafana/cluster-rbac-review.yaml` | `production-disposition` |
