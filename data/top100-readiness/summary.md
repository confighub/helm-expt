...
| What works as a proof but is not promoted yet? | 41 | The recipe/package proof exists and useful variants exist; run catalog review and selected live lanes. |
...
| Which proof-grade charts are closest to promotion? | 41 | Recipe/package proof and multiple variants exist, but catalog review is not done. | Run catalog promotion review and add live lanes for selected bases. |
...
| Promote proof-grade charts | 41 | Run catalog review on the closest proof-grade rows. | A chart has reviewed variants, live evidence for selected bases, and an updated catalog status. | `traefik/traefik@40.2.0`<br>`external-dns/external-dns@1.21.1`<br>`kyverno/kyverno@3.8.1`<br>`cloudnative-pg/cloudnative-pg@0.28.2`<br>`kedacore/keda@2.19.0` |
...
| Expand live evidence | 23 | Select rows that only have render parity and add local, GitOps, or live Helm-vs-ConfigHub evidence. | The strongest evidence moves beyond render parity for the selected chart/base. | `karpenter/karpenter@1.14.0`<br>`valkey/valkey@0.11.0`<br>`aws-controllers-k8s/ec2-chart@1.18.4`<br>`aws-controllers-k8s/eks-chart@1.16.3`<br>`aws-controllers-k8s/iam-chart@1.7.3` |
...
| `promote-after-review` | 41 | Recipe/package proof and multiple variants exist. It is a good candidate for catalog review and selected live lanes. | You are expanding the catalog or choosing the next charts for live evidence. |
...
| `promote-after-review` | 41 | 0 | No named hard gap currently blocks promotion review. |
| `needs-useful-variant` | 36 | 6 | Add realistic variants first; any named hard gap should shape those variants or be disclosed. |
...
| `proof-grade-ready-for-promotion-review` | 41 | Recipe/package proof exists and variants exist; needs human catalog promotion review. |
