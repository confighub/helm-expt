...
charts with live evidence on at least one variant: 86
...
| Expand live evidence | 14 | Select rows that only have render parity and add local, GitOps, or live Helm-vs-ConfigHub evidence. | The strongest evidence moves beyond render parity for the selected chart/base. | - |
...
| --- | ---: | --- |
| `in-confighub-proof` | 14 | Rendered objects uploaded to ConfigHub and passed the ConfigHub proof lane. |
