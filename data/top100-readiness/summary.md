...
| `bitnami/mysql@14.0.3` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | accept PDB behavior or add a reviewed patch where the chart supports it | `data/production-disposition/receipts/bitnami-mysql/scan-gate-warning-disposition.yaml` | `production-disposition` |
...
| `bitnami/postgresql@18.6.7` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | accept PDB behavior or add a reviewed patch where the chart supports it | `data/production-disposition/receipts/bitnami-postgresql/scan-gate-warning-disposition.yaml` | `production-disposition` |
| `bitnami/rabbitmq@16.0.14` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | accept PDB behavior or add a reviewed patch where the chart supports it | `data/production-disposition/receipts/bitnami-rabbitmq/scan-gate-warning-disposition.yaml` | `production-disposition` |
