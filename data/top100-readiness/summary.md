...
| `bitnami/nginx@24.0.2` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | accept PDB behavior or add a reviewed patch where the chart supports it | `data/production-disposition/receipts/bitnami-nginx/scan-gate-warning-disposition.yaml` | `production-disposition` |
