...
| `ingress-nginx/ingress-nginx@4.15.1` | `try-from-public-catalog` | `local-kubernetes-live` | 2 | write or fix the receipt for cluster RBAC review | `data/production-disposition/receipts/ingress-nginx-ingress-nginx/cluster-rbac-review.yaml` | `production-disposition` |
