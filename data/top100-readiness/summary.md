...
| `bitnami/mysql@14.0.3` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | write or fix the hook and lifecycle phase policy disposition receipt | `data/production-disposition/receipts/bitnami-mysql/hook-and-lifecycle-phase-policy.yaml` | `production-disposition` |
...
| `bitnami/postgresql@18.6.7` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | write or fix the hook and lifecycle phase policy disposition receipt | `data/production-disposition/receipts/bitnami-postgresql/hook-and-lifecycle-phase-policy.yaml` | `production-disposition` |
| `bitnami/rabbitmq@16.0.14` | `try-from-public-catalog` | `live-helm-vs-confighub-parity` | 2 | write or fix the hook and lifecycle phase policy disposition receipt | `data/production-disposition/receipts/bitnami-rabbitmq/hook-and-lifecycle-phase-policy.yaml` | `production-disposition` |
