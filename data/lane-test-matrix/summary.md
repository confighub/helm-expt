...
```text
chart-recipe-variant rows: 177
complete core lane set: 20
incomplete core lane set: 157
```
...
| --- | ---: | ---: | ---: | ---: | ---: |
| helm_template_vs_installer_setup | 177 | 0 | 0 | 0 | 0 |
| confighub_upload_variant_scan_safe_ops | 20 | 157 | 0 | 0 | 0 |
| local_kind_kubectl_apply | 23 | 154 | 0 | 0 | 0 |
| confighub_oci_argo_live | 22 | 149 | 0 | 2 | 4 |
| live_helm_vs_confighub_dual_compare | 20 | 155 | 0 | 2 | 0 |
...
The live Helm-vs-ConfigHub dual comparison lane has 20 PASS receipt(s), 2 WATCH receipt(s), 0 BLOCKED receipt(s), 0 FAIL receipt(s), and 155 missing row(s). The ConfigHub OCI/Argo live lane has a harness, but this repo
