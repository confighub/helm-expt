...
complete core lane set: 17
incomplete core lane set: 140
```
...
| confighub_upload_variant_scan_safe_ops | 18 | 139 | 0 | 0 | 0 |
...
The live Helm-vs-ConfigHub dual comparison lane has 19 PASS receipt(s), 2 WATCH receipt(s), 0 BLOCKED receipt(s), 0 FAIL receipt(s), and 136 missing row(s). The ConfigHub OCI/Argo live lane has a harness, but this repo
