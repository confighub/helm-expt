...
| Close open dispositions | 1 | Write or fix missing disposition receipts before making a support decision.<br>`hashicorp/vault@0.32.0` (dev-mode) |
...
| `hashicorp/vault@0.32.0` | dev-mode, default, ha-raft-ui | pass | local-kind-observed | blocked | 5 | target fact preflight |
