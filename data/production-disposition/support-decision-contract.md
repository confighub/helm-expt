...
| `bitnami/mongodb@19.0.7` | generated-passwords | render-only | lifecycle-support-scope-decision | choose whether generated-passwords is in production scope; close or document its render-only live-readiness issue first |
| `bitnami/postgresql@18.6.7` | generated-passwords | render-only | lifecycle-support-scope-decision | choose whether generated-passwords is in production scope; close or document its render-only live-readiness issue first |
