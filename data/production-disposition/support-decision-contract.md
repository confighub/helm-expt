...
| Close open dispositions | 1 | Write or fix the missing disposition receipts before making a support decision.<br>`prometheus-community/kube-prometheus-stack@85.3.3` (default) |
