...
| `jetstack/cert-manager@v1.20.2` | default, crds-enabled | production-review-ready | 6 | 0 | 0 | recipe-hook-policy:no-hooks; lifecycle-observations:2/2 | 2 |
...
| `hashicorp/vault@0.32.0` | dev-mode | start-here | image-digest-resolution | 3 | resolve image digests for each affected variant before production OCI support |
