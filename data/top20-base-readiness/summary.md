...
| `ingress-nginx/ingress-nginx@4.15.1` | default | no | runtime-watch | review-target-first | target-runtime: installer-applied workload not ready at observation cutoff (parity passed) | inspect the receipt and rerun after target resources, storage, and waits are appropriate |
