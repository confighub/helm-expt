...
| `hashicorp/vault@0.32.0` | default | `cub installer setup --pull packages/hashicorp/vault/0.32.0 --base default --work-dir <tmp> --non-interactive --namespace vault` | check production decision for hashicorp/vault |
...
| `ingress-nginx/ingress-nginx@4.15.1` | admission-disabled | `cub installer setup --pull packages/ingress-nginx/ingress-nginx/4.15.1 --base admission-disabled --work-dir <tmp> --non-interactive --namespace ingress-nginx` | check production decision for ingress-nginx/ingress-nginx |
| `ingress-nginx/ingress-nginx@4.15.1` | default | `cub installer setup --pull packages/ingress-nginx/ingress-nginx/4.15.1 --base default --work-dir <tmp> --non-interactive --namespace ingress-nginx` | check production decision for ingress-nginx/ingress-nginx |
