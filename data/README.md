...
| I want the checked eight-component EKS inference path, including one retained change promoted and delivered through Argo CD. | [certified-bundles/eks-inference-stack.md](./certified-bundles/eks-inference-stack.md)<br>[eks-inference-sandbox-proof/summary.md](./eks-inference-sandbox-proof/summary.md)<br>[eks-inference-promotion-delivery-proof/summary.md](./eks-inference-promotion-delivery-proof/summary.md) |
...
It includes 198 CSV files. Each row records the path, audience,
