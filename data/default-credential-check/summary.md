# Default-credential check — do selected catalog defaults ship a fixed shared password?
...
**Scope.** This lane checks 12 selected catalog defaults with known credential behavior. It is not a catalog-wide credential audit.
...
**Selected defaults shipping a FIXED credential: 0/12 (0%). Bases still named `generated-passwords`: 0.** Overall: **pass**.
