...
targetFactChecks:
  ...
  result: "$result"
  liveCheck:
    command: "TARGET_FACT_CHECK_MODE=live cub installer setup --pull data/latest-top20-refresh/candidates/redis-27.0.0/packages/bitnami/redis/27.0.0 --base reuse-existing-secret --work-dir <tmp> --non-interactive --namespace redis"
YAML
