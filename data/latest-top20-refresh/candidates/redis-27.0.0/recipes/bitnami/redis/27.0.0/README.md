# Redis Proof: bitnami/redis 27.0.0
...
| Scan findings | default: 0 high, 2 medium; reuse-existing-secret: 0 high, 2 medium |
...
current `packages/bitnami/redis/27.0.0` cub installer package against that
regular Helm output.
