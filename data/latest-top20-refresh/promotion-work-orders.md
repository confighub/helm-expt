...
completed work-order rows: 50
todo work-order rows: 6
...
| `bitnami/redis@27.0.0` | 2 / 8 | 6 | confighub-proof | run ConfigHub upload, function scan, safe-ops, and server-side variant proof against the candidate package |
