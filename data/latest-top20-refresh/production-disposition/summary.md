...
| `bitnami/mongodb@19.1.0` | static-passwords | proof-complete | not-production-supported | 7 | warn-production-blocked | review 7 production decision topic(s), then decide whether bitnami/mongodb@19.1.0 can replace 19.0.7 |
...
| `bitnami/postgresql@18.7.0` | static-passwords | proof-complete | not-production-supported | 7 | warn-production-blocked | review 7 production decision topic(s), then decide whether bitnami/postgresql@18.7.0 can replace 18.6.7 |
