...
| `bitnami/redis@27.0.0` | default | proof-incomplete | not-production-supported | 5 | warn-production-blocked | finish ConfigHub proof, local live e2e, and live parity before production review |
