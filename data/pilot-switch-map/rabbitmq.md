...
| Switch | Error |
| --- | --- |
| `memoryHighWatermark.enabled=true` | Command failed: helm template rabbitmq oci://registry-1.docker.io/bitnamicharts/rabbitmq --version 16.0.14 --namespace rabbitmq --values <tmp> --kube-version 1.30.0 Pulled: registry-1.docker.io/bitnam |
| `ldap.enabled=true` | Command failed: helm template rabbitmq oci://registry-1.docker.io/bitnamicharts/rabbitmq --version 16.0.14 --namespace rabbitmq --values <tmp> --kube-version 1.30.0 Pulled: registry-1.docker.io/bitnam |
