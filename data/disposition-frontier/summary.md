...
```text
lane cells:                 1152
recorded disposition:       1016  (88.2%)
+ derived blocked:          97
= verified disposition:     1113  (96.6%)
genuine todo (named next):  39
un-dispositioned gap:       0
```

**Distance to 99%:** 39 cells are not yet a
non-todo verified disposition (3.4% of cells).
...
| K two_cluster_kind_parity | 192 | 153 | 39 | 0 |
...
| Cells | Next action |
| --- | --- |
| 39 | run the two-cluster kind parity lane |
