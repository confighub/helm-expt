...
```text
lane cells:                 1152
recorded disposition:       963  (83.6%)
+ derived blocked:          130
= verified disposition:     1093  (94.9%)
genuine todo (named next):  59
un-dispositioned gap:       0
```

**Distance to 99%:** 59 cells are not yet a
non-todo verified disposition (5.1% of cells).
...
| K two_cluster_kind_parity | 192 | 133 | 59 | 0 |
...
| Cells | Next action |
| --- | --- |
| 59 | run the two-cluster kind parity lane |
