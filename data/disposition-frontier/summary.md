...
```text
lane cells:                 1152
recorded disposition:       959  (83.2%)
+ derived blocked:          130
= verified disposition:     1089  (94.5%)
genuine todo (named next):  63
un-dispositioned gap:       0
```

**Distance to 99%:** 63 cells are not yet a
non-todo verified disposition (5.5% of cells).
...
| K two_cluster_kind_parity | 192 | 129 | 63 | 0 |
...
| Cells | Next action |
| --- | --- |
| 63 | run the two-cluster kind parity lane |
