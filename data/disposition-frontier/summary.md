...
```text
lane cells:                 1152
recorded disposition:       1022  (88.7%)
+ derived blocked:          97
= verified disposition:     1119  (97.1%)
genuine todo (named next):  33
un-dispositioned gap:       0
```

**Distance to 99%:** 33 cells are not yet a
non-todo verified disposition (2.9% of cells).
...
| K two_cluster_kind_parity | 192 | 159 | 33 | 0 |
...
| Cells | Next action |
| --- | --- |
| 33 | run the two-cluster kind parity lane |
