...
```text
lane cells:                 1152
recorded disposition:       1020  (88.5%)
+ derived blocked:          97
= verified disposition:     1117  (97.0%)
genuine todo (named next):  35
un-dispositioned gap:       0
```

**Distance to 99%:** 35 cells are not yet a
non-todo verified disposition (3.0% of cells).
...
| K two_cluster_kind_parity | 192 | 157 | 35 | 0 |
...
| Cells | Next action |
| --- | --- |
| 35 | run the two-cluster kind parity lane |
