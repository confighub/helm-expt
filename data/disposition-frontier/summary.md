...
```text
lane cells:                 1152
recorded disposition:       1019  (88.5%)
+ derived blocked:          97
= verified disposition:     1116  (96.9%)
genuine todo (named next):  36
un-dispositioned gap:       0
```

**Distance to 99%:** 36 cells are not yet a
non-todo verified disposition (3.1% of cells).
...
| K two_cluster_kind_parity | 192 | 156 | 36 | 0 |
...
| Cells | Next action |
| --- | --- |
| 36 | run the two-cluster kind parity lane |
