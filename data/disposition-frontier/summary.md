...
```text
lane cells:                 1152
recorded disposition:       1011  (87.8%)
+ derived blocked:          98
= verified disposition:     1109  (96.3%)
genuine todo (named next):  43
un-dispositioned gap:       0
```

**Distance to 99%:** 43 cells are not yet a
...
| K two_cluster_kind_parity | 192 | 149 | 43 | 0 |
...
| Cells | Next action |
| --- | --- |
| 43 | run the two-cluster kind parity lane |
