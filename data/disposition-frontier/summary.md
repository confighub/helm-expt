...
```text
lane cells:                 1152
recorded disposition:       947  (82.2%)
+ derived blocked:          131
= verified disposition:     1078  (93.6%)
genuine todo (named next):  74
un-dispositioned gap:       0
```

**Distance to 99%:** 74 cells are not yet a
non-todo verified disposition (6.4% of cells).
...
| G gitops_oci_live | 192 | 191 | 1 | 0 |
| P live_helm_vs_confighub_parity | 192 | 191 | 1 | 0 |
