...
```text
lane cells:                 1152
recorded disposition:       960  (83.3%)
+ derived blocked:          130
= verified disposition:     1090  (94.6%)
genuine todo (named next):  62
un-dispositioned gap:       0
```

**Distance to 99%:** 62 cells are not yet a
non-todo verified disposition (5.4% of cells).
...
| K two_cluster_kind_parity | 192 | 130 | 62 | 0 |
...
| Cells | Next action |
| --- | --- |
| 62 | run the two-cluster kind parity lane |
