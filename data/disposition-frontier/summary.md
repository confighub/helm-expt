...
```text
lane cells:                 1152
recorded disposition:       975  (84.6%)
+ derived blocked:          130
= verified disposition:     1105  (95.9%)
genuine todo (named next):  47
un-dispositioned gap:       0
```

**Distance to 99%:** 47 cells are not yet a
non-todo verified disposition (4.1% of cells).
...
| K two_cluster_kind_parity | 192 | 145 | 47 | 0 |
...
| Cells | Next action |
| --- | --- |
| 47 | run the two-cluster kind parity lane |
