...
```text
lane cells:                 1152
recorded disposition:       953  (82.7%)
+ derived blocked:          130
= verified disposition:     1083  (94.0%)
genuine todo (named next):  69
un-dispositioned gap:       0
```

**Distance to 99%:** 69 cells are not yet a
non-todo verified disposition (6.0% of cells).
...
| K two_cluster_kind_parity | 192 | 123 | 69 | 0 |
...
| Cells | Next action |
| --- | --- |
| 69 | run the two-cluster kind parity lane |
