...
```text
lane cells:                 1152
recorded disposition:       1030  (89.4%)
+ derived blocked:          93
= verified disposition:     1123  (97.5%)
genuine todo (named next):  29
un-dispositioned gap:       0
```

**Distance to 99%:** 29 cells are not yet a
non-todo verified disposition (2.5% of cells).
...
| K two_cluster_kind_parity | 192 | 163 | 29 | 0 |
...
| Cells | Next action |
| --- | --- |
| 29 | run the two-cluster kind parity lane |
