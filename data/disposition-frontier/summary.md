...
```text
lane cells:                 1152
recorded disposition:       966  (83.9%)
+ derived blocked:          130
= verified disposition:     1096  (95.1%)
genuine todo (named next):  56
un-dispositioned gap:       0
```

**Distance to 99%:** 56 cells are not yet a
non-todo verified disposition (4.9% of cells).
...
| K two_cluster_kind_parity | 192 | 136 | 56 | 0 |
...
| Cells | Next action |
| --- | --- |
| 56 | run the two-cluster kind parity lane |
