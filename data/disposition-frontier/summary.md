...
```text
lane cells:                 1152
recorded disposition:       1021  (88.6%)
+ derived blocked:          97
= verified disposition:     1118  (97.0%)
genuine todo (named next):  34
un-dispositioned gap:       0
```

**Distance to 99%:** 34 cells are not yet a
...
| K two_cluster_kind_parity | 192 | 158 | 34 | 0 |
...
| Cells | Next action |
| --- | --- |
| 34 | run the two-cluster kind parity lane |
