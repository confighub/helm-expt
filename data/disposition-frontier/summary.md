...
```text
lane cells:                 1152
recorded disposition:       970  (84.2%)
+ derived blocked:          130
= verified disposition:     1100  (95.5%)
genuine todo (named next):  52
un-dispositioned gap:       0
```

**Distance to 99%:** 52 cells are not yet a
non-todo verified disposition (4.5% of cells).
...
| K two_cluster_kind_parity | 192 | 140 | 52 | 0 |
...
| Cells | Next action |
| --- | --- |
| 52 | run the two-cluster kind parity lane |
