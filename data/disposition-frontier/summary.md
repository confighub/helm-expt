...
```text
lane cells:                 1152
recorded disposition:       1018  (88.4%)
+ derived blocked:          97
= verified disposition:     1115  (96.8%)
genuine todo (named next):  37
un-dispositioned gap:       0
```

**Distance to 99%:** 37 cells are not yet a
non-todo verified disposition (3.2% of cells).
...
| K two_cluster_kind_parity | 192 | 155 | 37 | 0 |
...
| Cells | Next action |
| --- | --- |
| 37 | run the two-cluster kind parity lane |
