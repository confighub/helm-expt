...
```text
lane cells:                 1152
recorded disposition:       1017  (88.3%)
+ derived blocked:          97
= verified disposition:     1114  (96.7%)
genuine todo (named next):  38
un-dispositioned gap:       0
```

**Distance to 99%:** 38 cells are not yet a
non-todo verified disposition (3.3% of cells).
...
| K two_cluster_kind_parity | 192 | 154 | 38 | 0 |
...
| Cells | Next action |
| --- | --- |
| 38 | run the two-cluster kind parity lane |
