...
```text
lane cells:                 1152
recorded disposition:       967  (83.9%)
+ derived blocked:          130
= verified disposition:     1097  (95.2%)
genuine todo (named next):  55
un-dispositioned gap:       0
```

**Distance to 99%:** 55 cells are not yet a
non-todo verified disposition (4.8% of cells).
...
| K two_cluster_kind_parity | 192 | 137 | 55 | 0 |
...
| Cells | Next action |
| --- | --- |
| 55 | run the two-cluster kind parity lane |
