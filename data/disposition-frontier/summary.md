...
```text
lane cells:                 1152
recorded disposition:       942  (81.8%)
+ derived blocked:          131
= verified disposition:     1073  (93.1%)
genuine todo (named next):  79
un-dispositioned gap:       0
```

**Distance to 99%:** 79 cells are not yet a
non-todo verified disposition (6.9% of cells).
