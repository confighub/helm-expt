...
```text
lane cells:                 1152
recorded disposition:       1004  (87.2%)
+ derived blocked:          102
...
**Distance to 99%:** 46 cells are not yet a
non-todo verified disposition (4.0% of cells).
...
| K two_cluster_kind_parity | 192 | 146 | 46 | 0 |
...
| Cells | Next action |
| --- | --- |
| 46 | run the two-cluster kind parity lane |
