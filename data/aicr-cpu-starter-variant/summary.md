...
moved from `gp3` to `standard`. ConfigHub's dry run
named the affected Application and left the stored configuration unchanged;
the real change touched exactly 1 Application
(`kube-prometheus-stack`).

The proof ran in the scratch organization `Cubby AI Inc`
on 2026-08-07T08:50:01.016Z. Both scratch Spaces and the temporary registry
