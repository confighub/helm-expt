...
| T05 | Show prerequisites and lifecycle work before deployment | partial | [data/lifecycle-routes/summary.md](../../data/lifecycle-routes/summary.md)<br>[data/hook-lifecycle/summary.md](../../data/hook-lifecycle/summary.md)<br>[data/kps-default-package-upgrade-proof/summary.md](../../data/kps-default-package-upgrade-proof/summary.md)<br>[runs/kps-default-package-upgrade-proof/receipt.yaml](../../runs/kps-default-package-upgrade-proof/receipt.yaml)<br>[data/kps-confighub-lifecycle-promotion/summary.md](../../data/kps-confighub-lifecycle-promotion/summary.md)<br>[docs/user/target-prerequisites.md](../../docs/user/target-prerequisites.md) | Turn more candidate routes into chart-specific receipts and keep unsupported routes as named blockers. |
...
| ID | Outcome | Status | Current evidence | Completion step |
| --- | --- | --- | --- | --- |
| T09 | Review a chart and values supplied by the user | available | [data/byo-helm-values-review/summary.md](../../data/byo-helm-values-review/summary.md)<br>[runs/byo-helm-values-proof/receipt.yaml](../../runs/byo-helm-values-proof/receipt.yaml)<br>[data/config-workshop-command-contract/summary.md](../../data/config-workshop-command-contract/summary.md) | Add private-chart and dependency-auth examples without weakening source-lock requirements. |
| T10 | Review values proposed by AI | available | [docs/user/ai-assisted-helm-changes.md](../../docs/user/ai-assisted-helm-changes.md)<br>[data/byo-helm-values-review/review.yaml](../../data/byo-helm-values-review/review.yaml)<br>[runs/ai-change-review-live-proof/receipt.yaml](../../runs/ai-change-review-live-proof/receipt.yaml)<br>[data/config-workshop-command-contract/helm/workshop-result.json](../../data/config-workshop-command-contract/helm/workshop-result.json)<br>[data/config-workshop-ci-report/summary.md](../../data/config-workshop-ci-report/summary.md) | Extend the same report to more source plugins and destination-aware checks rather than treating the NGINX and Redis cases as universal. |
...
| T12 | Inspect and test an existing OCI package | available | [docs/user/inspect-oci-package.md](../../docs/user/inspect-oci-package.md)<br>[data/oci-inspection/summary.md](../../data/oci-inspection/summary.md)<br>[runs/aicr-oci-roundtrip-proof/receipt.yaml](../../runs/aicr-oci-roundtrip-proof/receipt.yaml)<br>[runs/serverless-oci-gitops-proof/receipt.yaml](../../runs/serverless-oci-gitops-proof/receipt.yaml)<br>[runs/anonymous-oci-transform-proof/public-oci-receipt.yaml](../../runs/anonymous-oci-transform-proof/public-oci-receipt.yaml)<br>[data/literal-config-examples/summary.md](../../data/literal-config-examples/summary.md) | Add signature checks and consumer-specific validation without confusing them with the package inspection report. |
| T13 | Transform OCI to OCI without requiring ConfigHub | available | [docs/user/transform-oci-package.md](../../docs/user/transform-oci-package.md)<br>[data/anonymous-oci-transform-proof/summary.md](../../data/anonymous-oci-transform-proof/summary.md)<br>[runs/anonymous-oci-transform-proof/receipt.yaml](../../runs/anonymous-oci-transform-proof/receipt.yaml)<br>[runs/anonymous-oci-transform-proof/public-oci-receipt.yaml](../../runs/anonymous-oci-transform-proof/public-oci-receipt.yaml)<br>[runs/existing-oci-upload-proof/receipt.yaml](../../runs/existing-oci-upload-proof/receipt.yaml) | Release cub with the merged companion-record import fix, then add patch-file input and signature checks. The worked NGINX output already has an authenticated publication receipt and anonymous pull-back check. |
...
| T16 | Upload literal Kubernetes YAML without rerendering | available | [docs/user/adopting-existing-apps.md](../../docs/user/adopting-existing-apps.md)<br>[docs/user/app-to-live-walkthrough.md](../../docs/user/app-to-live-walkthrough.md)<br>[examples/plain-yaml/acme-web/README.md](../../examples/plain-yaml/acme-web/README.md)<br>[runs/literal-yaml-upload-proof/receipt.yaml](../../runs/literal-yaml-upload-proof/receipt.yaml)<br>[data/literal-config-examples/summary.md](../../data/literal-config-examples/summary.md)<br>[data/config-workshop-command-contract/kubernetes-yaml/workshop-result.json](../../data/config-workshop-command-contract/kubernetes-yaml/workshop-result.json) | Continue the same four-object base through a derived variant and release only when that adds a lesson not already covered by the main ConfigHub tutorial. |
...
| T18 | Attach render context and route intent to every base variant | partial | [data/helm-render-intents/summary.md](../../data/helm-render-intents/summary.md)<br>[data/helm-render-intents/contract-gaps.md](../../data/helm-render-intents/contract-gaps.md)<br>[data/master-catalog-matrix/summary.md](../../data/master-catalog-matrix/summary.md)<br>[data/lifecycle-routes/summary.md](../../data/lifecycle-routes/summary.md)<br>[data/kps-default-package-upgrade-proof/summary.md](../../data/kps-default-package-upgrade-proof/summary.md)<br>[docs/user/helm-render-intents.md](../../docs/user/helm-render-intents.md) | Work through the generated route and target-prerequisite gaps until every base has an exact attached contract or an explicit no-extra-work decision. [Issue](https://github.com/confighub/helm-expt/issues/1625) |
...
| T20 | Keep approved object edits through source upgrades | available | [data/redis-upgrade-app-proof/summary.md](../../data/redis-upgrade-app-proof/summary.md)<br>[runs/redis-upgrade-app-proof/receipt.yaml](../../runs/redis-upgrade-app-proof/receipt.yaml)<br>[data/prometheus-upgrade-preservation-proof/summary.md](../../data/prometheus-upgrade-preservation-proof/summary.md)<br>[runs/prometheus-upgrade-preservation-proof/receipt.yaml](../../runs/prometheus-upgrade-preservation-proof/receipt.yaml) | Repeat this receipt when package-upgrade behavior changes or when another protected field class is added. |
| T21 | Promote through development staging and production | partial | [data/byo-helm-values-promotion-proof/summary.md](../../data/byo-helm-values-promotion-proof/summary.md)<br>[runs/aicr-variant-promotion-proof/receipt.yaml](../../runs/aicr-variant-promotion-proof/receipt.yaml)<br>[data/measured-promotion-proof/summary.md](../../data/measured-promotion-proof/summary.md)<br>[data/kps-confighub-lifecycle-promotion/summary.md](../../data/kps-confighub-lifecycle-promotion/summary.md)<br>[data/config-workshop-command-contract/live-promotion.md](../../data/config-workshop-command-contract/live-promotion.md)<br>[runs/config-workshop-command-contract/receipt.yaml](../../runs/config-workshop-command-contract/receipt.yaml) | Add the ordinary product interface and repeat destination preflight, rollback, and live comparison across more chart and target classes. |
...
| ID | Outcome | Status | Current evidence | Completion step |
| --- | --- | --- | --- | --- |
| T26 | Deliver reviewed OCI through Argo CD | available | [data/runtime-gitops/summary.md](../../data/runtime-gitops/summary.md)<br>[runs/oci-deploy-stage-rollout-proof/receipt.yaml](../../runs/oci-deploy-stage-rollout-proof/receipt.yaml)<br>[runs/kps-confighub-lifecycle-promotion/receipt.yaml](../../runs/kps-confighub-lifecycle-promotion/receipt.yaml) | Maintain fresh controller and workload receipts for every path that claims Argo CD delivery. |
...
| T29 | Record live convergence and observation freshness | partial | [data/live-e2e/summary.md](../../data/live-e2e/summary.md)<br>[runs/kps-confighub-lifecycle-promotion/receipt.yaml](../../runs/kps-confighub-lifecycle-promotion/receipt.yaml)<br>[docs/reference/observation-freshness-slo.md](../../docs/reference/observation-freshness-slo.md) | Store more live observations in ConfigHub and refresh receipts when target state or packages change. |
...
| ID | Outcome | Status | Current evidence | Completion step |
| --- | --- | --- | --- | --- |
| T36 | Complete the Upgrade App | partial | [data/redis-upgrade-app-proof/summary.md](../../data/redis-upgrade-app-proof/summary.md)<br>[runs/redis-upgrade-app-proof/receipt.yaml](../../runs/redis-upgrade-app-proof/receipt.yaml)<br>[data/kps-confighub-lifecycle-promotion/summary.md](../../data/kps-confighub-lifecycle-promotion/summary.md)<br>[runs/kps-confighub-lifecycle-promotion/receipt.yaml](../../runs/kps-confighub-lifecycle-promotion/receipt.yaml) | Add the product App interface, automatic route selection, persistent history, and a lifecycle-aware rollback path. |
| T37 | Complete the Hooks and CRDs App | partial | [docs/demo/hooks-crds/kube-prometheus-stack.md](../../docs/demo/hooks-crds/kube-prometheus-stack.md)<br>[data/hooks-crds-app/summary.md](../../data/hooks-crds-app/summary.md)<br>[data/kps-gitops-lifecycle-proof/summary.md](../../data/kps-gitops-lifecycle-proof/summary.md)<br>[runs/kps-gitops-lifecycle-proof/receipt.yaml](../../runs/kps-gitops-lifecycle-proof/receipt.yaml)<br>[data/kps-confighub-lifecycle-promotion/summary.md](../../data/kps-confighub-lifecycle-promotion/summary.md)<br>[runs/kps-confighub-lifecycle-promotion/receipt.yaml](../../runs/kps-confighub-lifecycle-promotion/receipt.yaml) | Add the product App interface and automatic route selection, then test rollback and post-success cleanup before widening the claim. |
...
| T43 | Promote the next 80 from proof-grade to useful catalog configs | partial | [data/top100-coverage/summary.md](../../data/top100-coverage/summary.md)<br>[data/useful-base-realization-wave/summary.md](../../data/useful-base-realization-wave/summary.md) | Build the remaining useful-base proposals and review promotion candidates in evidence order. [Issue](https://github.com/confighub/helm-expt/issues/1626) |
| T44 | Expand the catalog beyond Helm | partial | [docs/user/config-catalog-demonstrations.md](../../docs/user/config-catalog-demonstrations.md)<br>[data/demo-program/summary.md](../../data/demo-program/summary.md) | Add stable browse pages and ready-to-use artifacts for every source family rather than leaving them only in demonstrations. [Issue](https://github.com/confighub/helm-expt/issues/1627) |
| T45 | Let users browse by starting point and next job | available | [config-catalog/program.yaml](../../config-catalog/program.yaml)<br>[docs/user/config-catalog-demonstrations.md](../../docs/user/config-catalog-demonstrations.md)<br>[site/charts/index.html](../../site/charts/index.html)<br>[site/testing.html](../../site/testing.html)<br>[data/config-workshop-command-contract/summary.md](../../data/config-workshop-command-contract/summary.md) | Keep both navigation tables and their linked source pages current as starting points and jobs change. |
...
| T48 | Make hooks CRDs and setup work manageable per chart | partial | [docs/user/chart-hooks-what-happens.md](../../docs/user/chart-hooks-what-happens.md)<br>[data/hook-route-candidates/work-orders.md](../../data/hook-route-candidates/work-orders.md)<br>[data/lifecycle-routes/summary.md](../../data/lifecycle-routes/summary.md)<br>[data/kps-default-package-upgrade-proof/summary.md](../../data/kps-default-package-upgrade-proof/summary.md)<br>[data/kps-confighub-lifecycle-promotion/summary.md](../../data/kps-confighub-lifecycle-promotion/summary.md) | Repeat destination-bound lifecycle promotion for more high-value route work orders and keep untested controller paths named. [Issue](https://github.com/confighub/helm-expt/issues/1628) |
...
| ID | Outcome | Status | Current evidence | Completion step |
| --- | --- | --- | --- | --- |
| T50 | Measure whether new users understand and complete the journey | planned | [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md)<br>[docs/planning/persona-ux-audit-2026-06-22.md](../../docs/planning/persona-ux-audit-2026-06-22.md)<br>[data/managed-journey-coverage/summary.md](../../data/managed-journey-coverage/summary.md)<br>[docs/planning/config-workshop-simulation-findings.md](../../docs/planning/config-workshop-simulation-findings.md)<br>[data/site-persona-simulations-2026-08-24-command-contract-final/summary.md](../../data/site-persona-simulations-2026-08-24-command-contract-final/summary.md) | Run the six technically proved journeys with outside users and turn observed failures into tracked product, CLI, or content fixes. [Issue](https://github.com/confighub/helm-expt/issues/1553) |
