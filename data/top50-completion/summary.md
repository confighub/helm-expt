...
| ID | Outcome | Status | Current evidence | Completion step |
| --- | --- | --- | --- | --- |
| T50 | Measure whether new users understand and complete the journey | planned | [docs/planning/outside-user-test.md](../../docs/planning/outside-user-test.md)<br>[docs/planning/persona-ux-audit-2026-06-22.md](../../docs/planning/persona-ux-audit-2026-06-22.md)<br>[data/managed-journey-coverage/summary.md](../../data/managed-journey-coverage/summary.md) | Run the six technically proved journeys with outside users and turn observed failures into tracked product, CLI, or content fixes. [Issue](https://github.com/confighub/helm-expt/issues/1553) |
