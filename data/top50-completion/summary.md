...
| T48 | Make hooks CRDs and setup work manageable per chart | partial | [docs/user/chart-hooks-what-happens.md](../../docs/user/chart-hooks-what-happens.md)<br>[data/hook-route-candidates/work-orders.md](../../data/hook-route-candidates/work-orders.md)<br>[data/lifecycle-routes/summary.md](../../data/lifecycle-routes/summary.md)<br>[data/kps-default-package-upgrade-proof/summary.md](../../data/kps-default-package-upgrade-proof/summary.md)<br>[data/kps-confighub-lifecycle-promotion/summary.md](../../data/kps-confighub-lifecycle-promotion/summary.md) | Repeat destination-bound lifecycle promotion for more high-value route work orders and keep untested controller paths named. |
