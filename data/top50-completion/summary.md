...
| --- | --- | --- | --- | --- |
| T01 | Pull one ready-made OCI package without an account | available | [data/installer-oci-packages/summary.md](../../data/installer-oci-packages/summary.md)<br>[docs/user/installer-oci-packages.md](../../docs/user/installer-oci-packages.md) | Keep every published package reference current when recipes or package contents change. |
...
| T03 | Inspect recorded Helm inputs and rendered objects | available | [docs/user/helm-render-intents.md](../../docs/user/helm-render-intents.md)<br>[data/helm-render-intents/summary.md](../../data/helm-render-intents/summary.md) | Extend the same readable input record to every non-Helm source format. |
...
| T06 | Run the public path locally without ConfigHub | available | [docs/user/serverless-mode.md](../../docs/user/serverless-mode.md)<br>[runs/serverless-oci-gitops-proof/receipt.yaml](../../runs/serverless-oci-gitops-proof/receipt.yaml) | Keep the command surface aligned with released cub installer behavior. |
...
| T15 | Turn a cub installer package into OCI | available | [data/installer-oci-packages/summary.md](../../data/installer-oci-packages/summary.md)<br>[docs/user/installer-oci-packages.md](../../docs/user/installer-oci-packages.md) | Keep package generation and public registry references synchronized for every maintained recipe. |
...
| T18 | Attach render context and route intent to every base variant | partial | [data/helm-render-intents/summary.md](../../data/helm-render-intents/summary.md)<br>[data/lifecycle-routes/summary.md](../../data/lifecycle-routes/summary.md)<br>[docs/user/helm-render-intents.md](../../docs/user/helm-render-intents.md) | Close issue 1037 by attaching route and target-fact records across the full render-intent matrix. [Issue](https://github.com/confighub/helm-expt/issues/1037) |
...
| T37 | Complete the Hooks and CRDs App | partial | [docs/demo/hooks-crds/kube-prometheus-stack.md](../../docs/demo/hooks-crds/kube-prometheus-stack.md)<br>[data/hooks-crds-app/summary.md](../../data/hooks-crds-app/summary.md) | Run the upgrade route and the chart-specific Argo CD and Flux implementations before marking them automatic. |
