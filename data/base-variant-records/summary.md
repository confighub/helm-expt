...
There are **256 records**: 4 aicr, 1 configuration-oci, 1 cub-installer, 246 helm, 1 kubara, 1 kubernetes-yaml, 1 sveltos, 1 timoni. Their current statuses are 247 available, 9 partial.
...
- Flattening verdicts: 3 born-flattened, 74 flatten-with-routes, 12 not-assessed, 70 safe-to-flatten, 97 unsafe-to-flatten.
- Lifecycle requirements: 155 gap, 12 not-required, 89 recorded.
- Portable route intents: 155 gap, 12 not-required, 15 recorded, 74 required-at-destination.
...
| Flattening verdicts | 244/256 | The model is ahead of the unassessed rows. |
