...
There are **201 records**: 1 aicr, 199 helm, 1 sveltos. Their current statuses are 199 available, 2 partial.
...
- [AICR EKS H100 training](records/aicr-eks-h100-training-kubeflow-v0-14-0-base.yaml) records a genuine AICR v0.14.0 recipe and generated Flux bundle without claiming a live upload.
- [Sveltos Kyverno fleet](records/sveltos-kyverno-fleet-3-8-1-staging.yaml) records the intended ConfigHub and Sveltos boundary and remains marked as an example.
