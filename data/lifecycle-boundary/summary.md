...
hook lifecycle receipts present:          0/5
...
| --- | --- | --- | --- | --- | --- | --- |
| helm-hook-lifecycle-queue | `prometheus-community/kube-prometheus-stack@85.3.3` | default | route-and-receipt-needed | preflight-or-presync;postsync-check-or-observation;upgrade-action-with-receipt;preserve-ordering;preserve-cleanup-policy;webhook-readiness-observation;target-facts-or-preflight | hook templates are inventoried and a receipt path is declared | hook execution, cleanup, ordering, upgrade behavior, or production support |
| helm-hook-lifecycle-queue | `kyverno/kyverno@3.8.1` | default | route-and-receipt-needed | upgrade-action-with-receipt;delete-cleanup-policy;explicit-test-check;preserve-ordering;preserve-cleanup-policy;target-facts-or-preflight | hook templates are inventoried and a receipt path is declared | hook execution, cleanup, ordering, upgrade behavior, or production support |
| helm-hook-lifecycle-queue | `fluent/fluent-bit@0.57.6` | default | route-and-receipt-needed | explicit-test-check;preserve-cleanup-policy | hook templates are inventoried and a receipt path is declared | hook execution, cleanup, ordering, upgrade behavior, or production support |
| helm-hook-lifecycle-queue | `projectcalico/tigera-operator@v3.32.0` | default | route-and-receipt-needed | delete-cleanup-policy;preserve-ordering;preserve-cleanup-policy;target-facts-or-preflight | hook templates are inventoried and a receipt path is declared | hook execution, cleanup, ordering, upgrade behavior, or production support |
| helm-hook-lifecycle-queue | `gatekeeper/gatekeeper@3.22.2` | default | route-and-receipt-needed | preflight-or-presync;upgrade-action-with-receipt;preserve-ordering;preserve-cleanup-policy;webhook-readiness-observation | hook templates are inventoried and a receipt path is declared | hook execution, cleanup, ordering, upgrade behavior, or production support |
