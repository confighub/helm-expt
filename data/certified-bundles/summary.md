...
| eks-inference | eks-inference-gpu-runtime | rendered-config | safe-to-flatten | certified | data/certified-bundles/receipts/eks-inference/gpu-runtime/receipt.yaml |
