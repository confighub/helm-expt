...
- Preset: `default`.
- Kubernetes YAML: 14 object(s), mainly ConfigMap x3, Service x3, PodDisruptionBudget x2, ServiceAccount x2, StatefulSet x2, NetworkPolicy x1, Secret x1.
...
| --- | --- | --- |
| Helm values | [The values profile](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/redis/25.5.3/effective-values.yaml) defines the `default` base together with release `redis` and namespace `redis`. | Change the values and create or update a base preset when Helm needs to produce different objects. |
...
| Helm values profile | [recipes/bitnami/redis/25.5.3/effective-values.yaml](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/redis/25.5.3/effective-values.yaml) |
...
| Detailed guide | [data/confighub-example-guides/spaces/bitnami-redis-25-5-3-default/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/bitnami-redis-25-5-3-default/README.md) |
