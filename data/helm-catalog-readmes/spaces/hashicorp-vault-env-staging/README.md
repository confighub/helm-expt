...
| ConfigHub changes | Staging records `spec.replicas: 2` and its real identity-provider value as local revisions. Unconflicted base changes arrive through promotion. |
