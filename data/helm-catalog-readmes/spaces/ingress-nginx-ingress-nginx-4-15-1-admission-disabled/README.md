...
This is the `admission-disabled` preset for `ingress-nginx/ingress-nginx@4.15.1`. ingress-nginx admission webhook disabled variant rendered from ingress-nginx/ingress-nginx@4.15.1.
