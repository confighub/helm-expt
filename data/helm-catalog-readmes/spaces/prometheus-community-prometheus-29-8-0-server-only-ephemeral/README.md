...
This is the `server-only-ephemeral` preset for `prometheus-community/prometheus@29.8.0`. Use this when you want a smaller operating shape for first tests or local use.
