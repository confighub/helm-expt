...
- Preset config: `server-only-ephemeral`. Use this when you want a smaller operating shape for first tests or local use.
- Rendered objects: 6 object(s), mainly ClusterRole x1, ClusterRoleBinding x1, ConfigMap x1, Deployment x1, Service x1, ServiceAccount x1.
...
| Full generated guide | [data/confighub-example-guides/spaces/prometheus-community-prometheus-29-8-0-server-only-ephemeral/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/prometheus-community-prometheus-29-8-0-server-only-ephemeral/README.md) |
