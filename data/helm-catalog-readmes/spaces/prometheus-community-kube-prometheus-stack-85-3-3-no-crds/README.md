...
- Extra Helm work: 8 recorded route(s) for hooks or surrounding setup work.
...
| Install work | 10 CRDs, 1 Secret; 8 hook or setup route(s) are recorded. | Follow the prerequisite and route records. Secrets, CRDs, and setup jobs are not hidden as values or ConfigHub edits. |
