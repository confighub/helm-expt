...
| ConfigHub changes | This base contains the five reviewed objects imported from OCI. The separate review-decision Unit records the six fixes and the scoped exception without placing that evidence in a deployment release. Development and staging changes live in their own Spaces. |
...
- [Configuration decision chain](https://github.com/confighub/helm-expt/blob/main/data/config-review-decision-chain/summary.md)
- [Configuration decision](https://github.com/confighub/helm-expt/blob/main/config-catalog/review-decisions/byo-nginx-ai-values-24-0-2-reviewed.yaml)
- [Decision Unit receipt](https://github.com/confighub/helm-expt/blob/main/runs/config-review-decision-chain/receipt.yaml)
