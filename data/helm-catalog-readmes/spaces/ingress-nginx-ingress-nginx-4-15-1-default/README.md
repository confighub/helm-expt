...
- Rendered objects: 11 object(s), mainly Service x2, ClusterRole x1, ClusterRoleBinding x1, ConfigMap x1, Deployment x1, IngressClass x1, Role x1, RoleBinding x1.
...
| Full generated guide | [data/confighub-example-guides/spaces/ingress-nginx-ingress-nginx-4-15-1-default/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/ingress-nginx-ingress-nginx-4-15-1-default/README.md) |
