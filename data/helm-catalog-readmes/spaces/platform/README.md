...
# Checks that enforce the catalog before apply
...
- Production Spaces such as `bitnami-redis-prod` and `hashicorp-vault-env-prod` to see where approval matters.

## Evidence and source

- [Maintained apply-policy definition](https://github.com/confighub/helm-expt/blob/main/config-catalog/policies/catalog-standard.yaml)
- [Live functional proof](https://github.com/confighub/helm-expt/blob/main/data/apply-policy-functional-proof/summary.md)
- [Live filter and Space assignments](https://github.com/confighub/helm-expt/blob/main/data/apply-policy-profiles/live-helm-catalog.yaml)
