...
- Kubernetes YAML: 9 object(s), mainly Service x2, NetworkPolicy x1, PodDisruptionBudget x1, Role x1, RoleBinding x1, Secret x1, ServiceAccount x1, StatefulSet x1.
...
| Item | Link |
| --- | --- |
| Catalog chart page | [bitnami/rabbitmq@16.0.14](https://confighub.github.io/helm-expt/site/charts/bitnami-rabbitmq-16-0-14.html) |
| Helm values profile | [recipes/bitnami/rabbitmq/16.0.14/effective-values-existing-secret.yaml](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/rabbitmq/16.0.14/effective-values-existing-secret.yaml) |
...
| Detailed guide | [data/confighub-example-guides/spaces/bitnami-rabbitmq-16-0-14-existing-secret/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/bitnami-rabbitmq-16-0-14-existing-secret/README.md) |
| No-account script | [try.sh](https://confighub.github.io/helm-expt/site/sh/bitnami-rabbitmq-16-0-14/existing-secret/try.sh) |
| ConfigHub upload script | [confighub.sh](https://confighub.github.io/helm-expt/site/sh/bitnami-rabbitmq-16-0-14/existing-secret/confighub.sh) |
