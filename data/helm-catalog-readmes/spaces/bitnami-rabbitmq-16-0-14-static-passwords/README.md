...
| Helm values profile | [recipes/bitnami/rabbitmq/16.0.14/effective-values.yaml](https://github.com/confighub/helm-expt/blob/main/recipes/bitnami/rabbitmq/16.0.14/effective-values.yaml) |
