...
| --- | --- | --- |
| Helm values | [The values profile](https://github.com/confighub/helm-expt/blob/main/recipes/ingress-nginx/ingress-nginx/4.15.1/effective-values-internal-clusterip.yaml) defines the `internal-clusterip` base together with release `ingress-nginx` and namespace `ingress-nginx`. | Change the values and create or update a base preset when Helm needs to produce different objects. |
...
| Helm values profile | [recipes/ingress-nginx/ingress-nginx/4.15.1/effective-values-internal-clusterip.yaml](https://github.com/confighub/helm-expt/blob/main/recipes/ingress-nginx/ingress-nginx/4.15.1/effective-values-internal-clusterip.yaml) |
