...
- Rendered objects: 12 object(s), mainly Service x3, ClusterRoleBinding x2, ServiceAccount x2, ClusterRole x1, ConfigMap x1, Deployment x1, MutatingWebhookConfiguration x1, StatefulSet x1.
...
| Full generated guide | [data/confighub-example-guides/spaces/hashicorp-vault-0-32-0-default/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/hashicorp-vault-0-32-0-default/README.md) |
