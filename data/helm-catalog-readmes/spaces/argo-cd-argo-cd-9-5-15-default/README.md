...
- Preset: `default`.
- Kubernetes YAML: 49 object(s), mainly ConfigMap x8, Deployment x6, Role x6, RoleBinding x6, ServiceAccount x6, Service x5, ClusterRole x3, ClusterRoleBinding x3.
...
| --- | --- | --- |
| Helm values | [The values profile](https://github.com/confighub/helm-expt/blob/main/recipes/argo-cd/argo-cd/9.5.15/effective-values.yaml) defines the `default` base together with release `argo-cd` and namespace `argocd`. | Change the values and create or update a base preset when Helm needs to produce different objects. |
...
| Helm values profile | [recipes/argo-cd/argo-cd/9.5.15/effective-values.yaml](https://github.com/confighub/helm-expt/blob/main/recipes/argo-cd/argo-cd/9.5.15/effective-values.yaml) |
...
| Detailed guide | [data/confighub-example-guides/spaces/argo-cd-argo-cd-9-5-15-default/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/argo-cd-argo-cd-9-5-15-default/README.md) |
| No-account script | [try.sh](https://confighub.github.io/helm-expt/site/sh/argo-cd-argo-cd-9-5-15/default/try.sh) |
| ConfigHub upload script | [confighub.sh](https://confighub.github.io/helm-expt/site/sh/argo-cd-argo-cd-9-5-15/default/confighub.sh) |
