...
This is the `static-passwords` preset for `grafana/grafana@10.5.15`. Use this for comparison and proof only; it preserves a fixed shared credential shape and should not be the production starting point.
