...
This is the `existing-secret-ingress` preset for `grafana/grafana@10.5.15`. Use this when secret material should come from a Secret you create, not from a generated chart default.
