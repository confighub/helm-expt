...
- Preset config: `existing-secret-ingress`. Use this when secret material should come from a Secret you create, not from a generated chart default.
- Rendered objects: 9 object(s), mainly ClusterRole x1, ClusterRoleBinding x1, ConfigMap x1, Deployment x1, Ingress x1, Role x1, RoleBinding x1, Service x1.
...
| Full generated guide | [data/confighub-example-guides/spaces/grafana-grafana-10-5-15-existing-secret-ingress/README.md](https://github.com/confighub/helm-expt/blob/main/data/confighub-example-guides/spaces/grafana-grafana-10-5-15-existing-secret-ingress/README.md) |
