...
139 of 142 catalog entries have a witness.

| status | entries | meaning |
| --- | --- | --- |
| current | 133 | a committed witness already described the locked bytes |
| scanned | 6 | scanned in this sweep against the hash its recipe locks |
