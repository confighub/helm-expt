...
SPACE="${CUB_SPACE:-helm-spark-legacy}"
...
say "Render the legacy base variant into ./bitnami-spark-10-0-3-legacy"
...
cub installer upload --work-dir ./bitnami-spark-10-0-3-legacy --space "${SPACE}"
