#!/usr/bin/env bash
# bitnami/spark 10.0.3 - preset: ha
...
say "Pull the package and render the ha preset into ./bitnami-spark-10-0-3-ha"
...
if [ -d ./bitnami-spark-10-0-3-ha/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-spark-10-0-3-ha/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-spark-10-0-3-ha/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-spark-10-0-3-ha/out."
