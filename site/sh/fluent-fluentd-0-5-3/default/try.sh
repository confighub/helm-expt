#!/usr/bin/env bash
# fluent/fluentd 0.5.3 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/fluent-fluentd-0-5-3.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./fluent-fluentd-0-5-3-default"
...
if [ -d ./fluent-fluentd-0-5-3-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./fluent-fluentd-0-5-3-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./fluent-fluentd-0-5-3-default/out/manifests

say "Done. The cluster received exactly the files in ./fluent-fluentd-0-5-3-default/out."
