...
SPACE="${CUB_SPACE:-helm-gateway-controller-default-reviewed}"
...
say "Render the controller-default-reviewed preset into ./istio-gateway-1-30-0-controller-default-reviewed"
