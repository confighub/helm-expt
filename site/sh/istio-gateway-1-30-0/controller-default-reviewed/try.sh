#!/usr/bin/env bash
# istio/gateway 1.30.0 - base variant: controller-default-reviewed
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/istio-gateway-1-30-0.html
set -euo pipefail
...
say "Pull the package and render the controller-default-reviewed base variant into ./istio-gateway-1-30-0-controller-default-reviewed"
...
ls ./istio-gateway-1-30-0-controller-default-reviewed/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./istio-gateway-1-30-0-controller-default-reviewed/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./istio-gateway-1-30-0-controller-default-reviewed/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./istio-gateway-1-30-0-controller-default-reviewed/out/manifests

say "Done. The cluster received exactly the files in ./istio-gateway-1-30-0-controller-default-reviewed/out."
