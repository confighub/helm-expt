...
SPACE="${CUB_SPACE:-helm-gateway-default}"
...
say "Render the default base variant into ./istio-gateway-1-30-0-default"
...
cub installer upload --work-dir ./istio-gateway-1-30-0-default --space "${SPACE}"
