#!/usr/bin/env bash
# istio/gateway 1.30.0 - base variant: default
...
if [ -d ./istio-gateway-1-30-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./istio-gateway-1-30-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./istio-gateway-1-30-0-default/out/manifests

say "Done. The cluster received exactly the files in ./istio-gateway-1-30-0-default/out."
