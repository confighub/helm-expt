#!/usr/bin/env bash
# cloudnative-pg/cloudnative-pg 0.28.2 - preset: default
...
say "Pull the package and render the default preset into ./cloudnative-pg-cloudnative-pg-0-28-2-default"
...
if [ -d ./cloudnative-pg-cloudnative-pg-0-28-2-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./cloudnative-pg-cloudnative-pg-0-28-2-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./cloudnative-pg-cloudnative-pg-0-28-2-default/out/manifests

say "Done. The cluster received exactly the files in ./cloudnative-pg-cloudnative-pg-0-28-2-default/out."
