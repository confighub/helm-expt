#!/usr/bin/env bash
# cloudnative-pg/cloudnative-pg 0.28.2 - preset: no-crds
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/cloudnative-pg-cloudnative-pg-0-28-2.html
set -euo pipefail
...
say "Render the no-crds preset into ./cloudnative-pg-cloudnative-pg-0-28-2-no-crds"
