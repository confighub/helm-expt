...
SPACE="${CUB_SPACE:-helm-velero-default}"
...
say "Render the default base variant into ./velero-velero-12-0-1-default"
...
cub installer upload --work-dir ./velero-velero-12-0-1-default --space "${SPACE}"
