#!/usr/bin/env bash
# velero/velero 12.0.1 - base variant: no-crds
...
say "Pull the package and render the no-crds base variant into ./velero-velero-12-0-1-no-crds"
...
ls ./velero-velero-12-0-1-no-crds/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./velero-velero-12-0-1-no-crds/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./velero-velero-12-0-1-no-crds/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./velero-velero-12-0-1-no-crds/out/manifests

say "Done. The cluster received exactly the files in ./velero-velero-12-0-1-no-crds/out."
