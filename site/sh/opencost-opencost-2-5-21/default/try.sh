#!/usr/bin/env bash
# opencost/opencost 2.5.21 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/opencost-opencost-2-5-21.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./opencost-opencost-2-5-21-default"
