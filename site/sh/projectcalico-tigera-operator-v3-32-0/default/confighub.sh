#!/usr/bin/env bash
# projectcalico/tigera-operator v3.32.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/projectcalico-tigera-operator-v3-32-0.html
set -euo pipefail
...
say "Render the default preset into ./projectcalico-tigera-operator-v3-32-0-default"
