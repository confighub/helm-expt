#!/usr/bin/env bash
# stakater/reloader 2.2.12 - base variant: controller-default-reviewed
...
if [ -d ./stakater-reloader-2-2-12-controller-default-reviewed/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./stakater-reloader-2-2-12-controller-default-reviewed/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./stakater-reloader-2-2-12-controller-default-reviewed/out/manifests

say "Done. The cluster received exactly the files in ./stakater-reloader-2-2-12-controller-default-reviewed/out."
