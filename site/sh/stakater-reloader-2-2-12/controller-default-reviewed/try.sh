#!/usr/bin/env bash
# stakater/reloader 2.2.12 - preset: controller-default-reviewed
...
say "Pull the package and render the controller-default-reviewed preset into ./stakater-reloader-2-2-12-controller-default-reviewed"
