...
SPACE="${CUB_SPACE:-helm-reloader-default}"
...
say "Render the default base variant into ./stakater-reloader-2-2-12-default"
...
cub installer upload --work-dir ./stakater-reloader-2-2-12-default --space "${SPACE}"
