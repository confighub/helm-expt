...
SPACE="${CUB_SPACE:-helm-surveyor-default}"
...
say "Render the default base variant into ./nats-surveyor-0-20-9-default"
...
cub installer upload --work-dir ./nats-surveyor-0-20-9-default --space "${SPACE}"
