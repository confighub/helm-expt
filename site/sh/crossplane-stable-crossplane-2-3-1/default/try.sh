#!/usr/bin/env bash
# crossplane-stable/crossplane 2.3.1 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/crossplane-stable-crossplane-2-3-1.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./crossplane-stable-crossplane-2-3-1-default"
