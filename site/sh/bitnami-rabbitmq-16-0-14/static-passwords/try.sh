#!/usr/bin/env bash
# bitnami/rabbitmq 16.0.14 - preset: static-passwords
...
say "Pull the package and render the static-passwords preset into ./bitnami-rabbitmq-16-0-14-static-passwords"
...
if [ -d ./bitnami-rabbitmq-16-0-14-static-passwords/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-rabbitmq-16-0-14-static-passwords/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-rabbitmq-16-0-14-static-passwords/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-rabbitmq-16-0-14-static-passwords/out."
