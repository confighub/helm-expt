#!/usr/bin/env bash
# aws-ebs-csi-driver/aws-ebs-csi-driver 2.60.1 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1-default"
...
if [ -d ./aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1-default/out/manifests

say "Done. The cluster received exactly the files in ./aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1-default/out."
