#!/usr/bin/env bash
# aws-ebs-csi-driver/aws-ebs-csi-driver 2.60.1 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/aws-ebs-csi-driver-aws-ebs-csi-driver-2-60-1.html
set -euo pipefail
