#!/usr/bin/env bash
# vm/victoria-logs-single 0.12.5 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/vm-victoria-logs-single-0-12-5.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./vm-victoria-logs-single-0-12-5-default"
