#!/usr/bin/env bash
# vm/victoria-logs-single 0.12.5 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/vm-victoria-logs-single-0-12-5.html
set -euo pipefail
...
if [ -d ./vm-victoria-logs-single-0-12-5-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./vm-victoria-logs-single-0-12-5-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./vm-victoria-logs-single-0-12-5-default/out/manifests

say "Done. The cluster received exactly the files in ./vm-victoria-logs-single-0-12-5-default/out."
