#!/usr/bin/env bash
# argo-cd/argo-cd 9.5.15 - preset: no-crds
...
say "Pull the package and render the no-crds preset into ./argo-cd-argo-cd-9-5-15-no-crds"
