#!/usr/bin/env bash
# coredns/coredns 1.45.2 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/coredns-coredns-1-45-2.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./coredns-coredns-1-45-2-default"
...
if [ -d ./coredns-coredns-1-45-2-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./coredns-coredns-1-45-2-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./coredns-coredns-1-45-2-default/out/manifests

say "Done. The cluster received exactly the files in ./coredns-coredns-1-45-2-default/out."
