#!/usr/bin/env bash
# coredns/coredns 1.45.2 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/coredns-coredns-1-45-2.html
set -euo pipefail
