...
SPACE="${CUB_SPACE:-helm-nats-default}"
...
say "Render the default base variant into ./nats-nats-2-14-0-default"
...
cub installer upload --work-dir ./nats-nats-2-14-0-default --space "${SPACE}"
