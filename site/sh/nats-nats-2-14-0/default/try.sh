#!/usr/bin/env bash
# nats/nats 2.14.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/nats-nats-2-14-0.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./nats-nats-2-14-0-default"
...
ls ./nats-nats-2-14-0-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./nats-nats-2-14-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./nats-nats-2-14-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./nats-nats-2-14-0-default/out/manifests

say "Done. The cluster received exactly the files in ./nats-nats-2-14-0-default/out."
