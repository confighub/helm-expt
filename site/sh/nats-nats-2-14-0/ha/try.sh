...
say "Pull the package and render the ha preset into ./nats-nats-2-14-0-ha"
...
if [ -d ./nats-nats-2-14-0-ha/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./nats-nats-2-14-0-ha/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./nats-nats-2-14-0-ha/out/manifests

say "Done. The cluster received exactly the files in ./nats-nats-2-14-0-ha/out."
