...
SPACE="${CUB_SPACE:-helm-cert-manager-default}"
...
say "Render the default base variant into ./jetstack-cert-manager-v1-20-2-default"
...
cub installer upload --work-dir ./jetstack-cert-manager-v1-20-2-default --space "${SPACE}"
