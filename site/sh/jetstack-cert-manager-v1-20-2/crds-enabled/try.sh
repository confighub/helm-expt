#!/usr/bin/env bash
# jetstack/cert-manager v1.20.2 - preset: crds-enabled
...
say "Pull the package and render the crds-enabled preset into ./jetstack-cert-manager-v1-20-2-crds-enabled"
