...
SPACE="${CUB_SPACE:-helm-pyroscope-ha}"
...
say "Render the ha base variant into ./grafana-pyroscope-2-0-2-ha"
...
cub installer upload --work-dir ./grafana-pyroscope-2-0-2-ha --space "${SPACE}"
