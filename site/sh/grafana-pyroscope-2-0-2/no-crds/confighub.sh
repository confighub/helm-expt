...
SPACE="${CUB_SPACE:-helm-pyroscope-no-crds}"
...
say "Render the no-crds base variant into ./grafana-pyroscope-2-0-2-no-crds"
...
cub installer upload --work-dir ./grafana-pyroscope-2-0-2-no-crds --space "${SPACE}"
