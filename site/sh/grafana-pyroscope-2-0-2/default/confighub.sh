...
SPACE="${CUB_SPACE:-helm-pyroscope-default}"
...
say "Render the default base variant into ./grafana-pyroscope-2-0-2-default"
...
cub installer upload --work-dir ./grafana-pyroscope-2-0-2-default --space "${SPACE}"
