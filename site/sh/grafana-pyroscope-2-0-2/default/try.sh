#!/usr/bin/env bash
# grafana/pyroscope 2.0.2 - base variant: default
...
if [ -d ./grafana-pyroscope-2-0-2-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./grafana-pyroscope-2-0-2-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./grafana-pyroscope-2-0-2-default/out/manifests

say "Done. The cluster received exactly the files in ./grafana-pyroscope-2-0-2-default/out."
