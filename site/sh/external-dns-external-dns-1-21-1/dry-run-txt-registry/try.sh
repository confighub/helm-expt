#!/usr/bin/env bash
# external-dns/external-dns 1.21.1 - preset: dry-run-txt-registry
...
say "Pull the package and render the dry-run-txt-registry preset into ./external-dns-external-dns-1-21-1-dry-run-txt-registry"
