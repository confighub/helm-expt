#!/usr/bin/env bash
# external-secrets/external-secrets 2.5.0 - preset: default
...
say "Pull the package and render the default preset into ./external-secrets-external-secrets-2-5-0-default"
