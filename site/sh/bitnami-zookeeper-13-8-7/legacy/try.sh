#!/usr/bin/env bash
# bitnami/zookeeper 13.8.7 - base variant: legacy
...
say "Pull the package and render the legacy base variant into ./bitnami-zookeeper-13-8-7-legacy"
...
ls ./bitnami-zookeeper-13-8-7-legacy/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./bitnami-zookeeper-13-8-7-legacy/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-zookeeper-13-8-7-legacy/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-zookeeper-13-8-7-legacy/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-zookeeper-13-8-7-legacy/out."
