...
SPACE="${CUB_SPACE:-helm-zookeeper-default}"
...
say "Render the default base variant into ./bitnami-zookeeper-13-8-7-default"
...
cub installer upload --work-dir ./bitnami-zookeeper-13-8-7-default --space "${SPACE}"
