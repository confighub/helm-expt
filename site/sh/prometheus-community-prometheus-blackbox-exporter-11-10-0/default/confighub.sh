...
SPACE="${CUB_SPACE:-helm-prometheus-blackbox-exporter-default}"
...
say "Render the default preset into ./prometheus-community-prometheus-blackbox-exporter-11-10-0-default"
