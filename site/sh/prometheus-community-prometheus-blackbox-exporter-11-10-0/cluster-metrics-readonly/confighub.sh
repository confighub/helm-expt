...
SPACE="${CUB_SPACE:-helm-prometheus-blackbox-exporter-cluster-metrics-readonly}"
...
say "Render the cluster-metrics-readonly base variant into ./prometheus-community-prometheus-blackbox-exporter-11-10-0-cluster-metrics-readonly"
...
cub installer upload --work-dir ./prometheus-community-prometheus-blackbox-exporter-11-10-0-cluster-metrics-readonly --space "${SPACE}"
