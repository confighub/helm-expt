...
SPACE="${CUB_SPACE:-helm-logstash-default}"
...
say "Render the default base variant into ./elastic-logstash-8-5-1-default"
...
cub installer upload --work-dir ./elastic-logstash-8-5-1-default --space "${SPACE}"
