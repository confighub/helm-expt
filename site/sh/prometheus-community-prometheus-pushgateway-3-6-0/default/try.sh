#!/usr/bin/env bash
# prometheus-community/prometheus-pushgateway 3.6.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/prometheus-community-prometheus-pushgateway-3-6-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./prometheus-community-prometheus-pushgateway-3-6-0-default"
...
if [ -d ./prometheus-community-prometheus-pushgateway-3-6-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./prometheus-community-prometheus-pushgateway-3-6-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./prometheus-community-prometheus-pushgateway-3-6-0-default/out/manifests

say "Done. The cluster received exactly the files in ./prometheus-community-prometheus-pushgateway-3-6-0-default/out."
