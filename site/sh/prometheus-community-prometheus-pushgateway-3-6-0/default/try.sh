#!/usr/bin/env bash
# prometheus-community/prometheus-pushgateway 3.6.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/prometheus-community-prometheus-pushgateway-3-6-0.html
set -euo pipefail
