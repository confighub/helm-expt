...
SPACE="${CUB_SPACE:-helm-argo-events-default}"
...
say "Render the default base variant into ./argo-cd-argo-events-2-4-21-default"
...
cub installer upload --work-dir ./argo-cd-argo-events-2-4-21-default --space "${SPACE}"
