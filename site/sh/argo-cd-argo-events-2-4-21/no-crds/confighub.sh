...
SPACE="${CUB_SPACE:-helm-argo-events-no-crds}"
...
say "Render the no-crds base variant into ./argo-cd-argo-events-2-4-21-no-crds"
...
cub installer upload --work-dir ./argo-cd-argo-events-2-4-21-no-crds --space "${SPACE}"
