#!/usr/bin/env bash
# autoscaler/cluster-autoscaler 9.57.0 - preset: controller-default-reviewed
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/autoscaler-cluster-autoscaler-9-57-0.html
set -euo pipefail
...
say "Pull the package and render the controller-default-reviewed preset into ./autoscaler-cluster-autoscaler-9-57-0-controller-default-reviewed"
