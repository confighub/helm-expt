...
SPACE="${CUB_SPACE:-helm-redis-reuse-existing-secret}"
...
say "Render the reuse-existing-secret base variant into ./bitnami-redis-25-5-3-reuse-existing-secret"
...
cub installer upload --work-dir ./bitnami-redis-25-5-3-reuse-existing-secret --space "${SPACE}"
...
#   - Secret redis/redis-existing-secret key redis-password (suggested: kubectl -n redis create secret generic redis-existing-secret --from-literal=redis-password="$(openssl rand -base64 32)")
