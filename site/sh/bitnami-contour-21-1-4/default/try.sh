#!/usr/bin/env bash
# bitnami/contour 21.1.4 - base variant: default
...
say "Pull the package and render the default base variant into ./bitnami-contour-21-1-4-default"
...
ls ./bitnami-contour-21-1-4-default/out/manifests
...
if [ "$missing_packaged_secrets" -eq 1 ]; then
  bash ./bitnami-contour-21-1-4-default/package/prerequisites/contour-certgen/run.sh default
else
...
if [ -d ./bitnami-contour-21-1-4-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-contour-21-1-4-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-contour-21-1-4-default/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-contour-21-1-4-default/out."
