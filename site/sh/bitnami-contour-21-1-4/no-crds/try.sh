...
if [ "$missing_packaged_secrets" -eq 1 ]; then
  bash ./bitnami-contour-21-1-4-no-crds/package/prerequisites/contour-certgen/run.sh default
else
...
if [ -d ./bitnami-contour-21-1-4-no-crds/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-contour-21-1-4-no-crds/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-contour-21-1-4-no-crds/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-contour-21-1-4-no-crds/out."
