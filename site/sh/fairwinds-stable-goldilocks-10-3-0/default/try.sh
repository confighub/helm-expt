#!/usr/bin/env bash
# fairwinds-stable/goldilocks 10.3.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/fairwinds-stable-goldilocks-10-3-0.html
set -euo pipefail
