#!/usr/bin/env bash
# cloudpirates/nginx 0.16.1 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/cloudpirates-nginx-0-16-1.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./cloudpirates-nginx-0-16-1-default"
...
ls ./cloudpirates-nginx-0-16-1-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./cloudpirates-nginx-0-16-1-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./cloudpirates-nginx-0-16-1-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./cloudpirates-nginx-0-16-1-default/out/manifests

say "Done. The cluster received exactly the files in ./cloudpirates-nginx-0-16-1-default/out."
