#!/usr/bin/env bash
# istio/istiod 1.30.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/istio-istiod-1-30-0.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./istio-istiod-1-30-0-default"
...
ls ./istio-istiod-1-30-0-default/out/manifests
...
kubectl apply -f ./istio-istiod-1-30-0-default/out/manifests

say "Done. The cluster received exactly the files in ./istio-istiod-1-30-0-default/out."
