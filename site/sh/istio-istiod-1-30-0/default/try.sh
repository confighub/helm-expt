#!/usr/bin/env bash
# istio/istiod 1.30.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/istio-istiod-1-30-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./istio-istiod-1-30-0-default"
