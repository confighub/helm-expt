...
SPACE="${CUB_SPACE:-helm-secrets-store-csi-driver-default}"
...
say "Render the default preset into ./secrets-store-csi-driver-secrets-store-csi-driver-1-6-0-default"
