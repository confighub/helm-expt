#!/usr/bin/env bash
# secrets-store-csi-driver/secrets-store-csi-driver 1.6.0 - preset: default
...
say "Pull the package and render the default preset into ./secrets-store-csi-driver-secrets-store-csi-driver-1-6-0-default"
