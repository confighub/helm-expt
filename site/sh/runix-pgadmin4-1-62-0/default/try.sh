#!/usr/bin/env bash
# runix/pgadmin4 1.62.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/runix-pgadmin4-1-62-0.html
set -euo pipefail
