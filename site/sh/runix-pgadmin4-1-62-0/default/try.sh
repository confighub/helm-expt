#!/usr/bin/env bash
# runix/pgadmin4 1.62.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/runix-pgadmin4-1-62-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./runix-pgadmin4-1-62-0-default"
...
if [ -d ./runix-pgadmin4-1-62-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./runix-pgadmin4-1-62-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./runix-pgadmin4-1-62-0-default/out/manifests

say "Done. The cluster received exactly the files in ./runix-pgadmin4-1-62-0-default/out."
