#!/usr/bin/env bash
# argo-cd/argo-workflows 1.0.14 - preset: minimal-crds
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/argo-cd-argo-workflows-1-0-14.html
set -euo pipefail
...
say "Pull the package and render the minimal-crds preset into ./argo-cd-argo-workflows-1-0-14-minimal-crds"
