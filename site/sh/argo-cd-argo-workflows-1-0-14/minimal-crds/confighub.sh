...
SPACE="${CUB_SPACE:-helm-argo-workflows-minimal-crds}"
...
say "Render the minimal-crds base variant into ./argo-cd-argo-workflows-1-0-14-minimal-crds"
...
cub installer upload --work-dir ./argo-cd-argo-workflows-1-0-14-minimal-crds --space "${SPACE}"
