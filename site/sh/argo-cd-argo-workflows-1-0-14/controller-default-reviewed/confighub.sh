...
SPACE="${CUB_SPACE:-helm-argo-workflows-controller-default-reviewed}"
...
say "Render the controller-default-reviewed preset into ./argo-cd-argo-workflows-1-0-14-controller-default-reviewed"
