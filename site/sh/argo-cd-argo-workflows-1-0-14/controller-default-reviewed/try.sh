#!/usr/bin/env bash
# argo-cd/argo-workflows 1.0.14 - preset: controller-default-reviewed
...
say "Pull the package and render the controller-default-reviewed preset into ./argo-cd-argo-workflows-1-0-14-controller-default-reviewed"
