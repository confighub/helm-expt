...
SPACE="${CUB_SPACE:-helm-karpenter-default}"
...
say "Render the default base variant into ./karpenter-karpenter-1-14-0-default"
...
cub installer upload --work-dir ./karpenter-karpenter-1-14-0-default --space "${SPACE}"
...
#   - minimum schedulable nodes 2 (suggested: use a target with at least 2 schedulable nodes before applying this base)
