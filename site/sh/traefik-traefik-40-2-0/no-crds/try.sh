#!/usr/bin/env bash
# traefik/traefik 40.2.0 - preset: no-crds
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/traefik-traefik-40-2-0.html
set -euo pipefail
...
say "Pull the package and render the no-crds preset into ./traefik-traefik-40-2-0-no-crds"
