...
SPACE="${CUB_SPACE:-helm-elasticsearch-ha}"
...
say "Render the ha base variant into ./bitnami-elasticsearch-22-1-6-ha"
...
cub installer upload --work-dir ./bitnami-elasticsearch-22-1-6-ha --space "${SPACE}"
