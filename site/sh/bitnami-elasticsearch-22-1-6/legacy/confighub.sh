...
SPACE="${CUB_SPACE:-helm-elasticsearch-legacy}"
...
say "Render the legacy base variant into ./bitnami-elasticsearch-22-1-6-legacy"
...
cub installer upload --work-dir ./bitnami-elasticsearch-22-1-6-legacy --space "${SPACE}"
