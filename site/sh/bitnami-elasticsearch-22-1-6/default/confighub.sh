...
SPACE="${CUB_SPACE:-helm-elasticsearch-default}"
...
say "Render the default base variant into ./bitnami-elasticsearch-22-1-6-default"
...
cub installer upload --work-dir ./bitnami-elasticsearch-22-1-6-default --space "${SPACE}"
