#!/usr/bin/env bash
# argo-cd/argo-rollouts 2.40.9 - preset: default
...
say "Pull the package and render the default preset into ./argo-cd-argo-rollouts-2-40-9-default"
...
if [ -d ./argo-cd-argo-rollouts-2-40-9-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./argo-cd-argo-rollouts-2-40-9-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./argo-cd-argo-rollouts-2-40-9-default/out/manifests

say "Done. The cluster received exactly the files in ./argo-cd-argo-rollouts-2-40-9-default/out."
