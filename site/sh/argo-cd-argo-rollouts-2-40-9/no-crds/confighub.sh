...
SPACE="${CUB_SPACE:-helm-argo-rollouts-no-crds}"
...
say "Render the no-crds preset into ./argo-cd-argo-rollouts-2-40-9-no-crds"
...
cub installer upload --work-dir ./argo-cd-argo-rollouts-2-40-9-no-crds --space "${SPACE}"
