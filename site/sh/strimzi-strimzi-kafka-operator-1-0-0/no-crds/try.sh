#!/usr/bin/env bash
# strimzi/strimzi-kafka-operator 1.0.0 - preset: no-crds
...
say "Pull the package and render the no-crds preset into ./strimzi-strimzi-kafka-operator-1-0-0-no-crds"
