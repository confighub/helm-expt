#!/usr/bin/env bash
# open-telemetry/opentelemetry-operator 0.114.0 - preset: default
...
say "Pull the package and render the default preset into ./open-telemetry-opentelemetry-operator-0-114-0-default"
