...
SPACE="${CUB_SPACE:-helm-mysql-operator-default}"
...
say "Render the default base variant into ./mysql-mysql-operator-2-3-0-default"
...
cub installer upload --work-dir ./mysql-mysql-operator-2-3-0-default --space "${SPACE}"
