...
SPACE="${CUB_SPACE:-helm-fluent-bit-default}"
...
say "Render the default base variant into ./fluent-fluent-bit-0-57-6-default"
...
cub installer upload --work-dir ./fluent-fluent-bit-0-57-6-default --space "${SPACE}"
