...
SPACE="${CUB_SPACE:-helm-pg-operator-default}"
...
say "Render the default base variant into ./percona-pg-operator-3-0-0-default"
...
cub installer upload --work-dir ./percona-pg-operator-3-0-0-default --space "${SPACE}"
