#!/usr/bin/env bash
# prometheus-community/kube-prometheus-stack 85.3.3 - preset: default
...
say "Render the default preset into ./prometheus-community-kube-prometheus-stack-85-3-3-default"
