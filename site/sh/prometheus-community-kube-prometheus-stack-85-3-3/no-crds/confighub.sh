...
#   - CRD alertmanagerconfigs.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD alertmanagers.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD podmonitors.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD probes.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD prometheusagents.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD prometheuses.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD prometheusrules.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD scrapeconfigs.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD servicemonitors.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
#   - CRD thanosrulers.monitoring.coreos.com (included in the package as prerequisites/target-facts/no-crds-crds.yaml)
