...
say "Render the existing-secret base variant into ./cloudpirates-rabbitmq-0-21-13-existing-secret"
...
cub installer upload --work-dir ./cloudpirates-rabbitmq-0-21-13-existing-secret --space "${SPACE}"
...
#   - Secret default/rabbitmq-consolidated keys rabbitmq-erlang-cookie,rabbitmq-password (suggested: kubectl -n default create secret generic rabbitmq-consolidated --from-literal=rabbitmq-erlang-cookie=<value> --from-literal=rabbitmq-password=<value>)
