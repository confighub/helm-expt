#!/usr/bin/env bash
# grafana/rollout-operator 0.49.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/grafana-rollout-operator-0-49-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./grafana-rollout-operator-0-49-0-default"
