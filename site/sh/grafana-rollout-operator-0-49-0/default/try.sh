#!/usr/bin/env bash
# grafana/rollout-operator 0.49.0 - base variant: default
...
if [ -d ./grafana-rollout-operator-0-49-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./grafana-rollout-operator-0-49-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./grafana-rollout-operator-0-49-0-default/out/manifests

say "Done. The cluster received exactly the files in ./grafana-rollout-operator-0-49-0-default/out."
