#!/usr/bin/env bash
# bitnami/opensearch 2.0.10 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/bitnami-opensearch-2-0-10.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./bitnami-opensearch-2-0-10-default"
