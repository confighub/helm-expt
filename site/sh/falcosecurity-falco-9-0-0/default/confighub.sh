...
SPACE="${CUB_SPACE:-helm-falco-default}"
...
say "Render the default base variant into ./falcosecurity-falco-9-0-0-default"
...
cub installer upload --work-dir ./falcosecurity-falco-9-0-0-default --space "${SPACE}"
