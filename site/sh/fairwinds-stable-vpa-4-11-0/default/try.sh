#!/usr/bin/env bash
# fairwinds-stable/vpa 4.11.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/fairwinds-stable-vpa-4-11-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./fairwinds-stable-vpa-4-11-0-default"
