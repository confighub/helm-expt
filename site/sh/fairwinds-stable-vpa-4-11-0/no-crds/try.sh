#!/usr/bin/env bash
# fairwinds-stable/vpa 4.11.0 - preset: no-crds
...
say "Pull the package and render the no-crds preset into ./fairwinds-stable-vpa-4-11-0-no-crds"
