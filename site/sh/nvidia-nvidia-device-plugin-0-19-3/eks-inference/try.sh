...
if [ -d ./nvidia-nvidia-device-plugin-0-19-3-eks-inference/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./nvidia-nvidia-device-plugin-0-19-3-eks-inference/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./nvidia-nvidia-device-plugin-0-19-3-eks-inference/out/manifests

say "Done. The cluster received exactly the files in ./nvidia-nvidia-device-plugin-0-19-3-eks-inference/out."
