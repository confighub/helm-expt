...
SPACE="${CUB_SPACE:-helm-nvidia-device-plugin-default}"
...
say "Render the default base variant into ./nvidia-nvidia-device-plugin-0-19-3-default"
...
cub installer upload --work-dir ./nvidia-nvidia-device-plugin-0-19-3-default --space "${SPACE}"
