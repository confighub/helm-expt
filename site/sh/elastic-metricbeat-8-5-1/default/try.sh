#!/usr/bin/env bash
# elastic/metricbeat 8.5.1 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/elastic-metricbeat-8-5-1.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./elastic-metricbeat-8-5-1-default"
