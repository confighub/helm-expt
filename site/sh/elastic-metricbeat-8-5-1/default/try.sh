#!/usr/bin/env bash
# elastic/metricbeat 8.5.1 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/elastic-metricbeat-8-5-1.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./elastic-metricbeat-8-5-1-default"
...
ls ./elastic-metricbeat-8-5-1-default/out/manifests
...
kubectl apply -f ./elastic-metricbeat-8-5-1-default/out/manifests

say "Done. The cluster received exactly the files in ./elastic-metricbeat-8-5-1-default/out."
