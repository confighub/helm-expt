...
SPACE="${CUB_SPACE:-helm-tenant-default}"
...
say "Render the default base variant into ./minio-operator-tenant-7-1-1-default"
...
cub installer upload --work-dir ./minio-operator-tenant-7-1-1-default --space "${SPACE}"
