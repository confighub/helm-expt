#!/usr/bin/env bash
# minio-operator/tenant 7.1.1 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/minio-operator-tenant-7-1-1.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./minio-operator-tenant-7-1-1-default"
