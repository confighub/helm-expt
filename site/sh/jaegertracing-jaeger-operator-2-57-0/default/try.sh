#!/usr/bin/env bash
# jaegertracing/jaeger-operator 2.57.0 - preset: default
...
say "Pull the package and render the default preset into ./jaegertracing-jaeger-operator-2-57-0-default"
