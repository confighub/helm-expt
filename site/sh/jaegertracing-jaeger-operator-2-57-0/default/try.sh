#!/usr/bin/env bash
# jaegertracing/jaeger-operator 2.57.0 - base variant: default
...
say "Pull the package and render the default base variant into ./jaegertracing-jaeger-operator-2-57-0-default"
...
ls ./jaegertracing-jaeger-operator-2-57-0-default/out/manifests
...
if [ -d ./jaegertracing-jaeger-operator-2-57-0-default/out/secrets ]; then
  ...
  kubectl apply -f ./jaegertracing-jaeger-operator-2-57-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./jaegertracing-jaeger-operator-2-57-0-default/out/manifests

say "Done. The cluster received exactly the files in ./jaegertracing-jaeger-operator-2-57-0-default/out."
