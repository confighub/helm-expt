#!/usr/bin/env bash
# gitlab/gitlab-runner 0.89.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/gitlab-gitlab-runner-0-89-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./gitlab-gitlab-runner-0-89-0-default"
