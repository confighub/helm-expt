#!/usr/bin/env bash
# gitlab/gitlab-runner 0.89.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/gitlab-gitlab-runner-0-89-0.html
set -euo pipefail
...
if [ -d ./gitlab-gitlab-runner-0-89-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./gitlab-gitlab-runner-0-89-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./gitlab-gitlab-runner-0-89-0-default/out/manifests

say "Done. The cluster received exactly the files in ./gitlab-gitlab-runner-0-89-0-default/out."
