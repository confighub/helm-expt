...
SPACE="${CUB_SPACE:-helm-gitlab-runner-default}"
...
say "Render the default base variant into ./gitlab-gitlab-runner-0-89-0-default"
...
cub installer upload --work-dir ./gitlab-gitlab-runner-0-89-0-default --space "${SPACE}"
