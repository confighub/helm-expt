#!/usr/bin/env bash
# valkey/valkey 0.11.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/valkey-valkey-0-11-0.html
set -euo pipefail
...
if [ -d ./valkey-valkey-0-11-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./valkey-valkey-0-11-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./valkey-valkey-0-11-0-default/out/manifests

say "Done. The cluster received exactly the files in ./valkey-valkey-0-11-0-default/out."
