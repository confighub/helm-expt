...
SPACE="${CUB_SPACE:-helm-valkey-default}"
...
say "Render the default base variant into ./valkey-valkey-0-11-0-default"
...
cub installer upload --work-dir ./valkey-valkey-0-11-0-default --space "${SPACE}"
