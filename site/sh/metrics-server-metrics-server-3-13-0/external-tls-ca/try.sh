#!/usr/bin/env bash
# metrics-server/metrics-server 3.13.0 - preset: external-tls-ca
...
say "Pull the package and render the external-tls-ca preset into ./metrics-server-metrics-server-3-13-0-external-tls-ca"
