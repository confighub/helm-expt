...
SPACE="${CUB_SPACE:-helm-metrics-server-default}"
...
say "Render the default base variant into ./metrics-server-metrics-server-3-13-0-default"
...
cub installer upload --work-dir ./metrics-server-metrics-server-3-13-0-default --space "${SPACE}"
