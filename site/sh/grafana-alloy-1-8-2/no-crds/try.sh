#!/usr/bin/env bash
# grafana/alloy 1.8.2 - preset: no-crds
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/grafana-alloy-1-8-2.html
set -euo pipefail
...
say "Pull the package and render the no-crds preset into ./grafana-alloy-1-8-2-no-crds"
