#!/usr/bin/env bash
# grafana/alloy 1.8.2 - base variant: no-crds
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/grafana-alloy-1-8-2.html
set -euo pipefail
...
say "Pull the package and render the no-crds base variant into ./grafana-alloy-1-8-2-no-crds"
...
ls ./grafana-alloy-1-8-2-no-crds/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./grafana-alloy-1-8-2-no-crds/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./grafana-alloy-1-8-2-no-crds/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./grafana-alloy-1-8-2-no-crds/out/manifests

say "Done. The cluster received exactly the files in ./grafana-alloy-1-8-2-no-crds/out."
