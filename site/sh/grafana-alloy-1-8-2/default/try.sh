#!/usr/bin/env bash
# grafana/alloy 1.8.2 - base variant: default
...
if [ -d ./grafana-alloy-1-8-2-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./grafana-alloy-1-8-2-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./grafana-alloy-1-8-2-default/out/manifests

say "Done. The cluster received exactly the files in ./grafana-alloy-1-8-2-default/out."
