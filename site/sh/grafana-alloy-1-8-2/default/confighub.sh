...
SPACE="${CUB_SPACE:-helm-alloy-default}"
...
say "Render the default base variant into ./grafana-alloy-1-8-2-default"
...
cub installer upload --work-dir ./grafana-alloy-1-8-2-default --space "${SPACE}"
