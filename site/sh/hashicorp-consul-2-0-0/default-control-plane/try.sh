#!/usr/bin/env bash
# hashicorp/consul 2.0.0 - preset: default-control-plane
...
say "Pull the package and render the default-control-plane preset into ./hashicorp-consul-2-0-0-default-control-plane"
