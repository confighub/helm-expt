#!/usr/bin/env bash
# jaegertracing/jaeger 4.8.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/jaegertracing-jaeger-4-8-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./jaegertracing-jaeger-4-8-0-default"
