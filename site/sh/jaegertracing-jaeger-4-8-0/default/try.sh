#!/usr/bin/env bash
# jaegertracing/jaeger 4.8.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/jaegertracing-jaeger-4-8-0.html
set -euo pipefail
...
if [ -d ./jaegertracing-jaeger-4-8-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./jaegertracing-jaeger-4-8-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./jaegertracing-jaeger-4-8-0-default/out/manifests

say "Done. The cluster received exactly the files in ./jaegertracing-jaeger-4-8-0-default/out."
