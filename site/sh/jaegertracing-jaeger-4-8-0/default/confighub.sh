...
SPACE="${CUB_SPACE:-helm-jaeger-default}"
...
say "Render the default base variant into ./jaegertracing-jaeger-4-8-0-default"
...
cub installer upload --work-dir ./jaegertracing-jaeger-4-8-0-default --space "${SPACE}"
