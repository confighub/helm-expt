#!/usr/bin/env bash
# vm/victoria-metrics-single 0.39.0 - preset: default-reviewed
...
say "Pull the package and render the default-reviewed preset into ./vm-victoria-metrics-single-0-39-0-default-reviewed"
...
if [ -d ./vm-victoria-metrics-single-0-39-0-default-reviewed/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./vm-victoria-metrics-single-0-39-0-default-reviewed/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./vm-victoria-metrics-single-0-39-0-default-reviewed/out/manifests

say "Done. The cluster received exactly the files in ./vm-victoria-metrics-single-0-39-0-default-reviewed/out."
