...
SPACE="${CUB_SPACE:-helm-victoria-metrics-single-default-reviewed}"
...
say "Render the default-reviewed preset into ./vm-victoria-metrics-single-0-39-0-default-reviewed"
