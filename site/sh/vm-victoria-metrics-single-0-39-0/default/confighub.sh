...
SPACE="${CUB_SPACE:-helm-victoria-metrics-single-default}"
...
say "Render the default base variant into ./vm-victoria-metrics-single-0-39-0-default"
...
cub installer upload --work-dir ./vm-victoria-metrics-single-0-39-0-default --space "${SPACE}"
