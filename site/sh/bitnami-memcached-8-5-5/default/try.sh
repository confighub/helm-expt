#!/usr/bin/env bash
# bitnami/memcached 8.5.5 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/bitnami-memcached-8-5-5.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./bitnami-memcached-8-5-5-default"
