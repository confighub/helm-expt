#!/usr/bin/env bash
# bitnami/memcached 8.5.5 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/bitnami-memcached-8-5-5.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./bitnami-memcached-8-5-5-default"
...
ls ./bitnami-memcached-8-5-5-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./bitnami-memcached-8-5-5-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-memcached-8-5-5-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-memcached-8-5-5-default/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-memcached-8-5-5-default/out."
