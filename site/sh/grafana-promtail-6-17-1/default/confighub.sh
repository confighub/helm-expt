...
SPACE="${CUB_SPACE:-helm-promtail-default}"
...
say "Render the default base variant into ./grafana-promtail-6-17-1-default"
...
cub installer upload --work-dir ./grafana-promtail-6-17-1-default --space "${SPACE}"
