#!/usr/bin/env bash
# prometheus-community/prometheus-node-exporter 4.55.0 - base variant: default
...
say "Pull the package and render the default base variant into ./prometheus-community-prometheus-node-exporter-4-55-0-default"
...
ls ./prometheus-community-prometheus-node-exporter-4-55-0-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./prometheus-community-prometheus-node-exporter-4-55-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./prometheus-community-prometheus-node-exporter-4-55-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./prometheus-community-prometheus-node-exporter-4-55-0-default/out/manifests

say "Done. The cluster received exactly the files in ./prometheus-community-prometheus-node-exporter-4-55-0-default/out."
