...
SPACE="${CUB_SPACE:-helm-eck-operator-ha}"
...
say "Render the ha base variant into ./elastic-eck-operator-3-4-0-ha"
...
cub installer upload --work-dir ./elastic-eck-operator-3-4-0-ha --space "${SPACE}"
