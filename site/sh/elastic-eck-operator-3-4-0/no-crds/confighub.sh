...
SPACE="${CUB_SPACE:-helm-eck-operator-no-crds}"
...
say "Render the no-crds base variant into ./elastic-eck-operator-3-4-0-no-crds"
...
cub installer upload --work-dir ./elastic-eck-operator-3-4-0-no-crds --space "${SPACE}"
