...
SPACE="${CUB_SPACE:-helm-eck-operator-default}"
...
say "Render the default base variant into ./elastic-eck-operator-3-4-0-default"
...
cub installer upload --work-dir ./elastic-eck-operator-3-4-0-default --space "${SPACE}"
