...
SPACE="${CUB_SPACE:-helm-ec2-chart-default}"
...
say "Render the default base variant into ./aws-controllers-k8s-ec2-chart-1-18-4-default"
...
cub installer upload --work-dir ./aws-controllers-k8s-ec2-chart-1-18-4-default --space "${SPACE}"
