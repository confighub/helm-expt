#!/usr/bin/env bash
# aws-controllers-k8s/ec2-chart 1.18.4 - base variant: default
...
if [ -d ./aws-controllers-k8s-ec2-chart-1-18-4-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./aws-controllers-k8s-ec2-chart-1-18-4-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./aws-controllers-k8s-ec2-chart-1-18-4-default/out/manifests

say "Done. The cluster received exactly the files in ./aws-controllers-k8s-ec2-chart-1-18-4-default/out."
