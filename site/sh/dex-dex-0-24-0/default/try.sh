#!/usr/bin/env bash
# dex/dex 0.24.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/dex-dex-0-24-0.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./dex-dex-0-24-0-default"
...
ls ./dex-dex-0-24-0-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./dex-dex-0-24-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./dex-dex-0-24-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./dex-dex-0-24-0-default/out/manifests

say "Done. The cluster received exactly the files in ./dex-dex-0-24-0-default/out."
