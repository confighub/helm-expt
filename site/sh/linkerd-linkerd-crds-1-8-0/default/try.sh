#!/usr/bin/env bash
# linkerd/linkerd-crds 1.8.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/linkerd-linkerd-crds-1-8-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./linkerd-linkerd-crds-1-8-0-default"
