...
SPACE="${CUB_SPACE:-helm-linkerd-crds-default}"
...
say "Render the default base variant into ./linkerd-linkerd-crds-1-8-0-default"
...
cub installer upload --work-dir ./linkerd-linkerd-crds-1-8-0-default --space "${SPACE}"
