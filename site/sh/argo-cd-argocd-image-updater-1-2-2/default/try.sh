#!/usr/bin/env bash
# argo-cd/argocd-image-updater 1.2.2 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/argo-cd-argocd-image-updater-1-2-2.html
set -euo pipefail
...
say "Pull the package and render the default base variant into ./argo-cd-argocd-image-updater-1-2-2-default"
...
ls ./argo-cd-argocd-image-updater-1-2-2-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./argo-cd-argocd-image-updater-1-2-2-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./argo-cd-argocd-image-updater-1-2-2-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./argo-cd-argocd-image-updater-1-2-2-default/out/manifests

say "Done. The cluster received exactly the files in ./argo-cd-argocd-image-updater-1-2-2-default/out."
