#!/usr/bin/env bash
# argo-cd/argocd-image-updater 1.2.2 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/argo-cd-argocd-image-updater-1-2-2.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./argo-cd-argocd-image-updater-1-2-2-default"
