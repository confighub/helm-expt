#!/usr/bin/env bash
# kyverno/kyverno-policies 3.8.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/kyverno-kyverno-policies-3-8-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./kyverno-kyverno-policies-3-8-0-default"
