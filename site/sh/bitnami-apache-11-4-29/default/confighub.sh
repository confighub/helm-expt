...
SPACE="${CUB_SPACE:-helm-apache-default}"
...
say "Render the default base variant into ./bitnami-apache-11-4-29-default"
...
cub installer upload --work-dir ./bitnami-apache-11-4-29-default --space "${SPACE}"
