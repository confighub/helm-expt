#!/usr/bin/env bash
# bitnami/apache 11.4.29 - base variant: default
...
if [ -d ./bitnami-apache-11-4-29-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./bitnami-apache-11-4-29-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./bitnami-apache-11-4-29-default/out/manifests

say "Done. The cluster received exactly the files in ./bitnami-apache-11-4-29-default/out."
