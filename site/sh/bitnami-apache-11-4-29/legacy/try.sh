#!/usr/bin/env bash
# bitnami/apache 11.4.29 - preset: legacy
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/bitnami-apache-11-4-29.html
set -euo pipefail
...
say "Pull the package and render the legacy preset into ./bitnami-apache-11-4-29-legacy"
