#!/usr/bin/env bash
# kyverno/kyverno 3.8.1 - preset: default
...
say "Pull the package and render the default preset into ./kyverno-kyverno-3-8-1-default"
...
ls ./kyverno-kyverno-3-8-1-default/out/manifests

say "Ensure the default namespace exists"
kubectl create namespace default --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./kyverno-kyverno-3-8-1-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./kyverno-kyverno-3-8-1-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./kyverno-kyverno-3-8-1-default/out/manifests

say "Done. The cluster received exactly the files in ./kyverno-kyverno-3-8-1-default/out."
