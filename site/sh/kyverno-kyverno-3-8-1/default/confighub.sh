...
SPACE="${CUB_SPACE:-helm-kyverno-default}"
...
say "Render the default preset into ./kyverno-kyverno-3-8-1-default"
...
cub installer upload --work-dir ./kyverno-kyverno-3-8-1-default --space "${SPACE}"
