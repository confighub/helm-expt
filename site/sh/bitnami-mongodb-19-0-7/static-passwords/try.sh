#!/usr/bin/env bash
# bitnami/mongodb 19.0.7 - preset: static-passwords
...
say "Pull the package and render the static-passwords preset into ./bitnami-mongodb-19-0-7-static-passwords"
