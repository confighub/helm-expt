...
SPACE="${CUB_SPACE:-helm-cert-manager-csi-driver-default}"
...
say "Render the default base variant into ./jetstack-cert-manager-csi-driver-v0-14-0-default"
...
cub installer upload --work-dir ./jetstack-cert-manager-csi-driver-v0-14-0-default --space "${SPACE}"
