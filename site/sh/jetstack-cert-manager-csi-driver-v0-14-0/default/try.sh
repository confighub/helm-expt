#!/usr/bin/env bash
# jetstack/cert-manager-csi-driver v0.14.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/jetstack-cert-manager-csi-driver-v0-14-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./jetstack-cert-manager-csi-driver-v0-14-0-default"
...
if [ -d ./jetstack-cert-manager-csi-driver-v0-14-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./jetstack-cert-manager-csi-driver-v0-14-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./jetstack-cert-manager-csi-driver-v0-14-0-default/out/manifests

say "Done. The cluster received exactly the files in ./jetstack-cert-manager-csi-driver-v0-14-0-default/out."
