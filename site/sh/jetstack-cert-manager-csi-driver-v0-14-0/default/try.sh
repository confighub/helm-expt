#!/usr/bin/env bash
# jetstack/cert-manager-csi-driver v0.14.0 - base variant: default
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/jetstack-cert-manager-csi-driver-v0-14-0.html
set -euo pipefail
