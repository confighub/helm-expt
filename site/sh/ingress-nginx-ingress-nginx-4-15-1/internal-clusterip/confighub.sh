...
SPACE="${CUB_SPACE:-helm-ingress-nginx-internal-clusterip}"
...
say "Render the internal-clusterip preset into ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip"
