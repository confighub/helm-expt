#!/usr/bin/env bash
# ingress-nginx/ingress-nginx 4.15.1 - base variant: internal-clusterip
...
say "Pull the package and render the internal-clusterip base variant into ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip"
...
ls ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip/out/manifests

say "Ensure the ingress-nginx namespace exists"
kubectl create namespace ingress-nginx --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip/out/manifests

say "Done. The cluster received exactly the files in ./ingress-nginx-ingress-nginx-4-15-1-internal-clusterip/out."
