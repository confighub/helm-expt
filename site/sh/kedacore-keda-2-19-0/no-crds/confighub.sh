...
SPACE="${CUB_SPACE:-helm-keda-no-crds}"
...
say "Render the no-crds base variant into ./kedacore-keda-2-19-0-no-crds"
...
cub installer upload --work-dir ./kedacore-keda-2-19-0-no-crds --space "${SPACE}"
