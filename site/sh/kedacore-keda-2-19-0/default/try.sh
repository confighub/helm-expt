#!/usr/bin/env bash
# kedacore/keda 2.19.0 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/kedacore-keda-2-19-0.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./kedacore-keda-2-19-0-default"
...
if [ -d ./kedacore-keda-2-19-0-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./kedacore-keda-2-19-0-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./kedacore-keda-2-19-0-default/out/manifests

say "Done. The cluster received exactly the files in ./kedacore-keda-2-19-0-default/out."
