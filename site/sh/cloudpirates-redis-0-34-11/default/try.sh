#!/usr/bin/env bash
# cloudpirates/redis 0.34.11 - base variant: default
...
if [ -d ./cloudpirates-redis-0-34-11-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./cloudpirates-redis-0-34-11-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./cloudpirates-redis-0-34-11-default/out/manifests

say "Done. The cluster received exactly the files in ./cloudpirates-redis-0-34-11-default/out."
