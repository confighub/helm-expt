...
SPACE="${CUB_SPACE:-helm-redis-default}"
...
say "Render the default base variant into ./cloudpirates-redis-0-34-11-default"
...
cub installer upload --work-dir ./cloudpirates-redis-0-34-11-default --space "${SPACE}"
