...
#   - Secret default/redis-existing-secret key redis-password (suggested: kubectl -n default create secret generic redis-existing-secret --from-literal=redis-password=<value>)
