...
SPACE="${CUB_SPACE:-helm-trivy-operator-default}"
...
say "Render the default base variant into ./aqua-trivy-operator-0-32-1-default"
...
cub installer upload --work-dir ./aqua-trivy-operator-0-32-1-default --space "${SPACE}"
