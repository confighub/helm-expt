#!/usr/bin/env bash
# aws-controllers-k8s/iam-chart 1.7.3 - base variant: default
...
say "Pull the package and render the default base variant into ./aws-controllers-k8s-iam-chart-1-7-3-default"
...
ls ./aws-controllers-k8s-iam-chart-1-7-3-default/out/manifests

say "Ensure the ack-system namespace exists"
kubectl create namespace ack-system --dry-run=client -o yaml | kubectl apply -f -

if [ -d ./aws-controllers-k8s-iam-chart-1-7-3-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./aws-controllers-k8s-iam-chart-1-7-3-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./aws-controllers-k8s-iam-chart-1-7-3-default/out/manifests

say "Done. The cluster received exactly the files in ./aws-controllers-k8s-iam-chart-1-7-3-default/out."
