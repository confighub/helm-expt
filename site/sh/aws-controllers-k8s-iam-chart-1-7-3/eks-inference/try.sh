#!/usr/bin/env bash
# aws-controllers-k8s/iam-chart 1.7.3 - base variant: eks-inference
...
# data for this base variant. Chart page: https://confighub.github.io/helm-expt/site/charts/aws-controllers-k8s-iam-chart-1-7-3.html
set -euo pipefail
...
say "Pull the package and render the eks-inference base variant into ./aws-controllers-k8s-iam-chart-1-7-3-eks-inference"
...
ls ./aws-controllers-k8s-iam-chart-1-7-3-eks-inference/out/manifests
...
if [ -d ./aws-controllers-k8s-iam-chart-1-7-3-eks-inference/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./aws-controllers-k8s-iam-chart-1-7-3-eks-inference/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./aws-controllers-k8s-iam-chart-1-7-3-eks-inference/out/manifests

say "Done. The cluster received exactly the files in ./aws-controllers-k8s-iam-chart-1-7-3-eks-inference/out."
