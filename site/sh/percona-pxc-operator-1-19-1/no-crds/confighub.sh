...
SPACE="${CUB_SPACE:-helm-pxc-operator-no-crds}"
...
say "Render the no-crds base variant into ./percona-pxc-operator-1-19-1-no-crds"
...
cub installer upload --work-dir ./percona-pxc-operator-1-19-1-no-crds --space "${SPACE}"
