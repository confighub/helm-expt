...
SPACE="${CUB_SPACE:-helm-pxc-operator-default}"
...
say "Render the default base variant into ./percona-pxc-operator-1-19-1-default"
...
cub installer upload --work-dir ./percona-pxc-operator-1-19-1-default --space "${SPACE}"
