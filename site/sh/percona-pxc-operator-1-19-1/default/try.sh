#!/usr/bin/env bash
# percona/pxc-operator 1.19.1 - preset: default
...
# data for this preset. Chart page: https://confighub.github.io/helm-expt/site/charts/percona-pxc-operator-1-19-1.html
set -euo pipefail
...
say "Pull the package and render the default preset into ./percona-pxc-operator-1-19-1-default"
