#!/usr/bin/env bash
# autoscaler/vertical-pod-autoscaler 0.9.0 - preset: default
...
say "Pull the package and render the default preset into ./autoscaler-vertical-pod-autoscaler-0-9-0-default"
