...
SPACE="${CUB_SPACE:-helm-vertical-pod-autoscaler-default}"
...
say "Render the default base variant into ./autoscaler-vertical-pod-autoscaler-0-9-0-default"
...
cub installer upload --work-dir ./autoscaler-vertical-pod-autoscaler-0-9-0-default --space "${SPACE}"
