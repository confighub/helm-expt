#!/usr/bin/env bash
# gatekeeper/gatekeeper 3.22.2 - preset: default
...
say "Pull the package and render the default preset into ./gatekeeper-gatekeeper-3-22-2-default"
...
if [ -d ./gatekeeper-gatekeeper-3-22-2-default/out/secrets ]; then
  say "Apply rendered Secrets first"
  kubectl apply -f ./gatekeeper-gatekeeper-3-22-2-default/out/secrets
fi

say "Apply the rendered objects"
kubectl apply -f ./gatekeeper-gatekeeper-3-22-2-default/out/manifests

say "Done. The cluster received exactly the files in ./gatekeeper-gatekeeper-3-22-2-default/out."
