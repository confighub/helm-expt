...
SPACE="${CUB_SPACE:-helm-phpmyadmin-default}"
...
say "Render the default base variant into ./bitnami-phpmyadmin-20-0-0-default"
...
cub installer upload --work-dir ./bitnami-phpmyadmin-20-0-0-default --space "${SPACE}"
