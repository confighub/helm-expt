...
- `default`: chart defaults with CRDs, Linux DaemonSet, CSIDriver, and RBAC; 10 Helm objects, 11 cub install objects including Namespace.
- `sync-secret-rotation`: Secret syncing, rotation, and provider health checks are explicit; 12 Helm objects, 13 cub install objects including Namespace.
