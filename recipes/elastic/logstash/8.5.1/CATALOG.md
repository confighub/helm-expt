...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/elastic-logstash:8.5.1` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/elastic-logstash:8.5.1 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
