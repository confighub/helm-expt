...
| Installer package | [packages/bitnami/postgresql/18.7.0](../../../../packages/bitnami/postgresql/18.7.0) |
...
```sh
cub installer setup --pull packages/bitnami/postgresql/18.7.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
