# bitnami/opensearch 2.0.10 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 18 Helm objects, 19 `cub installer` objects including allowed support objects.
