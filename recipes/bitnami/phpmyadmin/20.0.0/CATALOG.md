...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/bitnami-phpmyadmin:20.0.0` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/bitnami-phpmyadmin:20.0.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
