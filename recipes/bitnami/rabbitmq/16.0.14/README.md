...
- `static-passwords`: RabbitMQ password and Erlang cookie bound as generated facts; image repository pinned to the still-pullable Bitnami legacy mirror with explicit image-substitution policy; 10 Helm objects, 11 cub installer objects including Namespace.
