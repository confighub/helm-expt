...
| Installer package | [packages/bitnami/contour/21.1.4](../../../../packages/bitnami/contour/21.1.4) |
...
```sh
cub installer setup --pull packages/bitnami/contour/21.1.4 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
