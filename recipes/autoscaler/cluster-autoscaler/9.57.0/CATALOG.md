...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/autoscaler-cluster-autoscaler:9.57.0` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/autoscaler-cluster-autoscaler:9.57.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
