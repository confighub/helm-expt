...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/hashicorp-terraform:1.1.2` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/hashicorp-terraform:1.1.2 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
