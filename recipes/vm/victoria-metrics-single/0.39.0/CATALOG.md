...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/vm-victoria-metrics-single:0.39.0` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/vm-victoria-metrics-single:0.39.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
