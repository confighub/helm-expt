# vm/victoria-logs-single 0.12.5 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 2 Helm objects, 3 `cub installer` objects including allowed support objects.
