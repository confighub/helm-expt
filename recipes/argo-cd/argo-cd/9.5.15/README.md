...
- `default`: chart defaults; 49 Helm objects, 50 cub install objects including Namespace.
- `no-crds`: Argo CD CRDs disabled; 46 Helm objects, 47 cub install objects including Namespace.
