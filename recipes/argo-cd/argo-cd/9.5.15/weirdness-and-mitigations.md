...
| hook-generated-secret | target-fact-for-config-only-lanes | Regular Helm creates this Secret via the chart secret-init path; config-only lanes stage it explicitly before workloads start. |
