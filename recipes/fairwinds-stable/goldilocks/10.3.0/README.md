# fairwinds-stable/goldilocks 10.3.0 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 9 Helm objects, 10 `cub install` objects including allowed support objects.
