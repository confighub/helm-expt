...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/minio-operator-tenant:7.1.1` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/minio-operator-tenant:7.1.1 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
