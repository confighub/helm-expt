...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/gatekeeper-gatekeeper:3.22.2` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/gatekeeper-gatekeeper:3.22.2 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
