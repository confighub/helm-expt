# rook-release/rook-ceph-cluster v1.19.5 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 27 Helm objects, 28 `cub installer` objects including allowed support objects.
