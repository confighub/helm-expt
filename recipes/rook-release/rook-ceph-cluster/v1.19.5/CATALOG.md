...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/rook-release-rook-ceph-cluster:v1.19.5` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/rook-release-rook-ceph-cluster:v1.19.5 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
