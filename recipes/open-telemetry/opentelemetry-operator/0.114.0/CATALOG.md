...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/open-telemetry-opentelemetry-operator:0.114.0` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/open-telemetry-opentelemetry-operator:0.114.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
