# open-telemetry/opentelemetry-operator 0.114.0 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 17 Helm objects, 18 `cub installer` objects including allowed support objects.
