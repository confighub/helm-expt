# crossplane-stable/crossplane 2.3.1 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 23 Helm objects, 24 `cub installer` objects including allowed support objects.
