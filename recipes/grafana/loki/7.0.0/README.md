...
- `simple-scalable-minio`: simple scalable Loki with one read/write/backend replica, explicit object-storage buckets, and MinIO enabled; 33 Helm objects, 34 cub installer objects including Namespace.
