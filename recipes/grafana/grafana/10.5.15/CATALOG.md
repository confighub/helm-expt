...
| GitOps runtime review | [recipes/grafana/grafana/10.5.15/gitops-runtime-review.yaml](gitops-runtime-review.yaml) |
...
| Installer package source | [packages/grafana/grafana/10.5.15](../../../../packages/grafana/grafana/10.5.15) |
...
```sh
cub installer setup --pull oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/grafana-grafana:10.5.15@sha256:fc038da08ab8544cdf8d3c08fd981e542de4d5e0f8ae61e21f163a9eb9956cc3 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
