...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/cloudnative-pg-cloudnative-pg:0.28.2` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/cloudnative-pg-cloudnative-pg:0.28.2 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
