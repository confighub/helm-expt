# cloudnative-pg/cloudnative-pg 0.28.2 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 21 Helm objects, 22 `cub installer` objects including allowed support objects.
