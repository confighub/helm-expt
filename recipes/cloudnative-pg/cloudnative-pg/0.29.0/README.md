# cloudnative-pg/cloudnative-pg 0.29.0 Proof
...
- `default`: chart defaults under Kubernetes 1.30.0; 22 Helm objects, 23 `cub installer` objects including allowed support objects.
