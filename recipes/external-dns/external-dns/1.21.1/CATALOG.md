...
| Proof lanes | render parity 3/3; ConfigHub 3/3; local live 3/3; GitOps live 2/3; live parity 2/3 |
...
| Installer package | [packages/external-dns/external-dns/1.21.1](../../../../packages/external-dns/external-dns/1.21.1) |
...
```sh
cub installer setup --pull packages/external-dns/external-dns/1.21.1 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
