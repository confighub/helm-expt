...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/prometheus-community-prometheus:29.8.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
