...
- `default`: default stack with Grafana admin password bound as a generated fact; 124 Helm objects, 125 cub install objects including Namespace.
- `no-crds`: CRDs disabled with Grafana admin password bound; 114 Helm objects, 115 cub install objects including Namespace.
