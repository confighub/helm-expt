# prometheus-community/prometheus-blackbox-exporter 11.10.0 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 4 Helm objects, 5 `cub installer` objects including allowed support objects.
