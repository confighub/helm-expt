# prometheus-community/prometheus-adapter 5.3.0 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 11 Helm objects, 12 `cub installer` objects including allowed support objects.
