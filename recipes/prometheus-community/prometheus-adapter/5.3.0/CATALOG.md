...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/prometheus-community-prometheus-adapter:5.3.0` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/prometheus-community-prometheus-adapter:5.3.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
