# prometheus-community/prometheus-node-exporter 4.55.0 Proof

This is one of the next 80 public-chart full proofs.

Variant:

- `default`: chart defaults under Kubernetes 1.30.0; 3 Helm objects, 4 `cub install` objects including allowed support objects.
