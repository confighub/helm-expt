...
| Installer package | [packages/prometheus-community/prometheus-node-exporter/4.55.0](../../../../packages/prometheus-community/prometheus-node-exporter/4.55.0) |
...
```sh
cub installer setup --pull packages/prometheus-community/prometheus-node-exporter/4.55.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
