...
| Installer package OCI | `oci://ghcr.io/confighub/helm-expt/prometheus-community-prometheus-node-exporter:4.55.0` |
...
```sh
cub installer setup --pull oci://ghcr.io/confighub/helm-expt/prometheus-community-prometheus-node-exporter:4.55.0 --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
