...
# prometheus-community/prometheus-node-exporter 4.55.0 Catalog Map
...
| Stage | Artifact |
| --- | --- |
| Source chart lock | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/source-lock.yaml](source-lock.yaml) |
| Dependency lock | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/dependency-lock.yaml](dependency-lock.yaml) |
| Recipe | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/recipe.yaml](recipe.yaml) |
| Helm plan | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/helm-plan.yaml](helm-plan.yaml) |
| Chart dossier | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/chart-dossier.yaml](chart-dossier.yaml) |
| Control points | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/control-points.yaml](control-points.yaml) |
| Value model | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/value-model.yaml](value-model.yaml) |
| Catalog status | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/catalog-status.yaml](catalog-status.yaml) |
| Helm pain report | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/helm-pain-report.yaml](helm-pain-report.yaml) |
| Installer package OCI | `oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/prometheus-community-prometheus-node-exporter:4.55.0@sha256:b5365489a899714904a438a5a3ccb2f7a7814f1b41bc16cf8fa41638e4ffa9cd` |
| Installer package source | [packages/prometheus-community/prometheus-node-exporter/4.55.0](../../../../packages/prometheus-community/prometheus-node-exporter/4.55.0) |
| Installer package receipt | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/publication/installer-package-receipt.yaml](publication/installer-package-receipt.yaml) |
| Machine index | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/artifact-index.yaml](artifact-index.yaml) |
...
| --- | --- | --- | --- | --- | --- |
| default | r001 | render | RenderReceipt | recorded | [recipes/prometheus-community/prometheus-node-exporter/4.55.0/revisions/default/r001/receipts/render-receipt.yaml](revisions/default/r001/receipts/render-receipt.yaml) |
...
```sh
cub installer setup --pull oci://europe-west1-docker.pkg.dev/nth-fort-499605-q5/helm-expt/prometheus-community-prometheus-node-exporter:4.55.0@sha256:b5365489a899714904a438a5a3ccb2f7a7814f1b41bc16cf8fa41638e4ffa9cd --base <variant> --work-dir <tmp> --non-interactive --namespace <namespace>
```
