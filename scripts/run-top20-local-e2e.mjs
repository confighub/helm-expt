...
const targets = [
  ...
  },
  {
    ...
    revision: "recipes/bitnami/postgresql/18.6.7/revisions/static-passwords/r001/variant-revision.yaml",
    rendered: "recipes/bitnami/postgresql/18.6.7/revisions/static-passwords/r001/rendered/release-objects.yaml",
    needsDefaultStorageClass: true,
  ...
  },
  {
    ...
    namespace: "rabbitmq",
    variant: "static-passwords",
    revision: "recipes/bitnami/rabbitmq/16.0.14/revisions/static-passwords/r001/variant-revision.yaml",
    rendered: "recipes/bitnami/rabbitmq/16.0.14/revisions/static-passwords/r001/rendered/release-objects.yaml",
    needsDefaultStorageClass: true,
  ...
  },
  {
    ...
    namespace: "grafana",
    variant: "static-passwords",
    revision: "recipes/grafana/grafana/10.5.15/revisions/static-passwords/r001/variant-revision.yaml",
    rendered: "recipes/grafana/grafana/10.5.15/revisions/static-passwords/r001/rendered/release-objects.yaml",
  },
  {
    rank: 16,
    slug: "mysql",
    ...
    namespace: "mysql",
    variant: "static-passwords",
    revision: "recipes/bitnami/mysql/14.0.3/revisions/static-passwords/r001/variant-revision.yaml",
    rendered: "recipes/bitnami/mysql/14.0.3/revisions/static-passwords/r001/rendered/release-objects.yaml",
    needsDefaultStorageClass: true,
  ...
  },
  {
    ...
    namespace: "mongodb",
    variant: "static-passwords",
    revision: "recipes/bitnami/mongodb/19.0.7/revisions/static-passwords/r001/variant-revision.yaml",
    rendered: "recipes/bitnami/mongodb/19.0.7/revisions/static-passwords/r001/rendered/release-objects.yaml",
    needsDefaultStorageClass: true,
  },
  {
    rank: 18,
