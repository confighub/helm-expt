...
function readme(rows) {
  const quickRoutes = [
    ...
    ["I want the checked eight-component EKS inference configuration path.", "data/certified-bundles/eks-inference-stack.md; data/eks-inference-sandbox-proof/summary.md"],
