...
function readme(rows) {
  const quickRoutes = [
    ...
    ["I want the checked eight-component EKS inference path, including one retained change promoted and delivered through Argo CD.", "data/certified-bundles/eks-inference-stack.md; data/eks-inference-sandbox-proof/summary.md; data/eks-inference-promotion-delivery-proof/summary.md"],
