...
function readme(rows) {
  const quickRoutes = [
    ...
    ["I want the same choose, check, and promote jobs on the website and command line.", "data/config-workshop-command-contract/summary.md; data/config-workshop-command-contract/command-map.json"],
    ["I want a pull-request comment from the same checked result.", "data/config-workshop-ci-report/summary.md"],
    ...
    ["I want the checked eight-component EKS inference path, including one retained change, Argo CD delivery, and one real CPU model request.", "data/certified-bundles/eks-inference-stack.md; data/eks-inference-sandbox-proof/summary.md; data/eks-inference-promotion-delivery-proof/summary.md; data/vllm-cpu-starter-proof/summary.md"],
    ["I want to pull and verify one AICR-derived configuration anonymously, without a cluster or GPU.", "data/aicr-cpu-starter-public-proof/summary.md"],
  ...
  const primary = [
    ...
    ["data/config-workshop-command-contract/summary.md", "The shared website and command-line contract for choosing, checking, retaining, and promoting configuration, with one exact Helm proof and one source-neutral YAML record."],
    ["data/config-workshop-ci-report/summary.md", "Source-neutral pull-request reports from exact WorkshopResult records, with bounded verdicts, findings, lifecycle requirements, omitted checks, and separate runtime status."],
    ...
    ["data/eks-inference-sandbox-proof/summary.md", "Live ConfigHub configuration proof for eight checked EKS inference OCI bundles: exact sources, linked variants, sandbox gates, and published Releases, without claiming a cloud or Kubernetes deployment."],
    ["data/eks-inference-promotion-delivery-proof/summary.md", "Live promotion and delivery proof for one EKS inference configuration change: one field changed, identical dev/staging/delivery Unit hashes, a published OCI Release, the matching Argo CD revision, and two healthy local replicas."],
    ["data/vllm-cpu-starter-proof/summary.md", "Live CPU inference proof: two checked Units changed from the EKS inference source, ConfigHub published release OCI, Argo CD pulled the same digest, vLLM became ready, and one real model request completed."],
    ["data/aicr-cpu-starter-public-proof/summary.md", "Anonymous AICR configuration proof: public source digest, seven reviewed Application hashes, source-and-intent record, local OCI digest, and pull-back comparison without ConfigHub, Kubernetes, cloud, or GPU access."],
