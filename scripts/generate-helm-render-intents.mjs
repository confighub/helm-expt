...
function summaryMd(intents, matrixRows, candidates) {
  ...
  o.push("");
  o.push("This report connects the full helm-expt chain to the shorter ConfigHub model. A render intent is one reviewed base-variant path: chart, version, values profile, namespace, capability profile, source lock, package base, evidence lanes, lifecycle routes, and target prerequisites.");
  o.push("");
