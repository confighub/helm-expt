...
const variants = [
  {
    ...
    valuesText: `image:
  digest: sha256:805bcc863fc3f602589fc75cae91eeedebad234d5ce5a476c96b03a747821e7f
tls:
  enabled: false
service:
  type: ClusterIP
`,
    valuesSummary: "image pinned by digest, TLS generation disabled, and service exposure kept internal",
...
service:
  type: ClusterIP
`,
    valuesSummary: "image pinned by digest and target TLS Secrets supply backend and ingress certificates",
    ...
    checkedValues: [
      {
        ...
        reason: "supported bases pin the Bitnami NGINX image by digest instead of rendering the chart default latest tag",
      },
      {
        path: "tls.enabled",
