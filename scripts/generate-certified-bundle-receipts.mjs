...
function buildSpaceGuide({ name, producer, sourceLine, contentsKind, files, verdict, routeFiles, uploadCommand, manualNotes }) {
  ...
  lines.push("");
  lines.push(manualNotes ? `This configuration bundle can be ingested into a Space, one Unit per file. ${sourceLine}` : `This Space holds one certified bundle, ingested one Unit per file. ${sourceLine}`);
  lines.push("");
