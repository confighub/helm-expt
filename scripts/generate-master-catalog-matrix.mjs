...
<p class="sub">Layer marks the path from F1 source chart through F2 bases and F3 target inputs to F4 derived ConfigHub variants; candidate and human-review rows are planning rows, not proof claims. Hover any cell for the reason and next action. How to read each cell and lane letter is explained in <a href="https://confighub.github.io/helm-expt/site/d/docs/user/reading-the-matrix.html">reading the matrix</a>; the taxonomy and retention rules are part of <a href="https://confighub.github.io/helm-expt/site/d/docs/reference/how-the-catalog-is-built.html">how the catalog is built</a>.${unmatchedReadiness.length ? ` Not in top-100 readiness (candidates/version drift): ${unmatchedReadiness.map(escapeHtml).join(", ")}.` : ""}</p>
<table class="queues">
