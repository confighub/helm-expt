...
function whoRuns(execMode, actionKind, disposition) {
  if (actionKind === "install-crd") {
    return disposition === "observed"
      ...
      : "Prerequisite — supply the CRDs once (default base or your platform)";
  }
