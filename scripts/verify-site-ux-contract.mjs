...
const checks = [
  {
    ...
    terms: ["See What Your Configuration Will Do", "Helm first", "See the exact Kubernetes objects before you deploy", "Search the <a href=\"./charts/index.html\">Catalog</a>", "Use <a href=\"./ask.html\">Check my config</a>", "Your files stay on your machine", "Both paths work without an account", "Keep the version you approve as files or OCI", "Check my config", "Search tested configurations", "cub installer setup", "--output-oci", "Find, Check, Then Keep", "Find a tested configuration", "Check my own configuration", "Keep it in ConfigHub", "Four Problems We Help Solve", "Check the result and the limits", "Config Workshop", "AN EXPERIMENTAL TEST SITE FOR CONFIG TOOLS"],
  },
  {
  ...
  {
    file: "site/ask.html",
    terms: ["Check your configuration", "Here is the chart and values my AI produced", "chart configurations we have already tested and documented", "Use this page for your own chart, values, new version, or unexpected result", "Your files are not uploaded", "the exact objects, a comparison, the checks that ran, and a review record", "See a 30-second example", "AI wrote these values. What did they actually change?", "I set a value. Why did the rendered object not change?", "If Helm ignored a setting, check first for a misspelled or wrong values path", "Can I upgrade this chart without breaking production?", "The chart does not expose the field I need. Must I fork it?", "How should Argo CD or Flux handle this chart's hooks and CRDs?", "Can I roll back to exactly what ran before?", "How is this candidate different from production?", "Where does this vulnerable image run, and how can I update it safely?", "1. Check a chart and values", "Optional comparison: add what you run today", "No, keep this investigation private", "Installed Helm release", "Read the existing-release commands", "Build my prompt", "WORKSHOP FINDING", "Check and retain the rendered result", "I have rendered YAML", "Check these objects", "This is a first check, not a Helm render", "The checks on this page run in your browser", "This page does not send your files to an AI service", "Keep or share the reviewed result", "Compare with the Catalog", "Download review record", "Only completed checks count as evidence. Everything else is not checked and cannot support a safety claim.", "ConfigurationReview schema", "Keep this reviewed result in ConfigHub", "Candidate file hash", "Copy commands to keep this result", "Use your own AI assistant", "Copy handoff for my AI", "Optional: propose a public Catalog case", "A maintainer must reproduce and classify the case", "Other Questions You Can Check", "What Happens to a Public Question", "within two business days", "Within seven days", "What happens next", "The review finds a placeholder credential", "blocking ConfigHub apply gate", "The render is surprising", "publish the reviewed files as OCI", "Save the reviewed result in ConfigHub", "delivery limitations", "checks and publication receipts", "promotion and fleet examples"],
  },
  {
  ...
  },
  {
    ...
    terms: ["Keep This Reviewed Configuration in ConfigHub", "Save the exact Kubernetes configuration you approved", "Use the Catalog or Check my config before you sign up", "the same answer tomorrow", "ConfigHub shows exact diffs", "Keep a reviewed result in ConfigHub", "1. What ConfigHub adds", "Upload reviewed files or OCI", "Create a version for each environment", "Publish a release for Argo CD or Flux", "2. See one exact handoff", "Review locally", "Publish the OCI", "Save the base in ConfigHub", "ded2b7c2624c74ae1dce2a947ad9d99a32a62f5114361970af61c9ca51449345", "sha256:34af6a50b952d1a168a5cad614ef47f652cf44b11806a93bf6cc7a79c6e9c683", "attach both file hashes", "Provider None", "3. Continue from the retained answer", "Compare development and production", "Promote and publish", "Roll back", "Compare desired with live", "Roll out to a fleet", "4. Continue with the official tutorial", "Create a ConfigHub account", "official tutorial", "Read the ConfigHub blog"],
  },
  {
  ...
  },
  {
    ...
    terms: ["id=\"chart-filter\"", "Component Catalog", "Find a Tested Helm Configuration", "Choose a Helm chart version", "we have tested and documented", "shows the Helm values", "check your own configuration", "A useful public result can become a new Catalog configuration", "Search Helm Configurations", "Search Helm charts", "Readiness", "Ready to try", "Checked; review before use", "Published package; review first", "First configuration", "Helm charts shown; 139 retained package versions remain available", "all 139 retained package versions", "112 components", "Every version has a local detail page", "Packaged configurations by version", "What each catalog entry contains", "Why the catalog offers several configurations", "Other Supported Input: AICR", "How the catalog handles required setup", "After you choose", "Choose how to deploy the reviewed configuration"],
  },
  {
...
const guideOpeningChecks = [
  {
    file: "site/index.html",
    headerTerms: ["See What Your Configuration Will Do", "Helm first", "exact Kubernetes objects", "Search the", "Catalog", "Check my config", "assistant you already use", "files stay on your machine", "without an account", "files or OCI", "Search tested configurations"],
  },
  {
    file: "site/ask.html",
    headerTerms: ["Check your configuration", "chart and values my AI produced", "Catalog", "tested and documented", "Use this page for your own chart", "AI assistant and Helm tools run on your machine", "compare rendered YAML in your browser", "Your files are not uploaded", "exact objects", "Start with my chart and values", "See a 30-second example", "I have rendered YAML"],
  },
  {
    file: "site/try.html",
  ...
  {
    file: "site/confighub.html",
    headerTerms: ["Keep This Reviewed Configuration in ConfigHub", "exact Kubernetes configuration you approved", "source, checks, and later changes", "Use the Catalog or Check my config before you sign up", "same answer tomorrow", "exact diffs", "Keep a reviewed result in ConfigHub", "Open the tutorial"],
  },
  {
    file: "site/how-it-works.html",
