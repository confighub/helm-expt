...
const DEMO_SPACES = [
  ...
  },
  {
    ...
    kind: "source",
    hubPending: true,
    summary: "NVIDIA AICR selected an EKS H100 training platform. This entry keeps the exact source choices, 17 generated Argo CD Applications, lifecycle plan, and public OCI digests together.",
    shows: [
    ...
    settingSources: {
      ...
      configHub: "No v0.20.0 ConfigHub change exists yet. The retained 17-Application base is the proposed upload input; development and staging changes will be recorded separately.",
...
function buildDemoReadme(model) {
  ...
  const opening = model.hubPending
