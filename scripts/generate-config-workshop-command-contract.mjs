        ...
        stages: [
          {
            ...
            answer: "The command-contract proof contains exact current and candidate Kubernetes object sets.",
            ...
            nextAction: "Confirm that both object sets are the revisions intended for promotion.",
          },
          {
            id: "materialization",
            question: "What will it produce?",
            answer: "The exact candidate object set and source record are retained. This command-contract proof did not rerun Helm.",
            requiredInputs: ["source and intent", "source-native materialization tool", "exact candidate objects"],
            catalogMatchRequired: false,
            ...
            resultState: "available",
            records: ["candidate.yaml", "source-and-intent.yaml"],
            nextAction: "Rerun Helm with the recorded inputs when source-to-output reproduction is required.",
          },
          {
            id: "destination",
            question: "Can this destination accept it?",
            answer: "The staging destination is named, but its current Secret, API, policy, controller, and lifecycle facts were not checked.",
            requiredInputs: ["exact candidate", "staging destination", "current destination facts"],
            catalogMatchRequired: false,
            sourceIntentRequired: false,
            ...
            resultState: "not-run",
            records: [],
            nextAction: "Run the required Secret and managed validation checks against staging.",
          },
          {
            id: "post-deployment",
            question: "Did it work?",
            answer: "The candidate was not deployed by this command-contract proof.",
            requiredInputs: ["exact delivered revision", "staging destination", "claim-specific live evidence"],
            catalogMatchRequired: false,
            sourceIntentRequired: false,
            destinationAccessRequired: true,
            ...
            resultState: "not-run",
            records: [],
            nextAction: "After deployment, record convergence, health, drift, and rollback results for the exact candidate digest.",
          },
        ],
      },
      sourceAware: {
