...
const contract = [
  ...
  },
  {
    ...
    statusMetrics: ["top100 user-shaped variant queue", "top100 promotion-review queue"],
    evidence: ["docs/user/custom-overlays.md", "docs/reference/customization-algorithm.md", "data/managed-overlay-goldens/external-dns-customer-acme-prod/README.md"],
    verify: "npm run variant-goldens:verify; npm run top100:coverage:verify",
