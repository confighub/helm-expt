...
const contract = [
  ...
  },
  {
    ...
    statusMetrics: ["top100 user-shaped variant queue", "useful-base proposal rows", "useful-base realized rows", "useful-base proposals not yet built", "top100 promotion-review queue"],
    evidence: ["docs/user/custom-overlays.md", "docs/reference/customization-algorithm.md", "data/managed-overlay-goldens/external-dns-customer-acme-prod/README.md", "data/useful-base-design-queue/summary.md", "data/useful-base-realization-wave/summary.md"],
    verify: "npm run variant-goldens:verify; npm run top100:coverage:verify; npm run top100:useful-base-queue:verify; npm run top100:useful-base-realization:verify",
