...
runProofCli({
  ...
  controlPoints: [
    ...
    { category: "crd-policy", status: "variant-controlled", variants: { default: 3, "no-crds": 0 }, note: "CRDs are ordinary rendered objects in the default variant and still need lifecycle/upgrade policy." },
