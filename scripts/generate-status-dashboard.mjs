...
function buildReport() {
  ...
  rows.push(metric("top100", "useful-base proposal rows", usefulBaseRows.length, "", "partial", "data/useful-base-design-queue/queue.csv", "Proposed base shapes for default-shaped proof-grade charts. Multiple proposed bases can exist for one chart; compare with the top100 user-shaped variant queue for chart-level scope. These are not supported bases until rendered and proved."));
