...
const targets = [
  ...
  { rank: 8, slug: "postgresql", chart: "bitnami/postgresql", version: "18.6.7", namespace: "postgresql", variant: "static-passwords", recipe: "recipes/bitnami/postgresql/18.6.7" },
  { rank: 9, slug: "rabbitmq", chart: "bitnami/rabbitmq", version: "16.0.14", namespace: "rabbitmq", variant: "static-passwords", recipe: "recipes/bitnami/rabbitmq/16.0.14" },
  ...
  { rank: 15, slug: "grafana", chart: "grafana/grafana", version: "10.5.15", namespace: "grafana", variant: "static-passwords", recipe: "recipes/grafana/grafana/10.5.15" },
  { rank: 16, slug: "mysql", chart: "bitnami/mysql", version: "14.0.3", namespace: "mysql", variant: "static-passwords", recipe: "recipes/bitnami/mysql/14.0.3" },
  { rank: 17, slug: "mongodb", chart: "bitnami/mongodb", version: "19.0.7", namespace: "mongodb", variant: "static-passwords", recipe: "recipes/bitnami/mongodb/19.0.7" },
...
function classifyWatch(spec, target) {
  ...
  if (isAwsEbsCsiDriver(spec, target) && (hasAwsMetadataTargetFit(text) || hasCrashLoopRuntime(text))) {
...
function isAwsEbsCsiDriver(spec, target) {
  return spec.chart === "aws-ebs-csi-driver/aws-ebs-csi-driver" ||
    target.chart === "aws-ebs-csi-driver/aws-ebs-csi-driver" ||
    target.chart === "aws-ebs-csi-driver";
}
