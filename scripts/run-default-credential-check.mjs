...
**Default bases shipping a FIXED credential: ${s.fixedCredentialCount}/${s.packagesChecked} (${pct(s.fixedCredentialCount, s.packagesChecked)}). Bases still named \`generated-passwords\`: ${s.misleadingNameCount}.** Overall: **${s.result}**.
...
<body><main>
  ...
  <p class="sub">${s.fixedCredentialCount}/${s.packagesChecked} default bases ship a fixed credential · ${s.misleadingNameCount} bases still named generated-passwords · generated ${s.observedAt}</p>
