...
function docsHtml(catalog) {
  ...
  const guideRows = [
    ...
    ["OCI import, promotion, and two-cluster rollout", "One live run imports exact Kubernetes objects from OCI, promotes a change through development and staging, exports one deployable OCI, and reconciles its digest on two Argo CD clusters.", "../data/oci-deploy-stage-rollout-proof/summary.md"],
