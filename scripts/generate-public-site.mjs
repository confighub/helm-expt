      ...
      <header>
        ...
        <div class="hero">
          <div>
            ...
            <p class="lead">Output data as OCI or files. Store reviewed objects in ConfigHub when your team needs changes, approvals, promotion, and rollout.</p>
            <p class="lead">Input data from Catalog or your own package: Helm, an AICR recipe for AI, OCI image, or Kubernetes YAML.</p>
            <div class="cta-row">
