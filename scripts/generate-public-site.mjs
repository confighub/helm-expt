  ...
  --values ./my-values.yaml</code></pre>
    ...
    <section aria-labelledby="platforms">
      ...
      ${markdownLikeTable([
        ...
        ["Kubara", worked(pathways, "kubara").result, `<a href="./d/docs/demo/kubara/local-platform.html">Walkthrough</a> · <a href="./d/docs/demo/kubara/app-rollout.html">App on the platform</a> · <a href="./d/docs/demo/kubara/single-platform.html">Single platform + apps</a> · <a href="https://github.com/confighub/helm-expt/blob/main/runs/kubara-app-rollout-proof/receipt.yaml">Receipt</a> · <a href="https://github.com/confighub/helm-expt/tree/main/examples/kubara/local-platform">GitHub source</a>`],
