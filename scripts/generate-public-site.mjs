...
<header class="hero">
  ...
  <div class="hero-copy">
    ...
    <p class="install-cub-note">The five words and four stages on one page: <a href="./d/docs/user/model-and-vocabulary.html">the model and its words</a>. All five exist as real objects you can open: <a href="./demo-org.html">the demo org</a> runs ten catalog charts with version ladders, a fleet, gates, and live-proven hooks.</p>
...
$ npm run redis:verify-install:render -- \\
  ...
  <p class="closing-line">Get Started needs no ConfigHub account. You add ConfigHub when your config needs to be shared, reviewed, and managed across a team or a fleet. To see where that leads, <a href="./demo-org.html">the demo org</a> is ten charts running exactly this way: version ladders, a fleet, approval gates, and hooks proven live.</p>
...
<body>
  ...
  <main>
    ...
    <section aria-labelledby="exhibits">
      ...
      <p>Each exhibit exists to prove one claim you can check yourself, and each takes about a minute. Every exhibit names its Spaces; in the GUI, the components view groups them by chart, and a unit's Revisions tab tells each story change by change.</p>
