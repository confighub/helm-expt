...
function topNav(base = ".") {
  ...
  return `<div class="site-chrome"><div class="experiment-banner">DRAFT WEB SITE PLEASE SEND COMMENTS TO AUTHORS</div><nav class="topbar"><a class="brand" href="${link("index.html")}">ConfigHub Helm Ops</a><span class="navlinks"><a href="${link("try.html")}">Get Started</a><a href="${link("charts/index.html")}">Helm Ops Catalog</a><a href="${link("how-it-works.html")}">How this works</a><a href="${link("journey.html")}">Apps + AI</a><a href="${link("docs.html")}">Docs + FAQ</a><a href="${link("verification.html")}">Verification</a><a href="${link("private/")}">Upgrade</a></span></nav></div>`;
}
