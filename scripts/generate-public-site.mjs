...
<main>
  <section aria-labelledby="managed-result">
    ...
    <p><strong>Every certified image in the Catalog has been uploaded into a ConfigHub organization as a base variant</strong>, one at a time, with the outcome recorded. The count today: 93 of 94 images and 211 Units, with one render-late wrapper chart marked not applicable and no refusals. <a href="https://github.com/confighub/helm-expt/blob/main/data/confighub-ready/summary.md">Read the lane</a>. It reruns against a disposable organization and fails when an image has no recorded outcome.</p>
