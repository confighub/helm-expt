...
<header class="hero">
  ...
  <div class="hero-copy">
    ...
    <p class="install-cub-note"><a href="./d/docs/user/model-and-vocabulary.html">The model and its words</a> explains the five words and the four stages on one page. <a href="./demo-org.html">The demo org</a> holds a real example of each, across ten catalog charts.</p>
