...
<header class="hero">
  ...
  <div class="hero-copy">
    ...
    <p class="install-cub-note">For the vocabulary on one page, read <a href="./d/docs/user/model-and-vocabulary.html">the model and its words</a>. To see real examples, open <a href="./demo-org.html">the demo org</a>.</p>
