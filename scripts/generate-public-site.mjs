...
<body>
  <header>
    ...
    <p class="tagline">helm-expt turns the most-used public Helm charts into reviewed <code>cub installer</code> packages with named variants, rendered objects, and a receipt behind every claim. Nothing here asks to be trusted: every green cell links to evidence you can re-run.</p>
    <div class="doors">
      <div class="door">
  ...
  --non-interactive --namespace redis</code></pre>
    ...
    <div class="tiers">
      <div class="tier"><span class="stage">tier 0</span><h3>Public catalog</h3><p>Top charts, proof-grade recipes and packages, fully verifiable locally.</p><span class="badge now">available</span></div>
  ...
  return `
    ...
    * { box-sizing: border-box; }
    ...
    .topbar .brand {
      ...
      font-weight: 700; color: var(--ink); text-decoration: none; letter-spacing: .02em;
    }
    ...
    h1 { margin: 0 0 10px; font-size: clamp(1.7rem, 3.4vw, 2.9rem); line-height: 1.08; letter-spacing: -.015em; max-width: 950px; }
    h2 { margin: 40px 0 10px; font-size: 1.32rem; letter-spacing: -.01em; }
    ...
    .door .kicker { font-size: .78rem; text-transform: uppercase; letter-spacing: .08em; color: var(--muted); }
