  ...
  try {
    ...
    writeYaml(receiptPath, {
      ...
      spec: {
        ...
        deterministicBundle: {
          command: `cub install package ${packageRelative} -o <tmp>/cert-manager-v1.20.2.tgz`,
          sha256: firstSHA,
        ...
        setupChecks: variants.map((variant) => ({
          ...
          base: variant.base,
          command: `cub install setup --pull ${packageRelative} --base ${variant.base} --work-dir <tmp> --non-interactive --namespace cert-manager`,
