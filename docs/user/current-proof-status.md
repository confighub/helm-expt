...
| Which sceptic attacks have fixtures, and which are still partial? | [Generative GitOps Fit](./generative-gitops-fit.md#sceptic-proofing-status), [Blast-Radius Accuracy](../../data/blast-radius-accuracy/summary.md), [Environment-Determinism Matrix](../../data/environment-matrix/summary.md), and [Synthetic Torture Suite](../../data/torture-suite/summary.md) | The current attack fixtures for blast radius, environment determinism, and breaker charts, plus their limits. |
