...
| Is value-change blast radius measured or assumed? | [Blast-Radius Accuracy](../../data/blast-radius-accuracy/summary.md) | The first measured KPS CRD base-pair case, plus the unmeasured value-source-map backlog. |
