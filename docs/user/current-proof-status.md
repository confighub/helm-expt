...
| Is value-change blast radius measured or assumed? | [Blast-Radius Accuracy](../../data/blast-radius-accuracy/summary.md) | The measured KPS CRD and Redis existing-secret base-pair cases, plus the unmeasured value-source-map backlog. |
