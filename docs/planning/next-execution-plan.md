...
77/191 chart/base rows have GitOps/OCI live proof.
77/191 chart/base rows have strict live Helm-vs-ConfigHub parity proof.
76/191 chart/base rows have the complete core lane set.
