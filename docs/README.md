...
| [server-account-pitch.md](./planning/server-account-pitch.md) | The account (server) value proposition — "your versions, your apps, your releases": the plain pitch, shipped-vs-frontier, and the before/after word tweaks that unite it with the homepage "Manage Helm Variants" / "Your Own Live Apps" boxes and the Apps page, rather than adding a new page. |
