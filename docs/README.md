...
| [what-config-workshop-is.md](./user/what-config-workshop-is.md) | Config Workshop in four concise parts: a catalog of tested configuration published as OCI images, uploaded into ConfigHub as base variants and recorded; a cub plugin with four nouns and the free verbs; platforms and stacks on demand, checked before anything runs, with the assistant choosing and the check deciding; and verified, certified, signed. Each part ends with what you can do, and the doc ends with what is not covered yet. |
