...
| [Answer the questions AICR users ask](./user/workshop-aicr-guide.md) | The known path for an AICR user: compose an H100 training recipe's exact objects, compare versions, read the recorded accelerator-fit route, and see the component order and nested sources it carries. |
| [Answer the questions Kubara users ask](./user/workshop-kubara-guide.md) | The known path for a Kubara user: check what a generated platform contains, read its recorded CRD, secret, and bootstrap routes, and see why a fleet-wide placement is still the pending step. |
| [Render your own chart to exact objects, adapt them as data, and keep them](./user/workshop-byo-charts-guide.md) | For a Helm chart or values that are not a Catalog entry, often written or changed by an AI: render, check, diff two versions, adapt a field the chart does not expose, then keep the reviewed objects while your own Argo CD or Flux keeps delivering. |
...
| [Harden Argo CD before production](./user/workshop-argocd-hardening-guide.md) | Turn security advice into a values variant of the Catalog's Argo CD base, check every key, compare it with the base, and keep it with a staging and production path. |
...
| [Find hook and CRD work](./user/workshop-lifecycle-guide.md) | Render a hook without executing it, retain a served-API refusal, and complete the lifecycle checklist. |
| [Add a field and restore the source](./user/workshop-field-restore-guide.md) | Local cub and assistant Guide: preserve source bytes, inspect a label addition, detect an object replacement and restore an exact copy. |
...
| [AICR h100-gke-cos-training-slurm example](./demo/aicr/h100-gke-cos-training-slurm.md) | Mirrored from NVIDIA AICR's recipe catalog: 18 components resolved into 21 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-ubuntu-training-slurm example](./demo/aicr/h100-eks-ubuntu-training-slurm.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-ubuntu-training-slurm example](./demo/aicr/h100-aks-ubuntu-training-slurm.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-ubuntu-training-slurm example](./demo/aicr/gb300-eks-ubuntu-training-slurm.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-ubuntu-training-slurm example](./demo/aicr/gb200-eks-ubuntu-training-slurm.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR vr200-rke2-ubuntu-training example](./demo/aicr/vr200-rke2-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR vr200-rke2-ubuntu-inference-dynamo example](./demo/aicr/vr200-rke2-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 18 components resolved into 21 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR vr200-rke2-ubuntu-inference example](./demo/aicr/vr200-rke2-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-lke-ubuntu-training example](./demo/aicr/rtx-pro-6000-lke-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-lke-ubuntu-inference example](./demo/aicr/rtx-pro-6000-lke-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-lke-training example](./demo/aicr/rtx-pro-6000-lke-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-lke-inference example](./demo/aicr/rtx-pro-6000-lke-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-ubuntu-training-kubeflow example](./demo/aicr/rtx-pro-6000-eks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-ubuntu-training example](./demo/aicr/rtx-pro-6000-eks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-ubuntu-inference-nim example](./demo/aicr/rtx-pro-6000-eks-ubuntu-inference-nim.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-ubuntu-inference-dynamo example](./demo/aicr/rtx-pro-6000-eks-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 18 components resolved into 21 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-ubuntu-inference example](./demo/aicr/rtx-pro-6000-eks-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-training example](./demo/aicr/rtx-pro-6000-eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-eks-inference example](./demo/aicr/rtx-pro-6000-eks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rtx-pro-6000-any example](./demo/aicr/rtx-pro-6000-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rke2-training example](./demo/aicr/rke2-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rke2-inference example](./demo/aicr/rke2-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR rke2 example](./demo/aicr/rke2.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR oke-ol-training example](./demo/aicr/oke-ol-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR oke-ol-inference example](./demo/aicr/oke-ol-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR oke-ol example](./demo/aicr/oke-ol.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR ocp-training example](./demo/aicr/ocp-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 10 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR ocp-inference-nim example](./demo/aicr/ocp-inference-nim.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR ocp-inference example](./demo/aicr/ocp-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 10 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR ocp example](./demo/aicr/ocp.md) | Mirrored from NVIDIA AICR's recipe catalog: 10 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR lke-training example](./demo/aicr/lke-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR lke-inference example](./demo/aicr/lke-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR lke example](./demo/aicr/lke.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR l40s-oke-training example](./demo/aicr/l40s-oke-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR l40s-oke-inference example](./demo/aicr/l40s-oke-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR l40s-any example](./demo/aicr/l40s-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR l40-any example](./demo/aicr/l40-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR kind-inference example](./demo/aicr/kind-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR kind example](./demo/aicr/kind.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 13 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h200-eks-training example](./demo/aicr/h200-eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h200-eks-inference example](./demo/aicr/h200-eks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h200-any example](./demo/aicr/h200-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-kind-training-slurm example](./demo/aicr/h100-kind-training-slurm.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-kind-training-kubeflow example](./demo/aicr/h100-kind-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-kind-training example](./demo/aicr/h100-kind-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 13 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-kind-inference-dynamo example](./demo/aicr/h100-kind-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-kind-inference example](./demo/aicr/h100-kind-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-gke-cos-training-kubeflow example](./demo/aicr/h100-gke-cos-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-gke-cos-training example](./demo/aicr/h100-gke-cos-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-gke-cos-inference-dynamo example](./demo/aicr/h100-gke-cos-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 21 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-gke-cos-inference example](./demo/aicr/h100-gke-cos-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-ubuntu-training-kubeflow example](./demo/aicr/h100-eks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-ubuntu-training example](./demo/aicr/h100-eks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-ubuntu-inference-nim example](./demo/aicr/h100-eks-ubuntu-inference-nim.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-ubuntu-inference-dynamo example](./demo/aicr/h100-eks-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 18 components resolved into 21 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-ubuntu-inference example](./demo/aicr/h100-eks-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-training example](./demo/aicr/h100-eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-bcm-ubuntu-training example](./demo/aicr/h100-bcm-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 13 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-bcm-training example](./demo/aicr/h100-bcm-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 13 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-any example](./demo/aicr/h100-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-ubuntu-training-kubeflow example](./demo/aicr/h100-aks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-ubuntu-training example](./demo/aicr/h100-aks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-ubuntu-inference-dynamo example](./demo/aicr/h100-aks-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 22 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-ubuntu-inference example](./demo/aicr/h100-aks-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-training example](./demo/aicr/h100-aks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-aks-inference example](./demo/aicr/h100-aks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gke-cos-training example](./demo/aicr/gke-cos-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gke-cos-inference example](./demo/aicr/gke-cos-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gke-cos example](./demo/aicr/gke-cos.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-generic-ubuntu-training example](./demo/aicr/gb300-generic-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-ubuntu-training-kubeflow example](./demo/aicr/gb300-eks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-ubuntu-training example](./demo/aicr/gb300-eks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-ubuntu-inference-dynamo example](./demo/aicr/gb300-eks-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 18 components resolved into 22 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-ubuntu-inference example](./demo/aicr/gb300-eks-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-training example](./demo/aicr/gb300-eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-eks-inference example](./demo/aicr/gb300-eks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb300-any example](./demo/aicr/gb300-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-oke-ubuntu-training-kubeflow example](./demo/aicr/gb200-oke-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-oke-ubuntu-training example](./demo/aicr/gb200-oke-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-oke-ubuntu-inference-dynamo example](./demo/aicr/gb200-oke-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-oke-ubuntu-inference example](./demo/aicr/gb200-oke-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-oke-training example](./demo/aicr/gb200-oke-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-oke-inference example](./demo/aicr/gb200-oke-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-ubuntu-training-kubeflow example](./demo/aicr/gb200-eks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-ubuntu-training example](./demo/aicr/gb200-eks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-ubuntu-inference-dynamo example](./demo/aicr/gb200-eks-ubuntu-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 18 components resolved into 22 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-ubuntu-inference example](./demo/aicr/gb200-eks-ubuntu-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-training example](./demo/aicr/gb200-eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-eks-inference example](./demo/aicr/gb200-eks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 20 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR gb200-any example](./demo/aicr/gb200-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR eks-training example](./demo/aicr/eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR eks example](./demo/aicr/eks.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR bcm-training example](./demo/aicr/bcm-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 13 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR bcm-inference example](./demo/aicr/bcm-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR bcm example](./demo/aicr/bcm.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 13 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR b200-gke-cos-training-kubeflow example](./demo/aicr/b200-gke-cos-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR b200-gke-cos-training example](./demo/aicr/b200-gke-cos-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR b200-gke-cos-inference-dynamo example](./demo/aicr/b200-gke-cos-inference-dynamo.md) | Mirrored from NVIDIA AICR's recipe catalog: 17 components resolved into 21 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR b200-gke-cos-inference example](./demo/aicr/b200-gke-cos-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR b200-any example](./demo/aicr/b200-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR aks-training example](./demo/aicr/aks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR aks-inference example](./demo/aicr/aks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR aks example](./demo/aicr/aks.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-oke-ubuntu-training-kubeflow example](./demo/aicr/a100-oke-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 12 components resolved into 14 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-oke-ubuntu-training example](./demo/aicr/a100-oke-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-oke-training example](./demo/aicr/a100-oke-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-gke-cos-training-kubeflow example](./demo/aicr/a100-gke-cos-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-gke-cos-training example](./demo/aicr/a100-gke-cos-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-eks-ubuntu-training-kubeflow example](./demo/aicr/a100-eks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 17 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-eks-ubuntu-training example](./demo/aicr/a100-eks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-eks-training example](./demo/aicr/a100-eks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 15 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-any example](./demo/aicr/a100-any.md) | Mirrored from NVIDIA AICR's recipe catalog: 11 components resolved into 12 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-aks-ubuntu-training-kubeflow example](./demo/aicr/a100-aks-ubuntu-training-kubeflow.md) | Mirrored from NVIDIA AICR's recipe catalog: 14 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-aks-ubuntu-training example](./demo/aicr/a100-aks-ubuntu-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR a100-aks-training example](./demo/aicr/a100-aks-training.md) | Mirrored from NVIDIA AICR's recipe catalog: 13 components resolved into 16 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR h100-eks-inference example](./demo/aicr/h100-eks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 16 components resolved into 19 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
| [AICR eks-inference example](./demo/aicr/eks-inference.md) | Mirrored from NVIDIA AICR's recipe catalog: 15 components resolved into 18 rendered Argo CD Applications, retained and digest-pinned, generated by `scripts/generate-aicr-from-overlay.mjs`. |
...
| [aicr-nim-track-backlog.md](./planning/aicr-nim-track-backlog.md) | The next fifty tasks in the AICR and NIM track, grouped by theme, with the ones that change shared Catalog and ConfigHub Workshop surfaces marked and the four gating tasks named. |
| [stacks-platforms-apps-taxonomy.md](./planning/stacks-platforms-apps-taxonomy.md) | The settled taxonomy for stacks, platforms, and apps: the menu of four ways to get a stack, altitude and planes, the certify loop, two-layer adapt, apps operated in ConfigHub, platform as an outcome; the spec the Stacks and Apps pages are rebuilt from. |
...
| Document | Purpose |
| --- | --- |
| [agent-operated-cross-format-catalog.md](./planning/agent-operated-cross-format-catalog.md) | Plan for an installable ConfigHub Workshop agent skill, task evaluations, a source-neutral Catalog, and the first Timoni source entry. |
...
| [backend-seven-day-plan.md](./planning/backend-seven-day-plan.md) | Historical 42-task backend checklist and dated evidence record; current execution is in workshop-execution-plan.md. |
