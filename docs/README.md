...
| [Current Kubara + ConfigHub mini-IDP](./demo/kubara/single-platform.md) | Primary Kubara v0.13.0 adoption path: familiar catalogs, config, overlays, and hub/spoke topology plus component-first OCI, governed definitions and instances, matrix, wiring, platform delivery, and two applications. |
