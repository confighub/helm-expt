...
| [RBAC review example](./demo/apps/rbac-review.md) | One exact permission correction: find unnecessary Secret access, review the object diff, require approval, and check the approved result on an isolated cluster. |
