...
| [chapter-three-gateway-rework.md](./planning/chapter-three-gateway-rework.md) | The specification for moving the Sveltos environment rollout onto the ConfigHub OCI gateway: what the runner becomes, what it deletes, and the two constraints the gateway imposes. Mirrored from the Sveltos repository. |
