...
| [workshop-execution-plan.md](./planning/workshop-execution-plan.md) | Delivery sequence for a bounded Kubara platform plus app, followed by adaptation and NVIDIA matching: CLI and assistant acceptance, complete task pages, evidence, trials and dependencies. |
...
| [backend-seven-day-plan.md](./planning/backend-seven-day-plan.md) | Ordered backend improvement checklist, evidence requirements, execution record, and human dependencies. |
