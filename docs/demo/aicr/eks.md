...
`scripts/generate-aicr-from-overlay.mjs eks`, the generator built
...
Criteria `--service eks` resolves three overlays into 13 components,
...
The [generation receipt](../../../examples/aicr/eks/generation-receipt.yaml)
...
The [digest index](../../../examples/aicr/eks/digest-index/README.md)
