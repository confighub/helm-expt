# The rtx-pro-6000-lke-ubuntu-training overlay, mirrored as a catalog entry

UNOFFICIAL/EXPERIMENTAL. This entry belongs to
[the AICR catalog overview](./index.md). It was produced by
`scripts/generate-aicr-from-overlay.mjs rtx-pro-6000-lke-ubuntu-training`, the generator built
...
Criteria `--service lke --accelerator rtx-pro-6000 --os ubuntu --intent training` resolves seven overlays into 11 components,
...
```bash
aicr recipe --service lke --accelerator rtx-pro-6000 --os ubuntu --intent training --output recipe.yaml
...
The [generation receipt](../../../examples/aicr/rtx-pro-6000-lke-ubuntu-training/generation-receipt.yaml)
...
```bash
node scripts/generate-aicr-digest-index.mjs --verify --example rtx-pro-6000-lke-ubuntu-training
```

The [digest index](../../../examples/aicr/rtx-pro-6000-lke-ubuntu-training/digest-index/README.md)
