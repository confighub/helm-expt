...
| #27 Observation freshness SLO | P0 acceptance satisfied | `docs/observation-freshness-slo.md` defines fresh, stale, failed, unknown, not-observed, and drifted states; verifier checks receipt fields and evidence digests. | UI/API display of freshness status remains outside this repo. |
