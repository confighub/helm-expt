...
| Chart-page claim integrity | ● | ○ | ● | ● | `chart-claim-integrity:verify`, [claim-integrity audit](../docs/planning/chart-claim-integrity-audit-2026-06-22.md) | re-checks each page claim against its cited receipt; **open HARD findings** (false-green lanes / blocked receipts) → [live findings](../data/chart-claim-integrity-audit-2026-06-22/summary.md) |
